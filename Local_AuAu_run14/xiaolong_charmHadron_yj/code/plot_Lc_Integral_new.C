...
void plot_Lc_Integral_new() {
    ...
    if(false) {  // read spectra
        ...
        const double yy[ncent][nn] = {{0.0010737, 7.55313e-05, 2.9242e-06}};
        const double yyerr[ncent][nn] = {{0.000206317, 1.04505e-05, 4.41178e-07}};
        const double yysys[ncent][nn] = {{0.00031684, 2.21745e-05, 8.19077e-07}};
        for(int icent=0; icent<ncent; icent++) {
