...
int Charm_Bottom_Decay_electrons_EvtGen(){
  ...
  TFile * inFile_D0= new TFile("input_new_20170927/TypeID_Ana_421.root","READ");
  TFile * inFile_D0bar= new TFile("input_new_20170927/TypeID_Ana_-421.root","READ");
  
  TFile * inFile_Dplus= new TFile("input_new_20170927/TypeID_Ana_411.root","READ");
  TFile * inFile_Dminus= new TFile("input_new_20170927/TypeID_Ana_-411.root","READ");

  
  //----------------

  TFile * inFile_Dsplus= new TFile("input_new_20170927/TypeID_Ana_431.root","READ");
  TFile * inFile_Dsminus= new TFile("input_new_20170927/TypeID_Ana_-431.root","READ");

  TFile * inFile_Lcplus= new TFile("input_new_20170927/TypeID_Ana_4122.root","READ");
  TFile * inFile_Lcminus= new TFile("input_new_20170927/TypeID_Ana_-4122.root","READ");
  ...
  TFile * inFile_Bplus= new TFile("input_new_20170927/TypeID_Ana_521.root","READ");
  TFile * inFile_Bminus= new TFile("input_new_20170927/TypeID_Ana_-521.root","READ");
  
   
  TFile * inFile_B0= new TFile("input_new_20170927/TypeID_Ana_511.root","READ");
  TFile * inFile_B0bar= new TFile("input_new_20170927/TypeID_Ana_-511.root","READ");
  ...
  TFile *file_fastsim=new TFile("File_fastsim_xzbin.root","RECREATE");
 for(Int_t ihist=0;ihist<mh2Nhist;ihist++)
    {
	  ...
	  mh1hist_Dca_Dsplus_rebin[ihist][ipt]= (TH1F *) mh1hist_Dca_Dsplus[ihist][ipt]->Rebin(nDcasDca,mh1hist_Dca_Dsplus[ihist][ipt]->GetName()+TString("_rebin"),DcaEdgeDca);
	  mh1hist_Dca_Dsminus_rebin[ihist][ipt]= (TH1F *) mh1hist_Dca_Dsminus[ihist][ipt]->Rebin(nDcasDca,mh1hist_Dca_Dsminus[ihist][ipt]->GetName()+TString("_rebin"),DcaEdgeDca);

	  mh1hist_Dca_Lcplus_rebin[ihist][ipt]= (TH1F *) mh1hist_Dca_Lcplus[ihist][ipt]->Rebin(nDcasDca,mh1hist_Dca_Lcplus[ihist][ipt]->GetName()+TString("_rebin"),DcaEdgeDca);
	  mh1hist_Dca_Lcminus_rebin[ihist][ipt]= (TH1F *) mh1hist_Dca_Lcminus[ihist][ipt]->Rebin(nDcasDca,mh1hist_Dca_Lcminus[ihist][ipt]->GetName()+TString("_rebin"),DcaEdgeDca);
	  ...
	  mh1hist_Dca_Dsplus_rebin[ihist][ipt]->Add(mh1hist_Dca_Dsminus_rebin[ihist][ipt]);
	  mh1hist_Dca_Lcplus_rebin[ihist][ipt]->Add(mh1hist_Dca_Lcminus_rebin[ihist][ipt]);
	  ...
	  */
	  ...
	  //  https://drupal.star.bnl.gov/STAR/system/files/charmCrossSection_v3.pdf
	  	  //https://arxiv.org/pdf/1509.01061.pdf
	  // 0.6086/(0.6086+0.2404)=0.7168 systematic uncertainty 0.723 0.277
	  // B 0.5 0.5 
	  //  mh1hist_Dca_D_rebin[ihist][ipt]->Scale(0.307143);
	  ...
	  //  mh1hist_Dca_D_rebin[ihist][ipt]->GetYaxis()->SetTitle();
	  
	  mh1hist_Dca_D_rebin[ihist][ipt]->Add(mh1hist_Dca_Dplus_rebin[ihist][ipt]);
	  mh1hist_Dca_D_rebin[ihist][ipt]->Add(mh1hist_Dca_Dsplus_rebin[ihist][ipt]);

	  if(Lc_Flag)
	    {
	      mh1hist_Dca_D_rebin[ihist][ipt]->Add(mh1hist_Dca_Lcplus_rebin[ihist][ipt]);
	    }
	  
	  //mh1hist_Dca_D_rebin[ihist][ipt]->Add(mh1hist_Dca_Dplus_rebin[ihist][ipt],0.277);

	  // mh1hist_Dca_B_rebin[ihist][ipt]->Scale(0.5);
	  mh1hist_Dca_B_rebin[ihist][ipt]->Add(mh1hist_Dca_Bplus_rebin[ihist][ipt]);
	  ...
	  mh1hist_Dca_Dsplus_rebin[ihist][ipt]->SetLineColor(6);
	  mh1hist_Dca_Lcplus_rebin[ihist][ipt]->SetLineColor(8);
  ...
  legend_D ->AddEntry(mh1hist_Dca_Dsplus_rebin[0][0],"D^{+}_{s}->e","l");
  if(Lc_Flag)
  legend_D ->AddEntry(mh1hist_Dca_Lcplus_rebin[0][0],"#Lambda_{c}^{+}->e","l");
  ...
  c7_D->Divide(4,2);
    ...
    for(Int_t ihist=0;ihist<mh2Nhist;ihist++)
    {
	  ...
	  mh1hist_Dca_D0_rebin[ihist][ipt]->Scale(1.,"width");
	  mh1hist_Dca_D0bar_rebin[ihist][ipt]->Scale(1.,"width");
	  mh1hist_Dca_Dplus_rebin[ihist][ipt]->Scale(1.,"width");
	  mh1hist_Dca_Dsplus_rebin[ihist][ipt]->Scale(1.,"width");
	  mh1hist_Dca_Lcplus_rebin[ihist][ipt]->Scale(1.,"width");
	  ...
	  mh1hist_Dca_Dsplus_rebin[ihist][ipt]->Sumw2(0);
	  mh1hist_Dca_Lcplus_rebin[ihist][ipt]->Sumw2(0);
	  ...
	  mh1hist_Dca_Dsplus_rebin[ihist][ipt]->Draw("sameC");
	  if(Lc_Flag)
	  mh1hist_Dca_Lcplus_rebin[ihist][ipt]->Draw("sameC");
  ...
  c7_B->Divide(4,2);
    ...
    for(Int_t ihist=0;ihist<mh2Nhist;ihist++)
    {
	  ...
	  gPad->SetLogy();
	    ...
	    mh1hist_Dca_B0_rebin[ihist][ipt]->Scale(1.,"width");
	    mh1hist_Dca_B0bar_rebin[ihist][ipt]->Scale(1.,"width");
	    mh1hist_Dca_Bplus_rebin[ihist][ipt]->Scale(1.,"width");
	    mh1hist_Dca_B_rebin[ihist][ipt]->Scale(1.,"width");
    ...
    TH1F *D0_e_pT= (TH1F*) mh2Hist_DcaVsPt_D0[IHIST]->ProjectionX("D0_e_pT");
    TH1F *Dplus_e_pT= (TH1F*) mh2Hist_DcaVsPt_Dplus[IHIST]->ProjectionX("Dplus_e_pT");
    TH1F *Ds_e_pT= (TH1F*) mh2Hist_DcaVsPt_Dsplus[IHIST]->ProjectionX("Ds_e_pT");
    TH1F *Lc_e_pT= (TH1F*) mh2Hist_DcaVsPt_Lcplus[IHIST]->ProjectionX("Lc_e_pT");
    ...
    D0_e_pT->SetLineColor(1);
    Dplus_e_pT->SetLineColor(2);
    Ds_e_pT->SetLineColor(4);
    Lc_e_pT->SetLineColor(6);

    
    D0_e_pT->Draw("same");
    Dplus_e_pT->Draw("same");
    Ds_e_pT->Draw("same");
    Lc_e_pT->Draw("same");
  ...
  legend_D_pt ->AddEntry(D0_e_pT,"D^{0} Decay Electrons","l");
  legend_D_pt ->AddEntry(Dplus_e_pT,"D^{#pm} Decay Electrons","l");
  legend_D_pt ->AddEntry(Ds_e_pT,"Ds Decay Electrons","l");
  legend_D_pt ->AddEntry(Lc_e_pT,"#Lambdac Decay Electrons","l");


  
  legend_D_pt ->SetBorderSize(0);
  legend_D_pt ->SetTextSize(0.04);
  legend_D_pt ->SetFillStyle(0);
  legend_D_pt ->SetTextFont(22);
