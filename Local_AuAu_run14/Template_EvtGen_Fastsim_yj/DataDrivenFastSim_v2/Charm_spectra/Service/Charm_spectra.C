...
//  hLc_spectra_0_80->Divide(hD0_spectra_10_60);
    ...
    TH1F * hLc_spectra_0_80=(TH1F *) hLc_spectra_0_80 = (TH1F*) inFile_Lc2->Get("hSpec_0");
  ...
  // spectra from Lc 
    ...
    pl_lc_0_80->SetLineStyle(7);
     ...
     hLc_spectra_0_80->Draw("samee3");

     hLc_spectra_0_80->Fit("pl_lc_0_80","R","same",0.2,10);
    hLc_spectra_0_80->Fit("fp_0_80","R","same",0.2,10);
    ...
    // hLc_spectra_10_60_model1->Fit("fp","R","same",0.2,10);



    
    hLc_spectra_10_60_mean->Divide(h_Scale);
    hLc_spectra_10_60_mean->SetFillColor(7);
    hLc_spectra_10_60_mean->Draw("samee3");
    hLc_spectra_10_60_mean->Fit("pl_lc_0_60","R","same",0.2,10);
    hLc_spectra_10_60_mean->Fit("fp_0_60","R","same",0.2,10);
    pl_lc_0_60->Draw("same");
    fp_0_60->Draw("same");

    //   hLc_spectra_0_80->Draw("samee3");

    Double_t x_central=-99,y_central=-99;
    Double_t x_err=-99,y_err=-99;
  
    Lc_10_60_err->GetPoint(0,x_central,y_central);
    y_err=  Lc_10_60_err->GetErrorY(0);
    y_central=y_central*D0_10_60_err->Eval(4.5);
    y_err=y_err*D0_10_60_err->Eval(4.5);

    Double_t  Err_D0=  hD0_spectra_10_60->GetBinError(hD0_spectra_10_60->FindBin(4.5));

    y_err=sqrt(Err_D0*Err_D0+y_err*y_err);
    
    
    TH1F *mh1Lc_10_60_err=new TH1F("mh1Lc_10_60_err","",1,3,6);
    mh1Lc_10_60_err->SetBinContent(1,y_central);
    mh1Lc_10_60_err->SetBinError(1,y_err);

    mh1Lc_10_60_err->SetMarkerSize(1.6);
    mh1Lc_10_60_err->SetMarkerStyle(20);
    //mh1Lc_10_60_err->Draw("sameE1");
    
    hLc_spectra_0_80->SetMarkerStyle(20);
    hLc_spectra_0_80->SetMarkerSize(1.6);
    hLc_spectra_0_80->Draw("sameE1");
    

    TLegend *legend_Lc  = new TLegend(0.55,0.65,0.85,0.85);
    legend_Lc ->AddEntry(mh1Lc_10_60_err,"#Lambdac 10-60%","p");
    legend_Lc ->AddEntry(hLc_spectra_10_60_mean,"#Lambdac 10-60% ","f");
    legend_Lc ->AddEntry(hLc_spectra_0_80,"#Lambdac x 1e^{2} Scaled 10-60% To 0-80%","f");
