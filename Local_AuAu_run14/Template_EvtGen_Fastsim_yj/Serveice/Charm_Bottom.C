...
int Charm_Bottom(){
  ...
  TFile * inFile_D0= new TFile("input_new_20170922/TypeID_Ana_421.root","READ");
  TFile * inFile_D0bar= new TFile("input_new_20170922/TypeID_Ana_-421.root","READ");
  
  TFile * inFile_Dplus= new TFile("input_new_20170922/TypeID_Ana_411.root","READ");
  TFile * inFile_Dminus= new TFile("input_new_20170922/TypeID_Ana_-411.root","READ");
  ...
  TFile * inFile_Bplus= new TFile("input_new_20170922/TypeID_Ana_521.root","READ");
  TFile * inFile_Bminus= new TFile("input_new_20170922/TypeID_Ana_-521.root","READ");
  
   
  TFile * inFile_B0= new TFile("input_new_20170922/TypeID_Ana_511.root","READ");
  TFile * inFile_B0bar= new TFile("input_new_20170922/TypeID_Ana_-511.root","READ");
