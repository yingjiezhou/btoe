...
// fastsim    
int Charm_Bottom_compare_old_new(){
...
TH1F *mh1Bottom_dca_old[mh2Nhist][Npt];
  ...
  // gStyle->SetLineWidth(1);
    ...
    TFile * input_fastsim= new TFile("/Users/xiaozhibai/work/Analysis/run14/simulation/Fraction_Fit/B_Fraction_fit/Minuit_Fit_2_15/Input/File_fastsim.root","READ");
  //   TFile * input_fastsim= new TFile("File_fastsim.root","READ");
   TFile * input_fastsim_old= new TFile("File_fastsim_old.root","READ");
