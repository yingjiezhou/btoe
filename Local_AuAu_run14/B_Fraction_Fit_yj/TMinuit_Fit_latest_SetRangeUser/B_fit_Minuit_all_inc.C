...
void B_fit_Minuit_all_inc(){
  ...
  //======zyj=======
  TString outFileName="Output_tunePtBin_yj_allChange_qa_xzbin_xzhadron";
  ...
  TFile *input_phe_hijing=new TFile("./Input/Photonic_electron_template_yj_xzbin.root","READ");
  //======zyj=======
  ...
  TFile *input_data=new TFile("Input/Data_inclusive_photonic_yj_xzbin.root","READ");
