...

{
  ...
  TFile *input_Fit=new TFile("InPut_2/Fit_B_fraction_MB_default.root","READ");
  TFile *input_Fit_kaon=new TFile("InPut_2/Fit_B_fraction_MB_kaon.root","READ");
  ...
  TFile *input_Fit_range_006=new TFile("InPut_2/Fit_B_fraction_MB_0.06.root","READ");
  TFile *input_Fit_DF=new TFile("InPut_2/Fit_B_fraction_MB_DF.root","READ");
  TFile *input_Fit_BF=new TFile("InPut_2/Fit_B_fraction_MB_BF.root","READ");
  TFile *input_Fit_weight_D=new TFile("InPut_2/Fit_B_fraction_MB_weight_data.root","READ");
  ...
  TFile *input_Fit_Extro=new TFile("InPut_2/Fit_B_fraction_MB_Extra_highpT.root","READ");
  ...
  // TH1F *Npe_Raa_all_sys=(TH1F *) input_Total_Raa->Get("NPERaaSysRun10_AuAu_0")->Clone("Npe_Raa_all_sys");
  
  // TH1F *B_fraction_AA=(TH1F *) input_B_fraction_AA->Get("b_fraction_MB")->Clone("B_fraction_AA");
  // TH1F *Npe_Raa=(TH1F *) input_ht->Get("b_fraction_HT")->Clone("B_fraction_HT");
