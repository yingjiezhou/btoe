...
void ReadDca_Comp(){
  ...
  auto file1(TFile::Open("Dca_hadron_allH.root","READ")); // yj
  TString outfileName="ReadDca_Comp_DCAxy_allH";
  ...
  for(Int_t ipt=0;ipt<Npt;ipt++) {
    ...
    cc->cd(ipt+1);
    gPad->SetLogy(1);
    mh1data_hadron[ipt]->SetLineColor(4);
    mh1data_hadron1[ipt]->SetLineColor(2);
