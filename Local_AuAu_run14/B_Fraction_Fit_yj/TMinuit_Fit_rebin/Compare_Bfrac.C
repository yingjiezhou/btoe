void Compare_Bfrac()
{
  ...
  const int nk=9;
  TString nkName[]={"Output_tunePtBin_xz_noLc", "Output_tunePtBin_xz", "Output_tunePtBin_yj_hadronChange", "Output_tunePtBin_yj_hadron_fastSimChange",
    "Output_tunePtBin_yj_hadron_purityChange","Output_tunePtBin_yj_allChange", "Output_tunePtBin_yj_purityChange",
    "Output_tunePtBin_yj_fastSimChange", "Output_tunePtBin_yj_allChange_woPurity"};
  TString nLName[]={"STAR Au+Au HFT QM17", "xz", "yj_Hadron", "yj_Hadron_HF", "yj_Hadron_Purity",
    "yj_Hadron_HF_Purity", "yj_Purity", "yj_HF", "yj_Hadron_HF_Purity(2bin)"
  };
  TFile * file[nk];
  TH1F *hist[nk];
  /*
  ...
  */
  ...
  c1->SaveAs("Compare_Bfrac_v7.pdf");
  /*
