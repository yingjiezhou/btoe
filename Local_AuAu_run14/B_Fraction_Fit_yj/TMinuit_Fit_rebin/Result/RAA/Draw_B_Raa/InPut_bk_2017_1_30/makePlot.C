void makePlot(){
  ...
  {  
    ...
    out<<setiosflags(ios::fixed)<<setiosflags(ios::right)<<setprecision(6)<<setw(4);
  ...
  {  
    ...
    dysU6[k] = x5-x2;
    cout<<setiosflags(ios::fixed)<<setiosflags(ios::right)<<setprecision(6)<<setw(4);
    out_06<<setiosflags(ios::fixed)<<setiosflags(ios::right)<<setprecision(6)<<setw(4);
    cout << pT6[k] << "\t";
    cout << Rb6[k] << "\t ";
    cout << dy6[k] << "\t";
    cout << dysD6[k] << "\t";
