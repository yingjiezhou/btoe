...

{
  ...
  TFile *input_run14_sys=new TFile("/Users/xiaozhibai/work/Analysis/run14/Result/Draw_B_Fraction/Test_temp/InPut/B_fraction_sys.root","READ");
  
  TFile *input_run12_pp=new TFile("/Users/xiaozhibai/work/Analysis/run14/Result/Draw_B_Fraction/Test_temp/InPut/run12NPEh_rBPoints.root","READ");
TFile *input_run14_AuAu_new=new TFile("OutPut/Fit_B_fraction_MB.root","READ");
	...
	if(ipt<2)
	  {
	    ...
	    B_fraction_new->SetBinContent(ipt+1,-999);
	    
	    B_fraction_MB->SetBinError(ipt+1,0);
	    B_fraction_sys->SetBinError(ipt+1,0);
	    B_fraction_new->SetBinError(ipt+1,0);
  ...
  TGraphErrors *  gr_B_fraction_sys=new TGraphErrors(B_fraction_sys);
   ...
   TGraphErrors *  gr_B_fraction_new=new TGraphErrors(B_fraction_new);
  
  TFile *input_PHENIX=new TFile("/Users/xiaozhibai/work/Analysis/run14/Result/Draw_B_Fraction/Test_temp/InPut/PHENIX.root","READ");
  ...
  B_fraction_sys->Write();
    ...
    gr_B_fraction_new->SetMarkerColor(1);
    gr_B_fraction_new->SetMarkerSize(3.8);
    
    gr_B_fraction_new->SetLineColor(1);
    gr_B_fraction_new->SetMarkerStyle(20);
    ...
    // FONLL
    TGraph *FONLL[2];
    FONLL[0] = new TGraph("/Users/xiaozhibai/work/Analysis/run14/Result/Draw_B_Fraction/Test_temp/InPut/FONLL_BAND_UP.dat");
    FONLL[1] = new TGraph("/Users/xiaozhibai/work/Analysis/run14/Result/Draw_B_Fraction/Test_temp/InPut/FONLL_BAND_DW.dat");
...
//  Gp->SetPallet();
    ...
    TGraphErrors *Ge_D0 = new TGraphErrors("/Users/xiaozhibai/work/Analysis/run14/Result/Draw_B_Fraction/Test_temp/InPut/e_D0.dat");
  ...
  //Ge_D_1->Draw("P");
    ...
    legend ->AddEntry(gr_B_fraction_MB,"STAR Au+Au HFT","p");
    legend ->AddEntry(gr_B_fraction_new,"STAR Au+Au HFT Add Ds,Lc","p");
