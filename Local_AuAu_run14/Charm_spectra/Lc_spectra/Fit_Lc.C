...
void Fit_Lc()
{
  ...
  TFile* fin = new TFile("out/Lc.root");
  TH1F  *hLc_spectra_10_60_mean = (TH1F *)fin->Get("hLc_spectra_10_60_mean");
  TH1F  *hLc_spectra_10_60_model1= (TH1F *)fin->Get("hLc_spectra_10_60_model1");
  gPad ->SetLogy();
