...
void Charm_spectra_Ds()
{
  ...
  TFile * inFile_Nesim=  new TFile("Ds_corrected_BDT_spectra.root","READ");
  ...
  TGraphErrors *Ds_0_10_Nesim_sts=(TGraphErrors *) inFile_Nesim->Get("corrected_yield_staterror_ptshifted_cen_0_10");
  TGraphErrors *Ds_0_10_Nesim_sys=(TGraphErrors *) inFile_Nesim->Get("corrected_yield_syserror_ptshifted_cen_0_10");

  TGraphErrors *Ds_10_40_Nesim_sts=(TGraphErrors *) inFile_Nesim->Get("corrected_yield_staterror_ptshifted_cen_10_40");
  TGraphErrors *Ds_10_40_Nesim_sys=(TGraphErrors *) inFile_Nesim->Get("corrected_yield_syserror_ptshifted_cen_10_40");

  TGraphErrors *Ds_40_80_Nesim_sts=(TGraphErrors *) inFile_Nesim->Get("corrected_yield_staterror_ptshifted_cen_40_80");
  TGraphErrors *Ds_40_80_Nesim_sys=(TGraphErrors *) inFile_Nesim->Get("corrected_yield_syserror_ptshifted_cen_40_80");
  ...
  TH1F *mh10_10_Nesim=new TH1F("mh10_10_Nesim","",4,0,5);
  ...
  for(int i=0;i<Ds_0_10_Nesim_sts->GetN();i++)
    {
      ...
      Ds_0_10_Nesim_sts->SetPoint(i,x_central,y_central*10);
      Ds_0_10_Nesim_sts->SetPointError(i,0,sqrt(y_err*y_err+y_err_sys*y_err_sys)*10);
      mh10_10_Nesim->SetBinContent(i+1,y_central);
      ...
      Ds_10_40_Nesim_sts->SetPointError(i,0,sqrt(y_err*y_err+y_err_sys*y_err_sys));
      ...
      Ds_40_80_Nesim_sts->SetPointError(i,0,sqrt(y_err*y_err+y_err_sys*y_err_sys));
  ...
  for(int i=0;i<Ds_0_10_Nesim_sts->GetN();i++)
    {
      ...
      Ds_0_80_Nesim_sts->SetPoint(i,x_central,mh10_80_Nesim->GetBinContent(i+1));
      Ds_0_80_Nesim_sts->SetPointError(i,0,mh10_80_Nesim->GetBinError(i+1));
  ...
  */
  ...
  TFile *weight_charm_Fit_data=new TFile("weight_charm_Fit_data_0_80_Ds.root","RECREATE");
