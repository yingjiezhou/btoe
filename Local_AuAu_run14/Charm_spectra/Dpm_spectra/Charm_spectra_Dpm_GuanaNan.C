...
void Charm_spectra_Dpm_GuanaNan()
{
  ...
  TFile * inFile_xiaolong=  new TFile("../cHadron.root","READ");
  TFile * inFile_Guannan=  new TFile("../Run14_Dpm_MyRaa_pT1.0.withScale_fromGuanan.root","READ");

  TFile * outFile=  new TFile("Charm_spectra.root","RECREATE");

  // file from Xiaolong 
  TGraphErrors *Ds_0_10_err=(TGraphErrors *) inFile_xiaolong->Get("Ds_0_10_err");
  ...
  TGraphErrors *Ds_0_10_Guannan_sts=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectra_0_10");
  TGraphErrors *Ds_0_10_Guannan_sys=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectraSys_0_10");

  TGraphErrors *Ds_10_40_Guannan_sts=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectra_10_40");
  TGraphErrors *Ds_10_40_Guannan_sys=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectraSys_10_40");

  TGraphErrors *Ds_40_80_Guannan_sts=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectra_40_80");
  TGraphErrors *Ds_40_80_Guannan_sys=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectraSys_40_80");

  TGraphErrors *Ds_0_80_Guannan_sts=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectra_0_80");
  TGraphErrors *Ds_0_80_Guannan_sys=(TGraphErrors *) inFile_Guannan->Get("gMyAuAuSpectraSys_0_80");
  
  TGraphErrors *Ds_0_80_Guannan_sts_combine=new  	TGraphErrors(13);
  

  
  // Ds_0_10_Guannan->Draw();
  // Ds_0_10_Guannan->Draw();

  TH1F *mh10_10_Guannan=new TH1F("mh10_10_Guannan","",13,0,13);
  TH1F *mh110_40_Guannan=new TH1F("mh110_40_Guannan","",13,0,13);
  TH1F *mh140_80_Guannan=new TH1F("mh140_80_Guannan","",13,0,13);
  TH1F *mh10_80_Guannan=new TH1F("mh10_80_Guannan","",13,0,13);

  // mh10_10_Guannan->Sumw2();
  // mh110_40_Guannan->Sumw2();
  // mh140_80_Guannan->Sumw2();
  // mh10_80_Guannan->Sumw2();
  ...
  for(int i=0;i<Ds_10_40_err->GetN();i++)
    {
      ...
      y_err_sys=Ds_0_10_sys->GetErrorY(i);
      y_err=Ds_0_10_err->GetErrorY(i);
      Ds_0_10_err->SetPoint(i,x_central,y_central/(2*TMath::Pi()*x_central)*10);
  ...
  for(int i=0;i<Ds_0_10_Guannan_sts->GetN();i++)
    {
      Double_t x_central=-999.0,y_central=-999.0,x_err=-999.0,y_err=-999.0,y_err_sys=-999.0;


	
      Ds_0_10_Guannan_sys->GetPoint(i,x_central,y_central);
      y_err_sys=Ds_0_10_Guannan_sys->GetErrorY(i);
      y_err=Ds_0_10_Guannan_sts->GetErrorY(i);

      Ds_0_10_Guannan_sts->SetPoint(i,x_central,y_central/20);
      Ds_0_10_Guannan_sts->SetPointError(i,0,sqrt(y_err*y_err+y_err_sys*y_err_sys)/20);
      mh10_10_Guannan->SetBinContent(i+1,y_central/20);
      mh10_10_Guannan->SetBinError(i+1,sqrt(y_err*y_err+y_err_sys*y_err_sys)/20);
      
      cout<< y_central<<" Guannan"<< y_err<<"\t"<<y_err_sys<<" \t"<<sqrt(y_err*y_err+y_err_sys*y_err_sys)<<endl;

      
      Ds_10_40_Guannan_sys->GetPoint(i,x_central,y_central);
      y_err_sys=Ds_10_40_Guannan_sys->GetErrorY(i);
      y_err=Ds_10_40_Guannan_sts->GetErrorY(i);
      Ds_10_40_Guannan_sts->SetPoint(i,x_central,y_central/5);
      Ds_10_40_Guannan_sts->SetPointError(i,0,sqrt(y_err*y_err+y_err_sys*y_err_sys)/5);

      mh110_40_Guannan->SetBinContent(i+1,y_central/5);
      mh110_40_Guannan->SetBinError(i+1,sqrt(y_err*y_err+y_err_sys*y_err_sys)/5);

      
      cout<< y_central<<" Guannan"<< y_err<<"\t"<<y_err_sys<<" \t"<<sqrt(y_err*y_err+y_err_sys*y_err_sys)<<endl;
      
      Ds_40_80_Guannan_sys->GetPoint(i,x_central,y_central);
      y_err_sys=Ds_40_80_Guannan_sys->GetErrorY(i);
      y_err=Ds_40_80_Guannan_sts->GetErrorY(i);
      Ds_40_80_Guannan_sts->SetPoint(i,x_central,y_central*2);
      Ds_40_80_Guannan_sts->SetPointError(i,0,sqrt(y_err*y_err+y_err_sys*y_err_sys)*2);

      mh140_80_Guannan->SetBinContent(i+1,y_central*2);
      mh140_80_Guannan->SetBinError(i+1,sqrt(y_err*y_err+y_err_sys*y_err_sys)*2);
  ...
  // combine for 0-80
  mh10_10_Guannan->Scale(N_0_10);
  mh110_40_Guannan->Scale(N_10_40);
  mh140_80_Guannan->Scale(N_40_80);

  mh10_80_Guannan->Add(mh10_10_Guannan);
  mh10_80_Guannan->Add(mh110_40_Guannan);
  mh10_80_Guannan->Add(mh140_80_Guannan);

  mh10_80_Guannan->Scale(1./(N_0_80));

  //  for the plots
  // mh10_80_Guannan->Scale(100.);
  ...
  for(int i=0;i<Ds_0_10_Guannan_sts->GetN();i++)
    {
      ...
      Ds_0_80_Guannan_sts_combine->SetPoint(i,x_central,mh10_80_Guannan->GetBinContent(i+1));
      Ds_0_80_Guannan_sts_combine->SetPointError(i,0,mh10_80_Guannan->GetBinError(i+1));
  ...
  Ds_0_10_Guannan_sts->SetMarkerColor(1);
  Ds_0_10_Guannan_sts->SetLineColor(1);

  Ds_10_40_Guannan_sts->SetMarkerColor(2);
  Ds_10_40_Guannan_sts->SetLineColor(2);
  
  Ds_40_80_Guannan_sts->SetMarkerColor(3);
  Ds_40_80_Guannan_sts->SetLineColor(3);

  Ds_0_80_Guannan_sts->SetLineColor(4);
  Ds_0_80_Guannan_sts->SetMarkerColor(4);
  

   Ds_0_80_Guannan_sts->SetMarkerStyle(20);
  
  Ds_0_10_err->SetMarkerStyle(24);
  Ds_10_40_err->SetMarkerStyle(24);


  Ds_0_80_Guannan_sts_combine->SetMarkerStyle(20);
  Ds_0_80_Guannan_sts_combine->SetMarkerColor(1);
  
  Ds_0_80_Guannan_sts->Draw("samePE");
  Ds_0_80_Guannan_sts_combine->Draw("samePE");


  cDs->SaveAs("Plots/compa_0-80_guana.pdf");
  return 0;
  ...
  /*  
  Ds_0_10_Guannan_sts->Fit("F_levy_Ds_0_10_levy","R0","",1,6.5);
  Ds_0_10_Guannan_sts->Fit("pl_0_10","R0","q",1,6.5);
  ...
  Ds_10_40_Guannan_sts->Fit("F_levy_Ds_10_40_levy","R0","same",1,6.5);
  Ds_10_40_Guannan_sts->Fit("pl_10_40","R0","same",1,6.5);

  F_levy_Ds_10_40_levy->Draw("same");
  pl_10_40->Draw("same");

  
  Ds_40_80_Guannan_sts->Fit("F_levy_Ds_40_80_levy","R0","same",1,6.5);
  Ds_40_80_Guannan_sts->Fit("pl_40_80","R0","",1,6.5);

  F_levy_Ds_40_80_levy->Draw("same");
  pl_40_80->Draw("same");

  */
   Ds_0_80_Guannan_sts->Fit("F_levy_Ds_0_80_levy","R0","",1,6.5);
   Ds_0_80_Guannan_sts->Fit("pl_0_80","R0","",1,6.5);
  ...
  Ds_0_10_Guannan_sts->Draw("samePE");
  Ds_10_40_Guannan_sts->Draw("samePE");
  Ds_40_80_Guannan_sts->Draw("samePE");
  Ds_0_80_Guannan_sts->Draw("samePE");
  ...
  legend_Ds ->AddEntry(Ds_0_10_Guannan_sts,"Ds 0-10% x 10","p");
  legend_Ds ->AddEntry(Ds_10_40_Guannan_sts,"Ds 10-40%","p");
  legend_Ds ->AddEntry(Ds_40_80_Guannan_sts,"Ds 40-80%","p");
  legend_Ds ->AddEntry(Ds_0_80_Guannan_sts,"Ds 0-80% x 100","p");
  ...
  TH1F *mh1Ds_0_80=new TH1F("mh1Ds_0_80","",200,0,20);
