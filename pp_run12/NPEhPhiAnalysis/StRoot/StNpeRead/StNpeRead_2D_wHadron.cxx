...
void StNpeRead::bookObjects()
{
  ...
  for(Int_t trg=0; trg<4; trg+=2)
  {
    ...
    mh3DelPhiPhotLS[trg]     = new TH3F(Form("mh3DelPhiPhotLS_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),80,-2,2.,200,0,20);
    mh3DelPhiPhotUS[trg]     = new TH3F(Form("mh3DelPhiPhotUS_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),80,-2,2.,200,0,20);
    mh3DelPhiPhotUSNP[trg]   = new TH3F(Form("mh3DelPhiPhotUSNP_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),80,-2,2.,200,0,20);
    mh3DelPhiPhotLSNP[trg]   = new TH3F(Form("mh3DelPhiPhotLSNP_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),80,-2,2.,200,0,20);
...
//              mh3DelPhiPhotLS[bTrg] -> Fill(dPhi,epT,hpT,weight); // weight for elect trig eff
              ...
              if(hpT>0.3){
                if(ptrk->gMom().perp()>0.2 && ptrk->gMom().perp()<0.3)mh3DelPhiPhotLS[bTrg] -> Fill(dPhi,dEta,epT,wt);
                if(ptrk->gMom().perp()>0.3 && ptrk->gMom().perp()<0.5)mh3DelPhiPhotLSNP[bTrg] -> Fill(dPhi,dEta,epT,wt);
              }
...
//              mh3DelPhiPhotUS[bTrg] -> Fill(dPhi,epT,hpT,weight); // weight for elect trig eff
              ...
              if(hpT>0.3){
                if(ptrk->gMom().perp()>0.2 && ptrk->gMom().perp()<0.3)mh3DelPhiPhotUS[bTrg] -> Fill(dPhi,dEta,epT,wt);
                if(ptrk->gMom().perp()>0.3 && ptrk->gMom().perp()<0.5)mh3DelPhiPhotUSNP[bTrg] -> Fill(dPhi,dEta,epT,wt);
              }
            }
            // For Pileup
            for(Int_t q = 0; q < 1; q++)
