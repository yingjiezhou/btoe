...
void StNpeRead::bookObjects()
{
  ...
  for(Int_t trg=0; trg<4; trg+=2)
  {
    ...
    //mh2PhiDistPt[trg]        = new TH2F(Form("mh2PhiDistPt_%i",trg),"",100,-0.1,0.1,400,0,20);
    //mh2ZDistPt[trg]          = new TH2F(Form("mh2ZDistPt_%i",trg),"",400,-20,20,400,0,20);
    // mh2PhiQPt[trg]           = new TH2F(Form("mh2PhiQPt_%i",trg),"",100,-0.1,0.1,800,-20,20);
    ...
    //cout << "at delPhi" << endl;
    mh3DelPhiIncl[trg]       = new TH3F(Form("mh3DelPhiIncl_%i",trg),"",100,-0.1,0.1,200,0,20,100,0.,10.);
    mh3DelPhiPhotLS[trg]     = new TH3F(Form("mh3DelPhiPhotLS_%i",trg),"",100,-0.1,0.1,80,-0.1,0.1,200,0,20);
    mh3DelPhiPhotUS[trg]     = new TH3F(Form("mh3DelPhiPhotUS_%i",trg),"",100,-0.1,0.1,80,-0.1,0.1,200,0,20);
    mh3DelPhiPhotUSNP[trg]   = new TH3F(Form("mh3DelPhiPhotUSNP_%i",trg),"",100,-0.1,0.1,80,-0.1,0.1,200,0,20);
    mh3DelPhiPhotLSNP[trg]   = new TH3F(Form("mh3DelPhiPhotLSNP_%i",trg),"",100,-0.1,0.1,80,-0.1,0.1,200,0,20);
    mh3DelPhiPhotInclNP[trg] = new TH3F(Form("mh3DelPhiPhotInclNP_%i",trg),"",100,-0.1,0.1,200,0,20,100,0.,10.);
    ...
    mh3DelPhiInclWt[trg]     = new TH3F(Form("mh3DelPhiInclWt_%i",trg),"",100,-0.1,0.1,200,0,20,100,0.,10.);
    mh3DelPhiPhotLSWt[trg]   = new TH3F(Form("mh3DelPhiPhotLSWt_%i",trg),"",100,-0.1,0.1,200,0,20,100,0.,10.);
    mh3DelPhiPhotUSWt[trg]   = new TH3F(Form("mh3DelPhiPhotUSWt_%i",trg),"",100,-0.1,0.1,200,0,20,100,0.,10.);
    mh3DelPhiInclWt[trg]->Sumw2();mh3DelPhiPhotLSWt[trg]->Sumw2();mh3DelPhiPhotUSWt[trg]->Sumw2();
    
    mh3DelPhiHadHad[trg]     = new TH3F(Form("mh3DelPhiHadHad_%i",trg),"",100,-0.1,0.1,200,0,20,100,0.,10.);
    mh3DelPhiHadHadWt[trg]   = new TH3F(Form("mh3DelPhiHadHadWt_%i",trg),"",100,-0.1,0.1,200,0,20,100,0.,10.);
