...
StNpeRead::StNpeRead(const char* outName)
{
  ...
  fqaCheck = new TNtuple("qaCheck", "qa for gpt sys", "RunNumber:EventNumber:isULS:gpt:ElectronCharge:ElectronpT:ElectronEta:ElectronPhi:HadronCharge:HadronpT:HadronEta:HadronPhi:pCharge:pEta:pPhi:hpion:hkaon:hproton:helectron:trig:nsigmae");
  fincCheck = new TNtuple("incCheck", "inc for gpt sys", "RunNumber:EventNumber:ElectronCharge:ElectronpT:ElectronEta:ElectronPhi:HadronCharge:HadronpT:HadronEta:HadronPhi:hpion:hkaon:hproton:helectron:trig:nsigmae");
  
  TH1F::SetDefaultSumw2();
  mPrescales=prescales::Instance();
  file_runNumber.open("/star/u/yjzhou19/pp_npe/NPEhPhiAnalysis2015/StRoot/StNpeRead/runIDPicoSet.txt");
  SetRunID_VPD();
}
...
void StNpeRead::bookObjects()
{
  ...
  for(Int_t trg=0; trg<4; trg+=2)
  {
    ...
    //mh2PhiDistPt[trg]        = new TH2F(Form("mh2PhiDistPt_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),400,0,20);
    //mh2ZDistPt[trg]          = new TH2F(Form("mh2ZDistPt_%i",trg),"",400,-20,20,400,0,20);
    // mh2PhiQPt[trg]           = new TH2F(Form("mh2PhiQPt_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),800,-20,20);
    ...
    mh2nSigmaElec[trg] = new TH2F(Form("mh2nSigmaElecTrg%i",trg),"",399,-15,15,400,0,20.);
    mh2Pion_nSigmaElec[trg] =new TH2F(Form("mh2Pion_nSigmaElecTrg%i",trg),"",400,0,20, 699,-35,35);
    mh2Kaon_nSigmaElec[trg] =new TH2F(Form("mh2Kaon_nSigmaElecTrg%i",trg),"",400,0,20,699,-35,35);
    mh2Proton_nSigmaElec[trg] =new TH2F(Form("mh2Proton_nSigmaElecTrg%i",trg),"",400,0,20,699,-35,35);
    mh2nSigmaElec_pT[trg]=new TH2F(Form("mh2nSigmaElec_pTTrg%i",trg),"",400,0,20,1399,-35,35);
    // all the cuts appllied
    mEta_ptPion[trg]=new TH2F(Form("mEta_ptPionTrg%i",trg)," ",400,0,20,300,-1.5,1.5);
    mEta_ptKaon[trg]=new TH2F(Form("mEta_ptKaonTrg%i",trg)," ",400,0,20,300,-1.5,1.5);
    mEta_ptProton[trg]=new TH2F(Form("mEta_ptProtonTrg%i",trg)," ",400,0,20,300,-1.5,1.5);
    mEta_ptElec[trg]=new TH2F(Form("mEta_ptElecTrg%i",trg)," ",400,0,20,300,-1.5,1.5);

    mh2nSigmaElec[trg]->Sumw2();
    mh2Pion_nSigmaElec[trg]->Sumw2();
    mh2Kaon_nSigmaElec[trg]->Sumw2();
    mh2Proton_nSigmaElec[trg]->Sumw2();
    mh2nSigmaElec_pT[trg]->Sumw2();
    mEta_ptPion[trg]->Sumw2();
    //========
    ...
    //cout << "at delPhi" << endl;
    mh3DelPhiIncl[trg]       = new TH3F(Form("mh3DelPhiIncl_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiPhotLS[trg]     = new TH3F(Form("mh3DelPhiPhotLS_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiPhotUS[trg]     = new TH3F(Form("mh3DelPhiPhotUS_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiPhotUSNP[trg]   = new TH3F(Form("mh3DelPhiPhotUSNP_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiPhotLSNP[trg]   = new TH3F(Form("mh3DelPhiPhotLSNP_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiPhotInclNP[trg] = new TH3F(Form("mh3DelPhiPhotInclNP_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    ...
    mh3DelPhiInclWt[trg]     = new TH3F(Form("mh3DelPhiInclWt_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiPhotLSWt[trg]   = new TH3F(Form("mh3DelPhiPhotLSWt_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiPhotUSWt[trg]   = new TH3F(Form("mh3DelPhiPhotUSWt_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiInclWt[trg]->Sumw2();mh3DelPhiPhotLSWt[trg]->Sumw2();mh3DelPhiPhotUSWt[trg]->Sumw2();
    
    mh3DelPhiHadHad[trg]     = new TH3F(Form("mh3DelPhiHadHad_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
    mh3DelPhiHadHadWt[trg]   = new TH3F(Form("mh3DelPhiHadHadWt_%i",trg),"",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
  ...
  /// Mixed Events
  mh3MixedDelPhi          = new TH3F("mh3MixedDelPhi","",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
  mh3MixedDelEta          = new TH3F("mh3MixedDelEta","",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
  mh3MixedEtaPhi          = new TH3F("mh3MixedEtaPhi","",100,-TMath::Pi(),TMath::Pi(),200,-5,5,100,0.,10.);
  mh3MixedDelPhiWt        = new TH3F("mh3MixedDelPhiWt","",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
  mh3MixedDelEtaWt        = new TH3F("mh3MixedDelEtaWt","",100,-TMath::Pi(),TMath::Pi(),200,0,20,100,0.,10.);
  mh3MixedEtaPhiWt        = new TH3F("mh3MixedEtaPhiWt","",100,-TMath::Pi(),TMath::Pi(),200,-5,5,100,0.,10.);
  
  // 1D histos for 2.5 to 3.5 GeV epT bin, HT0, hPt>0.3 GeV, For comparison with previous analysis
  mh1delPhiIncl         = new TH1F("mh1delPhiIncl","",100,-TMath::Pi(),TMath::Pi());  // TrigCount bin 1
  mh1delPhiUS           = new TH1F("mh1delPhiUS","",100,-TMath::Pi(),TMath::Pi());    // TrigCount bin 2
  mh1delPhiLS           = new TH1F("mh1delPhiLS","",100,-TMath::Pi(),TMath::Pi());    // TrigCount bin 3
  mh1delPhiHad          = new TH1F("mh1delPhiHad","",100,-TMath::Pi(),TMath::Pi());   // TrigCount bin 4
...
void StNpeRead::zFill_Inclusive (Int_t trg,StDmesonEvent * mNpeEvent ,Double_t ps ) // Fill histograms for events that are non-paired electrons                             
{
  ...
  for(Int_t it=0;it<mNpeEvent->nTracks();it++)
  {
    ...
    mh2nSigmaElec_pT[trg]->Fill(Trk->gMom().perp(),Trk->nSigmaElectron());
    if(abs(Trk->nSigmaPion())<-0.1)mEta_ptUnlike[trg]->Fill(Trk->gMom().perp(),Trk->gMom().pseudoRapidity());
    
    if(pass_cut_GoodTrack(trk) && pass_cut_hTrack(trk)){
      mh2Pion_nSigmaElec[trg]->Fill(Trk->gMom().perp(),Trk->nSigmaElectron()-Trk->nSigmaPion());
      mh2Kaon_nSigmaElec[trg]->Fill(Trk->gMom().perp(),Trk->nSigmaElectron()-Trk->nSigmaKaon());
      mh2Proton_nSigmaElec[trg]->Fill(Trk->gMom().perp(),Trk->nSigmaElectron()-Trk->nSigmaProton());
      if(pass_cut_Pt_Eta(trk) && pass_cut_ADC(trg,trk) &&
         pass_cut_Match_EMC_Dz(trk) && pass_cut_Match_EMC_Dphi(trk) && pass_cut_poe(trk) && pass_cut_EMC(trk)) {
        mh2nSigmaElec[trg]->Fill(Trk->nSigmaElectron(),Trk->gMom().perp());
      }
    }
  }
}
...
void StNpeRead::zFill_Photonic (Int_t bTrg,StDmesonEvent * mNpeEvent ,Double_t ps )
{
  ...
  Float_t tmp[24];
  tmp[0]= mNpeEvent->runId();
  tmp[1]= mNpeEvent->eventId();
  //cout<<"e pair number : "<<mNpeEvent->nElectronPair()<<" e track: "<<mNpeEvent->nTracks()<<endl;
  for(Int_t ip=0;ip<mNpeEvent->nElectronPair();ip++)
  {
    ...
    if(pair->pairDca() < cuts::pairDCA && pair->m() < cuts::massDCA) // Pair Conditions
    {
         ...
         pass_cut_Match_EMC_Dz(etrk) && pass_cut_Match_EMC_Dphi(etrk) && pass_cut_poe(etrk) && pass_cut_EMC(etrk)) // Is track an electron and the ADC0 big enough to be the trigger?
      {
        ...
        tmp[12]=pq;
        tmp[13]=ptrk->gMom().pseudoRapidity();
        tmp[14]=ptrk->gMom().phi();
        ...
        for(Int_t ih = ip; ih < mNpeEvent->nTracks(); ih++) // loop over all tracks in the event
        {
          ...
          if(etrk != htrk && pass_cut_hTrack(htrk)) // Is this track a hadron and not the same track or e-?
          {
            ...
            //            if(pass_cut_GoodTrack(htrk) && pass_cut_nsigmaE(htrk) && pass_cut_Pt_Eta(htrk) && pass_cut_ADC(bTrg,htrk) &&
            //               pass_cut_Match_EMC_Dz(htrk) && pass_cut_Match_EMC_Dphi(htrk) && pass_cut_poe(htrk) && pass_cut_EMC(htrk)) continue;
            //            bool isHadronElec = kFALSE;
            //            for(Int_t hip=0;hip<mNpeEvent->nElectronPair();hip++) // loop over pair branch to check if singleTrack also in Pair
            //            {
            //              StElectronPair* hpair = (StElectronPair*)aPairs->At(hip);
            //              StDmesonTrack*  hetrk = (StDmesonTrack*)aTracks->At(pair->electronId());
            //              StDmesonTrack*  hptrk = (StDmesonTrack*)aTracks->At(pair->partnerId());
            //
            //              if(hptrk->gMom().perp()< cuts::partnerElecGlobalPt) continue;
            //              if((htrk == hetrk || htrk == hptrk) && hpair->pairDca() < cuts::pairDCA && hpair->m() < cuts::massDCA && hetrk->charge()!=hptrk->charge())
            //              {
            //                isHadronElec = kTRUE;
            //              }
            //            }
            //            if(isHadronElec) continue;
            
            tmp[8]=htrk->charge();
            tmp[9]=hpT;
            tmp[10]=hpEta;
            tmp[11]=hPhi;
            tmp[15]=htrk->nSigmaPion();
            tmp[16]=htrk->nSigmaKaon();
            tmp[17]=htrk->nSigmaProton();
            tmp[18]=htrk->nSigmaElectron();
            tmp[19]=bTrg;
            tmp[20]=etrk->nSigmaElectron();
            if(hpT>0.3 && ptrk != htrk && pass_dEta(dEta)) fqaCheck->Fill(tmp);

            Float_t hnSigmaE = htrk->nSigmaElectron();
            if(hnSigmaE>-2. && hnSigmaE<3. && (abs(dPhi)<0.05 && abs(dEta)<0.05)) continue;
            if(eq == pq && pass_dEta(dEta))
            {
...
Bool_t StNpeRead::pass_cut_ADC(Int_t trg, StDmesonTrack* trk)
{
  ...
  //  hTrigEffHT0 = hTrigEffHT0Sys;
  //  hTrigEffHT0 = hTrigEffHT2Sys;
...
Bool_t StNpeRead::pass_cut_hTrack(StDmesonTrack * trk)
{
  ...
  Float_t dca = trk->dca();
  Float_t hnSigmaE = trk->nSigmaElectron();
  //cout<<""
...
Double_t StNpeRead::getTrgEff(Int_t trg, Double_t pt) // from shenghui's ppt trig. effi, use TGraph
{
  Double_t eff = 1;
  if(trg == 0)
  {
    eff = hTrigEffHT0->Eval(pt);
  }
  
  if(trg == 2)
  {
    eff = hTrigEffHT2->Eval(pt);
  }
...
Int_t StNpeRead::readEff()
{
  ...
  mtrigEffi = new TFile("/star/u/yjzhou19/pp_npe/NPEhPhiAnalysis2015/StRoot/StNpeRead/TrigEffGraph.root", "READ");
  if(!mtrigEffi->IsOpen()){
    cout<<"No input trigger efficiency!"<<endl;
    return -1;
  }
  hTrigEffHT0 = (TGraph*)mtrigEffi->Get("hTrigEffHT0");
  hTrigEffHT2 = (TGraph*)mtrigEffi->Get("hTrigEffHT2");
  hTrigEffHT0Sys = (TGraph*)mtrigEffi->Get("hTrigEffHT0Sys");
  hTrigEffHT2Sys = (TGraph*)mtrigEffi->Get("hTrigEffHT2Sys");
