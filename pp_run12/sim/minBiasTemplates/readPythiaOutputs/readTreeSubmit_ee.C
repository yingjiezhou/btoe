...
void readTreeSubmit_EwithE(TString filelist="test.list",TString outFile="test.root")
{
  ...
  for(int i = 0; i < nentries; i++){
    ...
    int ceNtrigcount=0;
    maxptbin = 0;
    totalE = numberofcElectrons+ numberofbcElectrons +numberofbElectrons;
    ...
    for(int trki = 0; trki < numberofcElectrons; trki++){
      ...
      for(int trkj = 0; trkj < totalE; trkj++){
        if(trkj>=0 && trkj<numberofcElectrons){
        ...
        if(trkj>=numberofcElectrons && trkj<numberofcElectrons+numberofbElectrons){
        ...
        if(trkj>=numberofcElectrons+numberofbElectrons && trkj<numberofcElectrons+numberofbElectrons+numberofbcElectrons){
