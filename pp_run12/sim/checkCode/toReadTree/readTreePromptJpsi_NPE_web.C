...
void readTreePromptJpsi_NPE_web(TString filelist="crossSectionE.list",TString outFile="promptJPsiVsNPE.root")
{
  ...
  hbept = new TH1D("hbept", "hbept", 2000., 0., 20.); // total b
  hbcept = new TH1D("hbcept", "hbcept", 2000., 0., 20.);
  hpjpsi = new TH1D("hpjpsi", "hpjpsi", 2000., 0., 20.);
  //=====================================
