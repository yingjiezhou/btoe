void runget_sym_minu_single(const char* FileName="pythia_npe_tree_May18", const char* FileName2="pythia_npe_dist_Jun9_old", const char* FileName3="Jpsi_sys/rootfile/Jpsie_Singlet")
{
...
//  TFile *fsy = new TFile(Form("AfterSub_%s.root", FileName), "RECREATE");
  ...
  TFile *fsy = new TFile("output/pythia_npe_tree_May18_jpsi_Singlet.root", "RECREATE");
