...
void templComp_wE_woE(const char* FileName="npe_woE", const char* FileName2="npe_wE")
{
  ...
  const char* PdfFileName= "templComp_wE_woE";
  char name[1000];
...
//    h2dPhiRawbe[i]->SetLineColor(kRed);
    ...
    leg5->AddEntry(h2dPhiRawbe[i],"b#bar{b}#rightarrow e, w/ E", "l");
    leg5->AddEntry(h2dPhiRawce[i],"c#bar{c}#rightarrow e, w/ E","l");
