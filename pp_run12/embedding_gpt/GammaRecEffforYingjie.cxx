...
int main(int argc, char **argv)
{
	...
	weightFile=new TFile("DataMaker/GetGammaSpectrum/macros/rootfile/GammaSpectrumpp.root","READ");
...
//	hRcptMeeSMD2        = new TH1F("RcptMeeSMD2","",nPtBins-1,ptbinfyj);
  ...
  hRcptMeeSMD3        = new TH2F("RcptMeeSMD3","",1000, 0, 20);
...
//					hRcptPosEleSMD->Fill(P_rcPt,wtPos/P_rcPt); // zyj
...
//					hRcptPosEleSMD->Fill(E_rcPt,wtEle/E_rcPt); //zyj
          hRcptPosEleSMD->Fill(E_rcPt, P_rcPt,wtEle/E_rcPt);
				...
				if(eem<0.24) {
					if(positronPriCutOK && electronParCutOK) { //tag: positron, partner: electron
						if(positronSMDPriCutOK) { //tag: positron, partner: electron
							...
							if(t->E_rcgPt[j]>0.1){
//								hRcptMeeSMD2->Fill(P_rcPt,wt); // zyj
                hRcptMeeSMD2->Fill(P_rcPt, t->E_rcgPt[j],wt);
//                hRcptMeeSMD3->Fill(t->E_rcgPt[j]);
...
//                 hRcptMeeSMD3->Fill(t->P_rcgPt[j]); // zyj
