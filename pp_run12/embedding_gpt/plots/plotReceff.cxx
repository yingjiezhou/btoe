...
void plotReceff()
{
	...
	TH2F *htmp;
	TLegend *lg;
	TFile *f = new TFile("DataMaker/Pi0Dalitz_hist.root");
	...
	TFile *f = new TFile("DataMaker/EtaDalitz_hist.root");
	...
	TFile *f = new TFile("DataMaker/Gamma_hist.root");
	...
	TCanvas *c=Canvas("c",0.18,0.012,0.15,0.06,0,0,0);
	c->SetGrid(1,1);
	////////////////////////////////////////////////////////////////////
	//Rec. eff. Con
	///////////////////////////////////////////////////////////////////
	...
	htmp=histo2D("htmp",20,PtMinhtmp[0],PtMaxhtmp[0],20,0,1.4,"p_{T} (GeV/c)","Reconstruction effciency",0.075,0.85,0.07,0.75);
	//htmp->SetNdivisions(505,"y");
	...
	TFile* file = new TFile("effroot/PHEReceff.root","RECREATE");
	//TFile* file = new TFile("effroot/PHEReceffSysMass.root","RECREATE");
	//TFile* file = new TFile("effroot/PHEReceffSysGpt.root","RECREATE");
	file->cd();
	...
	TFile* file = new TFile("effroot/PHEReceffSys.root","UPDATE");
	file->cd();
	hefffun->Write();
	file->Close();*/
}
