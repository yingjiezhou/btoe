...
void plotRec()
{
  ...
  auto hRcptMeeSMD2_0 = (TH1F*)ftp->ProjectionY("RcptMeeSMD2_0_y");
  ftp = (TH2F*)f->Get("RcptMeeSMD2_2");
  auto hRcptMeeSMD2_2 = (TH1F*)ftp->ProjectionY("RcptMeeSMD2_2_y");
  ftp = (TH2F*)f->Get("hRcptMeeSMD2US_0");
  auto hRcptMeeSMD2US_0 = (TH1F*)ftp->ProjectionY("hRcptMeeSMD2US_0_y");
  ftp = (TH2F*)f->Get("hRcptMeeSMD2US_2");
  auto hRcptMeeSMD2US_2 = (TH1F*)ftp->ProjectionY("hRcptMeeSMD2US_2_y");
  hRcptMeeSMD2US_0->Add(hRcptMeeSMD2_0, -1);
  hRcptMeeSMD2US_2->Add(hRcptMeeSMD2_2, -1);
//  hRcptMeeSMD2US_0->Add(hRcptMeeSMD2US_2, 1);
  hRcptMeeSMD2US_0->Scale(1./hRcptMeeSMD2US_0->Integral());
  hRcptMeeSMD2US_2->Scale(1./hRcptMeeSMD2US_2->Integral());
...
//  RcptMeeGamma->Scale(1e1);
  RcptMeePi0Dalitz->Scale(1./RcptMeePi0Dalitz->Integral());
  RcptMeeGamma->Scale(1./RcptMeeGamma->Integral());
  RcptMeeEtaDalitz->Scale(1./RcptMeeEtaDalitz->Integral());
  
  RcptMeeGamma->GetYaxis()->SetRangeUser(1e-7, 1e1);
