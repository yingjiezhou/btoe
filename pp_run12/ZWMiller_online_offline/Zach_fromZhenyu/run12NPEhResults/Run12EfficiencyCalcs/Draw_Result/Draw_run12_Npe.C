...

{
  ...
  TH1F *run12_HT_NPE_FONLL_sts=(TH1F *)  file_run12_HT->Get("run12_HT_NPE_FONLL_sts"); 
  TH1F *run12_HT_NPE_FONLL_sys=(TH1F *)  file_run12_HT->Get("run12_HT_NPE_FONLL_sys"); 
  ...
  for(Int_t ipt=0;ipt<NpT_bins_run12_HT;ipt++)
    {
      ...
      gr_run12_HT_FONLL_sys->SetPointError(ipt,0.1,gr_run12_HT_FONLL_sys->GetErrorY(ipt));
...
// run12 MB
  ...
  TGraphErrors* gr_run12_MB_FONLL_sts = new TGraphErrors(run12_MB_NPE_FONLL_sts);
  TGraphErrors* gr_run12_MB_FONLL_sys = new TGraphErrors(run12_MB_NPE_FONLL_sys);



  gr_run12_MB_sys->SetLineColor(gColor12MB);
  gr_run12_MB_sts->SetMarkerStyle(gMStyle12MB);
  gr_run12_MB_sts->SetMarkerColor(gColor12MB);
  gr_run12_MB_sts->SetLineColor(gColor12MB);
  gr_run12_MB_sts->SetMarkerSize(1);
  gr_run12_MB_sys->SetMarkerSize(1);




  gr_run12_MB_FONLL_sys->SetLineColor(gColor12MB);
  gr_run12_MB_FONLL_sts->SetMarkerStyle(gMStyle12MB);
  gr_run12_MB_FONLL_sts->SetMarkerColor(gColor12MB);
  gr_run12_MB_FONLL_sts->SetLineColor(gColor12MB);
  gr_run12_MB_FONLL_sts->SetMarkerSize(1);
  gr_run12_MB_FONLL_sys->SetMarkerSize(1);
  ...
  gr_run12_MB_sys->SetLineColor(gColor12MB_fill);
  gr_run12_MB_sys->SetFillStyle(1001);
  gr_run12_MB_sys->SetFillColor(gColor12MB_fill);

  gr_run12_MB_FONLL_sys->SetLineColor(gColor12MB_fill);
  gr_run12_MB_FONLL_sys->SetFillStyle(1001);
  gr_run12_MB_FONLL_sys->SetFillColor(gColor12MB_fill);
...
// run08
  ...
  line1->Draw("same");
  cc1->SaveAs("run12_cross_section.pdf");
