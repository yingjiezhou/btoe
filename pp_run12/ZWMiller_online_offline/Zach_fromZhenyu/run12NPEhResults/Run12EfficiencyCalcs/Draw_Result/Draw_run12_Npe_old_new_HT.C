...
char buf[1024];
void Draw_run12_Npe_old_new_HT()

{
  ...
  TGraphErrors* PhNEX_sts = new TGraphErrors("Data_Model/NPE_cross_section.dat","%lg %lg %lg");
  TGraphErrors* PhNEX_sys = new TGraphErrors("Data_Model/NPE_cross_section.dat","%lg %lg %*lg %lg");
  ...
  legend_2 ->AddEntry(gr_run12_HT_sts,"Run12 BEMC old","lp");
  // legend_2 ->AddEntry(data09_stat_err,"Run09","lp");
  //  legend_2 ->AddEntry(gr_run08_HT_sts,"Run05+Run08","lp");
   legend_2 ->AddEntry(PhNEX_sts,"Run12 BEMC old","lp");
  ...
  cc1->SaveAs("run12_cross_section_HT.pdf");
