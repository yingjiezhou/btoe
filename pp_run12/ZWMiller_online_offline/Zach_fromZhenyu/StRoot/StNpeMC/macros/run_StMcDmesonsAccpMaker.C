void run_StMcDmesonsAccpMaker(const char* file, const char* outfile) 
{
    ...
    triggers.push_back(370001);
    triggers.push_back(370011);
    //triggers.push_back(370501); //
    //triggers.push_back(370511); //
    //triggers.push_back(370522); //

    
    // Monte Carlo event maker
    StMcDmesonsAccpMaker* analysis = new StMcDmesonsAccpMaker(simuTrig,outfile,triggers);
