...
//  gStyle->SetOptStat(0);
  ...
  if (C) delete C;
  C = new TCanvas("C","canvas",50,198,1016,569);
  C->SetFillStyle(4000);
...
//      bClone2->SetLineWidth(2);
      ...
      legg->AddEntry(cClone,"Template Fit","lp");
      
      
      TPaveText* Name = new TPaveText(0.2,0.82,0.47,0.89,"BRNDC");
      ...
      if(j == 1){
        ...
        Style(dClone,1,1,1,8,1,1,"p");
        Style(cClone,1,1,1,8,kGreen+2,1,"same hist][");
        Style(cClone2,1,1,1,8,kBlue,1,"same pe");
        Style(bClone2,1,1,1,8,kRed,1,"same pe");
...
//        bClone2->Draw("same pe");
        ...
        sprintf(ptShow,"#it{p}_{T} #in [%1.1f,%1.1f] GeV",lowpt[i], highpt[i]);
        sprintf(entr,"High Tower 2");
        
        tx.SetTextSize(0.07);
        tx.DrawLatex(0.5,0.86,chi2);
...
//        Fit_Ratio->GetXaxis()->SetTitleOffset(5);
        ...
        Style(Fit_Ratio,1,1,1,8,1,1,"pe");
//        Fit_Ratio->Draw("pe");
        ll->Draw("same");
      }
