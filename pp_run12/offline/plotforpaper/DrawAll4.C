...
//  gStyle->SetOptStat(0);
  ...
  if (C) delete C;
  C = new TCanvas("C","canvas",95,163,1032,489);
  C->SetFillStyle(4000);
...
//      dClone->GetYaxis()->SetTitleOffset(3);
      ...
      dClone->GetXaxis()->SetTitleFont(42);
      dClone->GetYaxis()->SetLabelFont(42);
      dClone->GetYaxis()->SetTitleFont(42);
      dClone->GetYaxis()->SetLabelSize(0.09);
      dClone->GetYaxis()->SetTitleSize(0.1);
      dClone->GetYaxis()->SetTitleOffset(1.);
...
//      txt1->AddText(chi2);
      ...
      if(j == 1){
        ...
        Style(cClone,1,kGreen+2,2,8,kGreen+2,0.8,"same hist][");
...
//        Fit_Ratio->SetTitle(0);
        Fit_Ratio->GetYaxis()->SetRangeUser(0.5,1.5);
        
//        Fit_Ratio->GetYaxis()->SetLabelFont(42);
        Fit_Ratio->GetYaxis()->SetLabelSize(0.16);
        Fit_Ratio->GetYaxis()->SetTitleSize(0.18);

//        Fit_Ratio->GetYaxis()->SetLabelOffset(0.48);
//        Fit_Ratio->GetYaxis()->SetTitleFont(43);
        Fit_Ratio->GetYaxis()->SetTitleOffset(0.39);
        ...
        Fit_Ratio->GetXaxis()->SetTitleFont(42);
        Fit_Ratio->GetYaxis()->SetLabelFont(42);
        Fit_Ratio->GetYaxis()->SetTitleFont(42);
        
        Fit_Ratio->GetXaxis()->SetTitleOffset(0.86);
        Fit_Ratio->GetXaxis()->SetLabelSize(0.16);
        Fit_Ratio->GetXaxis()->SetTitleSize(0.2);
