...
//  auto fpht3 = new TF1("fht3", "TMath::Erf(6.48257e-01*x - 2.70569e+00)-8.95563e-03", 4.5, 20);
  ...
  auto fpht1 = new TF1("fht1", "TMath::Erf(x - 2.55666e+00)-6.00096e-03", 2, 20);
  auto fpht2 = new TF1("fht2", "TMath::Exp(-8.80280e+00+1.64328e+00*x)-1.41027e-02", 0, 5.1);
  auto fpht3 = new TF1("fht3", "TMath::Erf(6.48257e-01*x-2.70569e+00)-8.95634e-03", 5, 20);
  fpht1->SetLineColor(kRed);
  fpht2->SetLineColor(kRed);
  fpht3->SetLineColor(kRed);
  
  cout<<fht1->Eval(2.6)<<"  "<<fht1->Eval(2.7)<<endl;
  cout<<fpht1->Eval(2.6)<<"  "<<fpht1->Eval(2.7)<<endl;

//  cout<<fpht2->Eval(3.5)<<endl;
//  cout<<fpht3->Eval(5)<<endl;
