void drawtext();
void makePlot_hadron_gpt_ppt(const char* FileName="hadron_gpt_ppt"){
  ...
  auto fyj = new TFile(Form("FFOutput_hadron_ppt/sysChange_default_May5_FIT.root", FileName), "READ");
...
//  leg->AddEntry(stat6,"Run 5/6 p+p 200 GeV","pe");
  ...
  leg->AddEntry(hdf,"use gpT for hadron","pe");
//  leg->AddEntry(hbyjUp,"Norm.(central+err)","pe");
  leg->AddEntry(hbyj,"use ppT for hadron","pe");
