...
void offline_addPartnerCorr_addSplitCut_usePartner_looseSplitCut(const char* FileName="May5", const char* FileNameR="default", Bool_t doPurity = kFALSE, Bool_t doRec = kFALSE)
{
  ...
  else sprintf(name,"output/data/out_addPartnerCorr_withSplitCut_default_moreLooseSplitcut0p1.root"); // modified PHE loop
  if(doRecGpt) sprintf(name,"output/data/out_addPartnerCorr_withSplitCut_gpt_moreLooseSplitcut0p1.root");
