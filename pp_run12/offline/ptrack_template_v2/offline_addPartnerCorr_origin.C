...
void offline_addPartnerCorr_origin(const char* FileName="May5", const char* FileNameR="default", Bool_t doPurity = kFALSE, Bool_t doRec = kFALSE)
{
...
//  if(doRecGpt) sprintf(name,"output/data/out_addPartnerCorr_gpt.root");
  
  else sprintf(name,"output/data/out_addPartnerCorr_origin_default.root"); // modified PHE loop
  if(doRecGpt) sprintf(name,"output/data/out_addPartnerCorr_origin_gpt.root");
