//------------------------------------------------------------------------------
// $Id: StRefMultCorr.cxx,v 1.1 2020/06/16 15:35:19 fuchuan Exp $
// $Log: StRefMultCorr.cxx,v $
// Revision 1.1  2020/06/16 15:35:19  fuchuan
// version1.0
//
    ...
    const Double_t zdcCoincidenceRate, const UInt_t flag) const
{
  ...
  //cout << "mPar_luminosity[0] = " << mPar_luminosity[0][mParameterIndex] << ";mPar_luminosity[1] = " << mPar_luminosity[1][mParameterIndex] << endl;
