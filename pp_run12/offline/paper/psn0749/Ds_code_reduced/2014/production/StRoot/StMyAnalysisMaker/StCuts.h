...
float const trkDca     = 0.0070; /* >70 um */
float const trkPt      = 0.5;	 /* >0.5 GeV */
float const eta        = 1.0;
...
float const dcaDaughters = 0.0200; /* Maximum dca daughters */
float const secSigma     = 0.0300; /* Maximum secSigma */
float const decayLength  = 0.0050; /* Minimum decay Length */
float const minMass 	 = 1.8;	   /* Mass low */
float const maxMass 	 = 2.2;	   /* Mass high */
