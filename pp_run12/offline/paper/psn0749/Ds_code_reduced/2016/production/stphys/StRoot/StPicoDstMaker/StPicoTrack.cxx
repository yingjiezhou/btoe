...
StPicoTrack::StPicoTrack() : TObject(),
  ...
  mDedx(0.), mDnDx(0.), mDnDxError(0.), mNHitsFit(0), mNHitsMax(0), mNHitsDedx(0), mCharge(0), mPar(), mErrMatrix(),
...
//----------------------------------------------------------------------------------
StPicoTrack::StPicoTrack(StMuTrack const* const gTrk, StMuTrack const* const pTrk, double const B, StThreeVectorD const& pVtx, StDcaGeometry const* const dcaG)
  : StPicoTrack()
{
