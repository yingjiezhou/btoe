...
public:
  ...
  StPicoTrack(StMuTrack const* globalTrack, StMuTrack const* primaryTrack, double magField, StThreeVectorD const& pVtx, StDcaGeometry const* const dcaG);
  virtual ~StPicoTrack() {}
...
{
  StDcaGeometry a;
//for(int i = 0; i<=5; i++){ cout << " mPar[6] =" << mPar[i] << endl;}
