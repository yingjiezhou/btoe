//------------------------------------------------------------------------------
// $Id: StRefMultCorr.cxx,v 1.1 2020/06/16 15:48:57 fuchuan Exp $
// $Log: StRefMultCorr.cxx,v $
// Revision 1.1  2020/06/16 15:48:57  fuchuan
// version1.0
//
    ...
    const Double_t zdcCoincidenceRate, const UInt_t flag) const
{
 ...
 //cout<< "mPar_z_vertex[0][mParameterIndex] =" << mPar_z_vertex[0][mParameterIndex] << endl;
...
Double_t StRefMultCorr::getWeight() const
{
  ...
  //cout << "mPar_weight[0][mParameterIndex] = " << mPar_weight[0][mParameterIndex] << endl;
