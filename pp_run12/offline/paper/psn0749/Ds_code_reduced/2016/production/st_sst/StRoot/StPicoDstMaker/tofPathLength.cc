 /***************************************************************************
 *
 * $Id: tofPathLength.cc,v 1.1 2020/06/16 16:06:16 fuchuan Exp $
 *
 * Author: Frank Geurts
 ***************************************************************************
 *
...
double tofPathLength(const TVector3*  beginPoint, const TVector3* endPoint, const double curvature){
