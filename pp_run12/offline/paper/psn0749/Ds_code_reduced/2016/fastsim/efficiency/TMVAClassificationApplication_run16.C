...
void TMVAClassificationApplication_run16(TString fname = "Lc.root", TString myMethodList = "BDT" ) 
{   
#ifdef __CINT__
	...
	Float_t dcaDaughters, Eta, piRDca, RDca12, dcaLcToPv, rPtpi, rPt12, rPt, massDiff, decayLength, cosTheta, k1RDca, k2RDca, rM, rY, cent, flag ;
	...
	TString weightfile_1525_010 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/Train/010_1525/run16/weights_phyAndsst_run16/TMVAClassification_BDT.weights.xml";
	reader_1525_010->BookMVA( methodName, weightfile_1525_010 ); 

	TString weightfile_258_010 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/Train/010_258/run16/weights_phyAndsst_run16/TMVAClassification_BDT.weights.xml";
	reader_258_010->BookMVA( methodName, weightfile_258_010 ); 

	TString weightfile_125_1020 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/Train/1020_125/run16/weights_phyAndsst_run16/TMVAClassification_BDT.weights.xml";
	reader_125_1020->BookMVA( methodName, weightfile_125_1020 ); 

	TString weightfile_258_1020 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/Train/1020_258/run16/weights_phyAndsst_run16/TMVAClassification_BDT.weights.xml";
	//TString weightfile_258_1020 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/TrainingandApp_Ds_18_1080_long/2.5_8/weights_run16_phyAndsst_WideMass/TMVAClassification_BDT.weights.xml";
	reader_258_1020->BookMVA( methodName, weightfile_258_1020 ); 

	TString weightfile_125_2040 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/Train/2040_125/run16/weights_phyAndsst_run16/TMVAClassification_BDT.weights.xml";
	reader_125_2040->BookMVA( methodName, weightfile_125_2040 ); 

	TString weightfile_258_2040 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/Train/2040_258/run16/weights_phyAndsst_run16/TMVAClassification_BDT.weights.xml";
	reader_258_2040->BookMVA( methodName, weightfile_258_2040 ); 

	TString weightfile_158_4080 = "/star/u/fuchuan/data02/Ds/Ds_code_GPC/BDT/Train/4080_158/run16/weights_phyAndsst_run16/TMVAClassification_BDT.weights.xml";
	...
	theNtuple->SetBranchAddress( "Eta",     &Eta );
	...
	for (Long64_t ievt=0; ievt<theNtuple->GetEntries();ievt++) {
		...
		if (rPtpi<=0.6 || rPt12<=0.5 || k1RDca<=0.006 || piRDca<=0.006 || k2RDca<=0.006 || dcaDaughters>=0.01 || decayLength<=0.012 || cosTheta<=0.98 || cosTheta>=1 || massDiff>=0.008 || rM<=1.8 || rM>=2.1 ||  fabs(rY)>=1 || rPt<1 || rPt >8)	
		{
