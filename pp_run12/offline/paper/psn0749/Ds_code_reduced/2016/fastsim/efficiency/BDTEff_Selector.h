...
#ifndef BDTEff_Selector_h
#define BDTEff_Selector_h
...
class BDTEff_Selector : public TSelector {
public :
...
TTree *DsSig;
  ...
  // List of branches
   ...
   TBranch        *b_mBdt    ;   //!
   TBranch        *b_TpcWeight ;
   BDTEff_Selector(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~BDTEff_Selector() { }
   ...
   ClassDef(BDTEff_Selector,0);
};

#endif

#ifdef BDTEff_Selector_cxx
void BDTEff_Selector::Init(TTree *tree)
{
...
#endif // #ifdef BDTEff_Selector_cxx
