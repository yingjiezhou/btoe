...
void systematicsMinuit(const char* FileName="May5", const char* FileNameR="default", Bool_t doPileup = kFALSE, Bool_t doPythia = kFALSE, Bool_t doFitRange = kFALSE, Bool_t doJpsi = kFALSE)
{
//  bUp = kTRUE;
//  bDown = kTRUE;
