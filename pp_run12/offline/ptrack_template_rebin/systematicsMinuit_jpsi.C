...
//  sprintf(name,"minBiasTemplates111915/readTreeOutput/input/pythia_npe_tree_May9.root"); // from yjzhou
  if(doPythia) sprintf(name,"output/sim/pythia_npe_tree_May26.root");// new, bak
  if(doPythia && doJpsi) sprintf(name,"output/sim/AfterSub_pythia_npe_tree_May18.root");// new, bak
