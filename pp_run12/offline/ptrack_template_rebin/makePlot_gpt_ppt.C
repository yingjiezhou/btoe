void drawtext();
void makePlot_gpt_ppt(const char* FileName="gpt_ppt"){
...
//  gStyle->SetOptFit(1111);
  ...
  auto fyjd = new TFile(Form("../offlineNPEh_gpt/FFOutput/sysChange_default_Mar3_1_FIT.root", FileName),"READ"); // gpt
  auto hd = (TGraphAsymmErrors *)fyjd->Get("HT0");
  auto hnorm = (TGraphAsymmErrors *)fyjd->Get("normsmall");
  
  auto fyj = new TFile(Form("FFOutput/sysChange_default_May5_FIT.root", FileName), "READ");
