...
void systematicsMinuit(const char* FileName="Mar3_1", const char* FileNameR="default")
{
...
//  gMinuit->mnparm(0,"BtoNPE frac",vstart[0],step[0], 0, 0, ierflg);
  gMinuit->mnparm(1,"Scale Factor",vstart[1],step[1], 0, 0, ierflg);
...
//  if(ptbin <2) FITPARAS = 1.02777;
//   else FITPARAS = 1.03988;
