...
void previousDataMinuit()
{
  ...
  sprintf(name,"/Users/zhouyingjie/Local/PWG/NPE/1_pp_zamiller/minBiasTemplates111915/readTreeOutput/pythia/readTreeOut_Dec22.root");
  TFile *fT = new TFile(name,"READ");
  
  //  sprintf(name,"/Users/zach/Research/rootFiles/run12NPEhPhi/currentData.root");
  sprintf(name,"npe_tree_Oct12_1_processed.root");
...
//    cout << ptbin << "; 0: " << norm0 << " 2: " << norm2 << endl;
  ...
  TGraphErrors *grPr    = new TGraphErrors(2,pTP,RbP,0,EbP); //? zyj
