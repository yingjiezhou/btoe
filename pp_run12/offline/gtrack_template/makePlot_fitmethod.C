void drawtext();
void makePlot_fitmethod(const char* FileName="fitmethod_comp"){
...
//  gStyle->SetOptFit(1111);
  ...
  auto fyj = new TFile(Form("FFOutput/sysChange_FitMethod2_Mar3_1_FIT.root", FileName), "READ");
...
//  leg->AddEntry(stat6,"Run 5/6 p+p 200 GeV","pe");
  ...
  leg->AddEntry(hdf,"gpt, default","pe");
//  leg->AddEntry(hbyjUp,"Norm.(central+err)","pe");
  leg->AddEntry(hbyj,"gpt, fitMethod2","pe");
