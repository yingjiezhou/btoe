...
Double_t FITPARAS = 1.034-0.01067; // From Fit of P1. Error is 0.007 on fit`
//1.034 ± 0.01067
...
void systematicsMinuit(const char* FileName="Mar3_1", const char* FileNameR="fitNormPlusv1")
{
...
//  sprintf(name,"/Users/zach/Research/rootFiles/run12NPEhPhi/currentDataSystematics.root");
  ...
  else if(doNorm) sprintf(name,Form("FFOutput/npe_tree_%s_processed_default.root", FileName));
  ...
  for(Int_t ptbin=0; ptbin<9; ptbin++)
  {
    ...
    if(doPileup){
      ...
      for(int i = 0; i < 2; i++){
        ...
        beforeShift->GetYaxis()->SetRangeUser(-.02,.02);
...
//    doFit(gMinuit,p01[ptbin],p00[ptbin],e01[ptbin],e00[ptbin]);
    else doFit(gMinuit,p01[ptbin],p00[ptbin],e01U[ptbin],e00U[ptbin],e01D[ptbin],e00D[ptbin]);
...
//    doFit(gMinuit,p21[ptbin],p20[ptbin],e21[ptbin],e20[ptbin]);
    else doFit(gMinuit,p21[ptbin],p20[ptbin],e21U[ptbin],e20U[ptbin],e21D[ptbin],e20D[ptbin]);
