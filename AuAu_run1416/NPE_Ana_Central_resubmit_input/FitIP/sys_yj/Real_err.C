...
//=========  (Thu Oct 10 14:51:46 2019) by ROOT version 6.16/00
   ...
   er__1->SetBinContent(5,0.03544177);
   er__1->SetBinContent(6,0.02573205);
   er__1->SetBinContent(7,0.04637896);
   er__1->SetBinContent(8,0.02507216);
   er__1->SetMinimum(0);
