...
void fitdata1D(TH1F* hpovere,TH1F* hnsige,TH1F* hdeltabeta,TH1F* hzdist, TH1F* hphidist,int save,char *outputfile,int pt,double ptLow ,double ptHigh)
{
  ...
  RooRealVar frac1("frac1","frac1",0.6,0,1); //0.5 0813 fraction越小，sigma 越大，越平坦
  ...
  RooRealVar sigma1_zdist("sigma1_zdist","sigma1_zdist",5,5,10);
  RooRealVar sigma2_zdist("sigma2_zdist","sigma2_zdist",5,2,10);
  ...
  RooRealVar frac1_zdist("frac1_zdist","frac1_zdist",0.2,0,1);
  RooRealVar frac2_zdist("frac2_zdist","frac2_zdist",0.9,0,1); //0817
  ...
  sigma1_zdist.setVal(9);
  sigma2_zdist.setVal(3);
  mean1_zdist.setVal(0.2);
  
  if(1) g1_zdist = new RooAddPdf("g1_zdist","g1_zdist",g1_1_zdist,g1_2_zdist,frac1_zdist);
  //if(1) g1_zdist = new RooAddPdf("g1_zdist","g1_zdist",g1_1_zdist);
  ...
  RooRealVar sigma1_phidist("sigma1_phidist","sigma1_phidist",0.01,0.01,0.1);
  RooRealVar sigma2_phidist("sigma2_phidist","sigma2_phidist",0.01,0.01,0.1);
  RooRealVar sigma3_phidist("sigma3_phidist","sigma3_phidist",0.01,0.01,0.1);
  ...
  RooRealVar frac1_phidist("frac1_phidist","frac1_phidist",0.1,0,1);
  RooRealVar frac2_phidist("frac2_phidist","frac2_phidist",0.6,0,1); //0814
  ...
  if(save && pt==2){
    c_povere->SaveAs("plots/Electron_POverE_Fit_highPt.pdf"); // should be named in _highpT???? zyj
    c_nsige->SaveAs("plots/Electron_NSigmae_Fit_highPt.pdf");
    c_deltabeta->SaveAs("plots/Electron_DeltaBeta_Fit_highPt.pdf");
    c_zdist->SaveAs("plots/Electron_ZDist_Fit_highPt.pdf");
    c_phidist->SaveAs("plots/Electron_PhiDist_Fit_highPt.pdf");
    TFile f(outputfile,"RECREATE");
    weight_povere->Write("electron_weight_povere");
    weight_nsige->Write("electron_weight_nsige");
    weight_deltabeta->Write("electron_weight_deltabeta");
