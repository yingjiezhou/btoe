...
void doLikelihood(){
  ...
  //leg->Draw("same");
  canv2->SaveAs("plots_likelihood_yj_B10_beta/Elec_pion_Probability.pdf");
  //========================================================================
  ...
  line->Draw("same hist");
  leg->Draw("same");
  canv4->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Cut_Effi.pdf");
  //========================================================================
  ...
  ROC->Draw("P");
  cpp->SaveAs("plots_likelihood_yj_B10_beta/ROC.pdf");
  //========================================================================
  ...
  canvsig->SaveAs("plots_likelihood_yj_B10_beta/Signi.pdf");
  //========================================================================
  ...
  leg2->Draw("same");
  canv1->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Response_Comparision.pdf");
  canv1->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Response_Comparision.C");
  //========================================================================
  ...
  leg2->Draw("same");
  cp->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Response_Comparision_post.pdf");
  cp->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Response_Comparision_post.C");
  ...
  canv5->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Efficiency_pt.pdf");
  canv5->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Efficiency_pt.C");
  //=========================================================================

  /*
  TCanvas *canv51 = new TCanvas ("canv51","DLL Rat");
  pt_eff_r->Draw("PE");
  canv51->SaveAs("plots_likelihood_yj_B10_beta/DLL_Rat.pdf");
  */
  //=========================================================================
  ...
  leg1->Draw("same");
  canv55->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Efficiency_diff_MVACut.pdf");
  canv55->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Efficiency_diff_MVACut.C");
  //=========================================================================
  ...
  canv6->SaveAs("plots_likelihood_yj_B10_beta/corr_electron.pdf");
  //=========================================================================
  ...
  hOverlap->Draw();
  canv9->SaveAs("plots_likelihood_yj_B10_beta/overlap.pdf");
  //=========================================================================
  ...
  leg12->Draw("same");
  canv25->SaveAs("plots_likelihood_yj_B10_beta/Likelihood_Efficiency_Nsigma_e.pdf");
  //=========================================================================
  ...
  canv7->SaveAs("plots_likelihood_yj_B10_beta/nsige_dll_dist.pdf");
  //=========================================================================
  ...
  canv77->cd(2);
  DLL_p_pt->Draw("COLZ");
  canv77->SaveAs("plots_likelihood_yj_B10_beta/pt_dll_dist.pdf");
