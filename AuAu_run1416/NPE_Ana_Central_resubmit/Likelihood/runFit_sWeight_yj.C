...
void runFit_sWeight_yj(int save=1){
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  if(pt>0){
    sprintf(cut_s,"probe_nsige<4 && probe_nsige>-4 && probe_emc0>0 && probe_charge*tag_charge<0 && probe_pt>%1.1f && probe_pt<%1.1f &&probe_p/probe_emc0<4 &&probe_zdist<20 &&probe_zdist>-20",binning[pt-1],binning[pt]);
    sprintf(cut_b,"probe_nsige<4 && probe_nsige>-4 && probe_emc0>0 && probe_charge*tag_charge>0 && probe_pt>%1.1f && probe_pt<%1.1f &&probe_p/probe_emc0<4&&probe_zdist<20 &&probe_zdist>-20",binning[pt-1],binning[pt]);
    sprintf(cut_s_beta,"probe_beta>0 && probe_nsige<4 && probe_nsige>-4 && probe_emc0>0  && probe_charge*tag_charge<0 && probe_pt>%1.1f && probe_pt<%1.1f &&probe_p/probe_emc0<4 &&probe_zdist<20 &&probe_zdist>-20",binning[pt-1],binning[pt]);
    sprintf(cut_b_beta,"probe_beta>0 && probe_nsige<4 && probe_nsige>-4 && probe_emc0>0 && probe_charge*tag_charge>0 && probe_pt>%1.1f && probe_pt<%1.1f &&probe_p/probe_emc0<4 &&probe_zdist<20 &&probe_zdist>-20",binning[pt-1],binning[pt]);
  ...
  if(pt == 2) {
    file = "root/weights_electron_highPt.root";
    file_pion = "root/weights_pion_highPt.root";
  }
  ...
  sprintf(dFile,"/Volumes/YJMAC/Matt_production/NPE_Tuples_Central5_resubmit.root");
...
void doLikelihood(){
  ...
  //leg->Draw("same");
  canv2->SaveAs("plots_yj/Elec_pion_Probability.pdf");
  //========================================================================
  ...
  line->Draw("same hist");
  leg->Draw("same");
  canv4->SaveAs("plots_yj/Likelihood_or_response_Cut_Effi.pdf");
  //========================================================================
  ...
  sign->Draw("P");
  canvsig->SaveAs("plots_yj/Signi.pdf");
  //========================================================================
  ...
  leg2->Draw("same");
  canv1->SaveAs("plots_yj/Likelihood_Response_Comparision.pdf");
  //========================================================================
  ...
  leg2->Draw("same");
  cp->SaveAs("plots_yj/Likelihood_Response_Comparision_post.pdf");
  //========================================================================
  // sigma_e eff
  ...
  /*
   ...
   canv5->SaveAs("plots_yj/Likelihood_Efficiency_pt.pdf");
   //=========================================================================
   
   TCanvas *canv51 = new TCanvas ("canv51","DLL Rat");
   pt_eff_r->Draw("PE");
   canv51->SaveAs("plots_yj/DLL_Rat.pdf");
   //=========================================================================
   ...
   leg1->Draw("same");
   canv55->SaveAs("plots_yj/Likelihood_Efficiency_diff_MVACut.pdf");
   //=========================================================================
   ...
   canv6->SaveAs("plots_yj/corr_electron.pdf");
   //=========================================================================
   ...
   hOverlap->Draw();
   canv9->SaveAs("plots_yj/overlap.pdf");
   //=========================================================================
   ...
   leg12->Draw("same");
   canv25->SaveAs("plots_yj/Likelihood_Efficiency_Nsigma_e.pdf");
   //=========================================================================
   ...
   canv7->SaveAs("plots_yj/nsige_dll_dist.pdf");
   //=========================================================================
   ...
   canv77->cd(2);
   DLL_p_pt->Draw("COLZ");
   canv77->SaveAs("plots_yj/pt_dll_dist.pdf");
