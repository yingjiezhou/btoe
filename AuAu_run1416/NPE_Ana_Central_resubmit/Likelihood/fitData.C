...
void fitdata1D(TH1F* hpovere,TH1F* hnsige,TH1F* hdeltabeta,TH1F* hzdist, TH1F* hphidist,int save,char *outputfile,int pt,double ptLow ,double ptHigh)
{
  ...
  RooRealVar frac1_deltabeta("frac1_deltabeta","frac1_deltabeta",0.8,0,1); //0.8 0813
  ...
  RooRealVar sigma1_zdist("sigma1_zdist","sigma1_zdist",5,0.2,15);// 5, 0.5, 10
  ...
  RooRealVar frac1_zdist("frac1_zdist","frac1_zdist",0.9,0,1); //0.2->0.9
  ...
  RooRealVar sigma1_phidist("sigma1_phidist","sigma1_phidist",0.01,0.0001,0.1); //0.01,0.01,0.1
  ...
  RooRealVar frac1_phidist("frac1_phidist","frac1_phidist",0.9,0,1); //0.1->0.9
  ...
  if(1)g1_phidist = new RooAddPdf("g1_phidist","g1_phidist",g1_1_phidist,g1_2_phidist,frac1_phidist);
