...
void plotAllSyst_old_yj(int savefrac = 0){
  ...
  TFile * f= new TFile("../../NPE_MC/Ana/root_yj/HF_plots_C5_yj.root");
...
// pp
  ...
  ccharm->SaveAs("sys_yj/charm_spectrum_Qing.pdf");
  //======================================================================
  ...
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,1,"./11133333/yields.dat",1,y_sys_mb);//Central 11
  //getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,1,"./1111133/yields.dat",1,y_sys_mb);//Central 11
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,2,"./7702/yields.dat",0,y_sys_mb);//phoe 1-pion
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,3,"./7704/yields.dat",0,y_sys_mb);//phoe 1-gamma
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,4,"./7706/yields.dat",0,y_sys_mb);// phoe 2
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,5,"./7708/yields.dat",0,y_sys_mb);// pt spectra
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,6,"./7710/yields.dat",0,y_sys_mb);// pt spectra
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,7,"./7712/yields.dat",0,y_sys_mb);// more dp fragmetation
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,8,"./7714/yields.dat",2,y_sys_mb);// less dp fragmetation
  ...
  */
  ...
  leg4->Draw("same");
  gPad->RedrawAxis();
  cy->SaveAs("sys_yj/yields_Qing.pdf");
  //======================================================================
  ...
  leg3->Draw("same");
  //Name11->Draw("same");
  c1->SaveAs("sys_yj/Final_fraction_Qing.pdf");
  //======================================================================
  ...
  er_ht->Draw("same");
  leg22->Draw("same");
  c2->SaveAs("sys_yj/Real_err_Qing.pdf");
  ...
  Name1->Draw("same");
  gPad->RedrawAxis();
  c3->SaveAs("sys_yj/MB_HT_average_Qing.pdf");
  //======================================================================
  // relative error
  for(int i = 5; i<10; i++){
  ...
  leg11->Draw("same");
  c34->SaveAs("sys_yj/realative_err_Qing.pdf");
  //======================================================================
  ...
  */
  ...
  func2.Draw("same l");
  func22.Draw("same l");
  cspread->SaveAs("sys_yj/spread_Qing.pdf");
  ...
  legg->Draw("same");
  Name1->Draw("same");
  c44->SaveAs("sys_yj/raa_fraction_Qing.pdf");
  //======================================================================
  ...
  c4->SaveAs("sys_yj/FracComp_errors_Qing.pdf");
  //======================================================================
  ...
  if(1){
    TFile save("root_yj/FracB_Qing.root","RECREATE");
    h_ave->Write("fb");
