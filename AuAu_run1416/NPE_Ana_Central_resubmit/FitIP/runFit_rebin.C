#include "fitdata1D_yj.C"
void Iso_Efficiency(TH1F *comp__5);
//#include "fit_tfraction.C"
void runFit_rebin(int rs=1,int save=1, int doAllFits=1, int HT=0)
{
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  //for(int pt=ptStart;pt<ptStart+1;pt++){ //zyj test
    ...
    sprintf(dFile,"/Volumes/YJMAC/Matt_production/NPE_Tuples_Central5_resubmit.root"); //zyj
    ...
    sprintf(dFile1,"../../NPE_MC/Ana/root_yj/DCA_plots_yj_central5_v3_2.root"); // updated pion spectrum, change scale, default
    //sprintf(dFile1,"../../NPE_MC/Ana/root_yj/DCA_plots_yj_central5_v3_2_morePion.root"); // updated pion spectrum, change scale, default
    ...
    //sprintf(dFile2,"../../NPE_MC/Ana/root_yj/HF_plots_C5_yj_HighDp.root"); // updated D and Lc/D0 ratio
    ...
    //double constraint[9]={0,0,0,0,0.345052, 0.230658, 0.186633, 0.166221, 0.133711};
    double constraint[8]={0,0,0,0,0.345052, 0.230658, 0.186633, 0.149966};
    int pur_val;
    if(HT){
      ...
      double constraint_v2[8]={0.362,0.304,0.283,0.378125, 0.311862, 0.22964, 0.225388, 0.1970}; // default
    ...
    //////////////////////////////////////////////////////////////////
      ...
      //if(pt>0)fitdata1D_yj(h01,h01_emc,h01_emc,h01_pi,h01_2pi,h01_k,h01_p,h01_D,h01_e,h01_B,0,0,save,file,dat,datc,dir1,dir2,dir3,dir4,dir5,dir6,pt,0,rs,cutLow,cutHigh,binning[pt-1],binning[pt],eff,pur_val,HT,e_const); // zyj 2nd h01_emc is not used
      if(pt>0)fitdata1D_yj(h01,h01_emc,h01_emc,h01_pi,h01_D,h01_e,h01_B,0,0,save,file,dat,datc,dir1,dir2,dir3,dir4,dir5,dir6,pt,0,rs,cutLow,cutHigh,binning[pt-1],binning[pt],eff,pur_val,HT,e_const); // zyj 2nd h01_emc is not used
      //if(pt>0)fitdata1D_yj(h01,h01_emc,h01_emc,h01_pi,h01_2pi,h01_k,h01_p,h01_D,h01_e,h01_B,0,0,save,file,dat,datc,dir1,dir2,dir3,dir4,dir5,dir6,pt,0,rs,cutLow,cutHigh,binning[pt-1],binning[pt],eff,pur_val,HT); // zyj 2nd h01_emc is not used
    }//End Fit
  }//End PT
}//End
void norm(TH1F *h){
