...
void runFit_eff(int rs=1,int save=1, int doAllFits=1, int HT=0)
{
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  //for(int pt=ptStart;pt<ptStart+1;pt++){ //zyj test
    ...
    sprintf(dFile1,"../../NPE_MC/Ana/root_yj/DCA_plots_yj_central5_v3_2.root"); // updated pion spectrum, change scale
    ...
    if(HT){
      ...
      //double constraint_v2[numPtBins]={0.362,0.304,0.283,0.458314, 0.354518, 0.263822, 0.214651, 0.185941, 0.138889};
      //double constraint_v2[numPtBins]={0.362,0.304,0.283,0.556533, 0.417713, 0.268589, 0.261435, 0.292406, 0.222482};
      double constraint_v2[numPtBins]={0.362,0.304,0.283,0.378125, 0.311862, 0.22964, 0.225388, 0.217199, 0.176918};
...
void Iso_Efficiency(TH1F *comp__5){
  ...
  /*
  // more pion
  comp__5->SetBinContent(1,0.2916479);
  comp__5->SetBinContent(2,0.3548496);
  comp__5->SetBinContent(3,0.3492845);
  comp__5->SetBinContent(4,0.3709503);
  comp__5->SetBinContent(5,0.3755578);
  comp__5->SetBinContent(6,0.3670899);
  comp__5->SetBinContent(7,0.4199777);
  comp__5->SetBinContent(8,0.4484926);
  comp__5->SetBinContent(9,0.468603);
  comp__5->SetBinError(1,0.007734193);
  comp__5->SetBinError(2,0.02721369);
  comp__5->SetBinError(3,0.0167186);
  comp__5->SetBinError(4,0.01195646);
  comp__5->SetBinError(5,0.00948278);
  comp__5->SetBinError(6,0.006732437);
  comp__5->SetBinError(7,0.007330579);
  comp__5->SetBinError(8,0.005974563);
  comp__5->SetBinError(9,0.004352291);
   */
  
  // more gamma
   comp__5->SetBinContent(1,0.3110697);
   comp__5->SetBinContent(2,0.405578);
   comp__5->SetBinContent(3,0.3877198);
   comp__5->SetBinContent(4,0.4197519);
   comp__5->SetBinContent(5,0.3943381);
   comp__5->SetBinContent(6,0.3667388);
   comp__5->SetBinContent(7,0.442749);
   comp__5->SetBinContent(8,0.4738626);
   comp__5->SetBinContent(9,0.4883895);
   comp__5->SetBinError(1,0.00627915);
   comp__5->SetBinError(2,0.02693079);
   comp__5->SetBinError(3,0.01731952);
   comp__5->SetBinError(4,0.01310183);
   comp__5->SetBinError(5,0.01020009);
   comp__5->SetBinError(6,0.006933853);
   comp__5->SetBinError(7,0.007502862);
   comp__5->SetBinError(8,0.005787575);
   comp__5->SetBinError(9,0.004020763);
}
