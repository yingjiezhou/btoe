...
void calcPurity_err_comp(int rs=1,int save=0, int doAllFits=0)
{
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  double purity_matt_err[9]={1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 0.03, 1e-6};
  ...
  hpur2->SetMarkerStyle(21);
  hpur22->SetMarkerStyle(25);
  hpur3->SetMarkerStyle(22);
  ...
  hpur33->SetMarkerColor(kGreen+2);
  hpur33->SetLineColor(kGreen+2);
  hpur3->SetMarkerColor(kGreen+2);
  hpur3->SetLineColor(kGreen+2);
