int const num=11;
double bin[num+1]={0.6,0.8,1,1.2,1.4,1.6,1.8,2,3,4,5,10};

void DCAResZ(int save = 0, int weight_data=0){ //weight only for phoE pair comp. and reweight for weight.C, and if doing other comp. integrated over pt
/////////////////////////////////////////////////////////////////////////////////////////
    gROOT->ProcessLine(".x ~/myStyle.C");  
    TGaxis::SetMaxDigits(3);  
//////////////////////////////////////////////////////////////////
    TFile *f1 = new TFile("../../NPE_Ana/production/NPE_Tuples_TuneA10.root");
    ratio1 = (TH2F*) f1->Get("hQaDcaZ1");
    ratio2 = (TH2F*) f1->Get("hQaDcaZ2");
    ratio3 = (TH2F*) f1->Get("hQaDcaZ3");
    ratio4 = (TH2F*) f1->Get("hQaDcaZ4");
    ratio5 = (TH2F*) f1->Get("hQaDcaZ5");
    ratio6 = (TH2F*) f1->Get("hQaDcaZ6");
    ratio7 = (TH2F*) f1->Get("hQaDcaZ7");
    ratio8 = (TH2F*) f1->Get("hQaDcaZ8");


    ratio1->GetXaxis()->SetRangeUser(-0.01,0.01);
    ratio2->GetXaxis()->SetRangeUser(-0.01,0.01);
    ratio3->GetXaxis()->SetRangeUser(-0.01,0.01);
    ratio4->GetXaxis()->SetRangeUser(-0.01,0.01);
    ratio5->GetXaxis()->SetRangeUser(-0.01,0.01);
    ratio6->GetXaxis()->SetRangeUser(-0.01,0.01);
    ratio7->GetXaxis()->SetRangeUser(-0.01,0.01);
    ratio8->GetXaxis()->SetRangeUser(-0.01,0.01);
...
//======================================================================
    ...
    ch1->SetBranchAddress("sig_dcaz",&s_dcaxy);
...
//======================================================================
    ...
    getRes(ratio1,res_data_1,8,1);
    getRes(ratio2,res_data_2,8,1);
    getRes(ratio3,res_data_3,8,1);
    getRes(ratio4,res_data_4,8,1);
    getRes(ratio5,res_data_5,8,1);
    getRes(ratio6,res_data_6,8,1);
    getRes(ratio7,res_data_7,8,1);
    getRes(ratio8,res_data_8,8,1);
...
void getRes(TH2F * dcapt,TH1F * res,int mar,int col){
    ...
    res->GetYaxis()->SetTitle("#sigma_{Z} [#mum]");
