...
void HF_DCA_yj(int save = 0, int weight_data=0){
  ...
  TFile *MyDWeights = new TFile("./root_yj/D_Weights_Alt_c5.root","READ");
  TH1F* D_Weights = MyDWeights->Get("D_Weights");
  
  TFile *fileC5=new TFile("root_yj/Lc/C5_Catania1080.root","READ");
  TGraph *gr_lc = (TGraph* )fileC5->Get("LctoD0");
  ...
  //TGraph *gr_lc = new TGraph(14,lc_x,lc_y); // 0-80??? zyj
  //
  //
  ...
  if(save){
    ...
    dcapt_d_all->Add(dcapt_dp,dp_sl/d0_sl * dp_cs/d0_cs);
    ...
    //leg->Draw("same");
    //}
    c1->SaveAs("plots_HF_yj_C5/All_DCA_Shapes.pdf");
    ...
    dca_ds->Draw("same hist");
    dca_lc->Draw("same hist");
    c11->SaveAs("plots_HF_yj_C5/charm_Shapes.pdf");
    ...
    dca_bs->Draw("same hist");
    dca_lb->Draw("same hist");
    c111->SaveAs("plots_HF_yj_C5/bottom_Shapes.pdf");
    ...
    leg->Draw("same");
    c1111->SaveAs("plots_HF_yj_C5/Comb_Shapes.pdf");
    ...
    leg->Draw("same");
    c2->SaveAs("plots_HF_yj_C5/all_lin.pdf");
    ...
    leg->Draw("same");
    c3->SaveAs("plots_HF_yj_C5/delta_phi.pdf");
    ...
    leg55->Draw("same");
    c_c->SaveAs("plots_HF_yj_C5/frac_pt.pdf");
    ...
    leg55->Draw("same");
    c_pt->SaveAs("plots_HF_yj_C5/pt.pdf");
    ...
    c22->SaveAs("plots_HF_yj_C5/all_pt.pdf");
    ...
    pt_b_all->Draw("PE");
    c222->SaveAs("plots_HF_yj_C5/b_c_ratio.pdf");
    ...
    cy->SaveAs("plots_HF_yj_C5/yield.pdf");
  }
}
