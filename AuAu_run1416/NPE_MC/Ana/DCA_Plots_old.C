...
void DCA_Plots_old(int save = 1 , int weight_data=1){
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  leg1->Draw("same");
  cfit->SetLogy();
  cfit->SaveAs("plots_yj_full/new_weight_comp.pdf");
  //=========================================================================
  ...
  //sprintf(dFile3,"/Volumes/YJMAC/Matt_production/MCv2.root");
  ...
  for(int i =0;i<ch1->GetEntries();i++){
    ...
    if(s_head == 7){
      ...
      //ww = gamma_new_weights->GetBinContent(bin)/0.0174*2; // *2 means more gamma
  ...
  comp1->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
  ...
  leg->Draw("same");
  ccomp->SaveAs("plots_yj_full/PhoECom.pdf");
  //======================================================================
  ...
  comp55->Draw("same");
  leg->Draw("same");
  ccomp_ee->SaveAs("plots_yj_full/PhoEComp.pdf"); // phe component constitute, fraction w/ weight
  //======================================================================
  
  //TFile f("root/DCA_plots.root","RECREATE");
  TFile f("root_yj/DCA_plots_yj_full.root","RECREATE");
  ...
  pt_ni->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
  comp_e->GetYaxis()->SetTitle("Isolation Efficiency");
  comp_e->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
  pt_ni->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
  ...
  pt_ni->SetMarkerColor(kGray+2);
  pt_ni->SetLineColor(kGray+2);
  TLegend *leg5 = new TLegend(0.2,0.75,0.5,0.92);
  leg5->AddEntry(pt_ni,"Single Electron","LPE");
  leg5->AddEntry(pt_pi0_nw_ni,"#pi^{0} Dalitz Decay","LPE");
  leg5->AddEntry(pt_eta_nw_ni,"#eta Dalitz Decay","LPE");
  leg5->AddEntry(pt_gamma_nw_ni,"#gamma","LPE");
  leg5->AddEntry(comp,"Photonic Weighted Ave. ","LPE");
  ...
  */
  comp_pi0->SetMarkerStyle(24);
  comp_eta->SetMarkerStyle(30);
  comp_gamma->SetMarkerStyle(25);
  comp_e->SetMarkerStyle(28);
  comp_e->SetMarkerColor(kGray+2);
  comp_e->SetLineColor(kGray+2);
  ...
  line->SetLineStyle(7);
  line->Draw("same");
  ciso->SaveAs("plots_yj_full/DCAEff_Pt_Q.pdf"); // comp 就没填图， 本来是填各个成分的fraction的
  ciso->SaveAs("plots_yj_full/DCAEff_Pt_Q.C"); // comp 就没填图， 本来是填各个成分的fraction的
  return ;
  //==========================================================================
  ...
  ciso1->SaveAs("plots_yj_full/PhiEff_Pt.pdf");
  ...
  ciso2->SaveAs("plots_yj_full/EtaEff_Pt.pdf"); // we have
  ...
  ciso3->SaveAs("plots_yj_full/VzEff_Pt.pdf");
  ...
  ciso33->SaveAs("plots_yj_full/DCAEff_Pt.pdf"); // at high pt
  //==========================================================================
  ...
  cpt->SaveAs("plots_yj_full/pt_comp_Q.pdf");
  //==========================================================================
  ...
  c2D4->SaveAs("plots_yj_full/comp_gamma_dca.pdf");
  //==========================================================================
  ...
  h11->GetXaxis()->SetTitle("p_{T} (GeV/#it{c})");
  h11->GetZaxis()->SetRangeUser(0,0.01);
  h11->Draw("COLZ");
  c3->cd(2);
  dr_eh_all->GetYaxis()->SetTitle("Decay Radius [cm]");
  dr_eh_all->GetXaxis()->SetTitle("p_{T} (GeV/#it{c})");
  dr_eh_all->GetZaxis()->SetRangeUser(0,0.01);
  dr_eh_all->Draw("COLZ");
  c3->SaveAs("plots_yj_full/e_radius_2D.pdf");
  //==========================================================================
  ...
  c31->SaveAs("plots_yj_full/PhoE_radius.pdf"); // zyj don't know
  //==========================================================================
  ...
  c33->SaveAs("plots_yj_full/sanity_check_mass_pt.pdf");
  ...
  c331->SaveAs("plots_yj_full/PhoE_mass.pdf");
    return ;
  //==========================================================================
  ...
  c11->cd(10);
  leg2->Draw();
  c11->SaveAs("plots_yj_full/Gamma_InvYield_lin.pdf");
