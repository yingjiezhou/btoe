...
void weight_D_sys(){
  ...
  //double xx42[6]={9.68e-01,1.35,1.89,2.56,3.75,5.88};
  ...
  TGraphErrors *gd01 = new TGraphErrors(7,xx4,yy41,xx4e,yy4e); // soft
  TGraphErrors *gd02 = new TGraphErrors(7,xx4,yy42,xx4e,yy4e);
  ...
  TF1 *fd01 = new TF1("fd01",func1,0.315,20,3);
  fd01->SetParameter(0,1.44381e+01);
  fd01->SetParameter(1,0.11);
  fd01->SetParameter(2,1.10008e-01);
  
  TF1 *fd02 = new TF1("fd02",func1,0.315,20,3);
  fd02->SetParameter(0,1.44381e+01);
  fd02->SetParameter(1,0.11);
  fd02->SetParameter(2,1.10008e-01);
  ...
  //c11->Divide(2);
  //c11->cd(1);
  gd0->GetYaxis()->SetRangeUser(1e-6, 1e-1);
  gd0->Fit(fd0);
  gd01->Fit(fd01); // soft
  gd02->Fit(fd02);
  ...
  */
  ...
  TFile fi("root_yj/D_Weights_sys_hard.root","RECREATE");
  //TFile fi("root_yj/D_Weights_sys_soft.root","RECREATE");
