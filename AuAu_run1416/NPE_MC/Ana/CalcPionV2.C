void CalcPionV2(int save = 1 , int weight_data=1){ 
/////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
    ...
    TF1 *func = new TF1("func","[0]+x*[1]+x*[2]*[2]+x*[3]*[3]",5,20);
    gr->Fit(func,"R","",5,20);
    func->SetLineStyle(7);
//////////////////////////////////////////////////////////////////
    ...
    TH1F* mean11 = new TH1F("mean11","",100,0,0.2);
    TH1F* mean22 = new TH1F("mean22","",100,0,0.2);




    TFile *f_D = new TFile("root/DCA_plots_Alt.root");
...
/////////////////////////////////////////////////////////////////
    ...
    TH2F *h2DPtDeltaPhie_w3 = new TH2F("h2DPtDeltaPhie_w3","h2DPtDeltaPhie_w3",40,0,20,5,0,TMath::Pi()/2);h2DPtDeltaPhie_w3->Sumw2();
...
/////////////////////////////////////////////////////////////////
	...
	if(s_hft<1)continue;	
	//if(!(s_head==7 && s_parentid==7 && s_gparentid==0))continue;
	...
	if(s_parentpt<7.6)double v2 = gr->Eval(s_parentpt);
	else double v2 = func->Eval(s_parentpt);
	//else double v2 = f3.Eval(s_parentpt);
	f1.SetParameter(0,v2);
	double v2Weight = 0;
	v2Weight = f1.Eval(dPhi)/(f1.Integral(0,TMath::Pi()/2)/(TMath::Pi()/2));

	if(s_parentpt+wpt<7.6)double v2ee = gr->Eval(s_parentpt+wpt);
	else double v2ee = func->Eval(s_parentpt+wpt);
	...
	h2DPtDeltaPhie2->Fill(s_pt,dPhie,ww); 
...
//////////////////////////////////////////////////////////////////
	...
	ParentV2_w->SetBinContent(i,val3-val1);//-val1
	ParentV2_w->SetBinError(i,er3);	
	ElectronV2_w->SetBinContent(i,val4-val2);//-val2
...
/////////////////////////////////////////////////////////////////
    ...
    TCanvas *c33 = new TCanvas("c33","means");
    mean11->Draw();
    mean22->SetLineColor(kRed);
    mean22->SetMarkerColor(kRed);
    mean22->Draw("same");
    cout << mean11->GetMean() << "  " << mean22->GetMean() << endl;

    if(save){
	TFile fff("v2_hists/pion_v2.root","RECREATE");
