void DCA_Plots_Hijing(int save = 1 , int weight_data=1){ 
/////////////////////////////////////////////////////////////////////////////////////////
...
//	    }     
	    ...
	    if(s_head==149 && s_parentid==149 && s_gparentid==0){
	    ...
	    if(s_head==147 && s_parentid==147 && s_gparentid==0){
...
//======================================================================
	...
	for(int i =0;i<ch11->GetEntries();i++){
	    ...
	    if((s_head==147||s_head==149) && s_gparentid==0){
...
//======================================================================
	TFile f("root/DCA_plots_Hijing.root","RECREATE");
