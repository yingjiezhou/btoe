void CalcPionV2_PhoE(int save = 0 , int weight_data=1){ 
/////////////////////////////////////////////////////////////////////////////////////////
...
//======================================================================
    ...
    ch1->SetBranchAddress("eh_charge",&s_c1);
    ch1->SetBranchAddress("eh_h_charge",&s_c2);
    ch1->SetBranchAddress("eh_comb_mass",&s_m);
    ch1->SetBranchAddress("eh_hft",&s_hft2);
//////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
    ...
    f3.Draw("same");
    if(save){
	TFile fff("v2_hists/pion_v2_phoe.root","RECREATE");
