...
/////////////////////////////////////////////////////////////////
    ...
    if(save){	
	char dFile[500];
	sprintf(dFile,"All_Decays_newiso_full_new.root");
	TFile *f_D = new TFile(dFile);
	TChain *ch1 = f_D->Get("Signal_tree");
        char dFile3[500];
        sprintf(dFile3,"MC_newiso_full_new.root");
        TFile *f_D3 = new TFile(dFile3);
	TChain *ch11 = f_D3->Get("EH");
	char dFile1[500];
	sprintf(dFile1,"../../NPE_ANA/production/NPE_Tuples_TuneB10.root");
...
//======================================================================
	...
	for(int i =0;i<ch1->GetEntries();i++){
		...
		int bin = eta_new_weights->FindBin(s_pt);
                ww = eta_new_weights->GetBinContent(bin)*0.0199728*0.0069/0.0174*0.45*5;
...
//======================================================================
	...
	TCanvas *ccomp_ee = new TCanvas("ccomp_ee","ccomp ee");
