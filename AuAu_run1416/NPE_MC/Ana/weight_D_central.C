...
void weight_D_central(){
  ...
  TGraphErrors *gd0mb = new TGraphErrors(7,xx4,yy4,xx4e,yy4e);
  TF1 *fd0mb = new TF1("fd0mb",func1,0.315,20,3);
  fd0mb->SetParameter(0,1.44381e+01);
  fd0mb->SetParameter(1,0.11);
  fd0mb->SetParameter(2,1.10008e-01);
  ...
  TFile fi("root_yj/D_Weights_Alt_c5.root","RECREATE");
