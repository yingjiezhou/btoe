void DrawDeltaPhi_PhoE(){
    gROOT->ProcessLine(".x ~/myStyle.C");  
    TGaxis::SetMaxDigits(3); 
    int const numPtBins=9;
    double binning[numPtBins+1]={0.6,1,1.2,1.5,2.0,2.5,3.5,4.5,5.5,8.5};   

    TH1F *Res = new TH1F("Res","Res",numPtBins,binning);//
    TH1F *Res_mm = new TH1F("Res_mm","Res_mm",numPtBins,binning);//
    TH1F *Cos = new TH1F("Cos","Cos",numPtBins,binning);//

    char file[50]="resolution/Gamma.root";//Here
    TFile *f = new TFile("./root/DCA_plots_Hijing_GammaConv.root");
    dr =(TH2F*)f->Get("phirespt_pi0_mm");//Here
    h11 = (TH2F*) f->Get("phirespt_pi0");//Here
    cos = (TH2F*) f->Get("cosphirespt_pi0");//Here
    ...
    dr->GetXaxis()->SetRangeUser(-0.2,0.2);
    h11->GetXaxis()->SetRangeUser(-0.2,0.2);
    ...
    leg->AddEntry(dr_0,"#it{#pi^{0}}#rightarrow#gamma#rightarrow#it{e}_{mm}","PEL");//
    leg->AddEntry(h11_0,"#it{#pi^{0}}#rightarrow#gamma#rightarrow#it{e}","PEL");  //
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_1->GetMaximum()*0.9.1,"#it{p}_{T}#in[0.6,1.0] [GeV]");
    lat.DrawLatex(0.02,dr_1->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_1->GetMaximum()*0.6,label1);
    c1->cd(2);
    dr_2->Draw("PE");
    h11_2->Draw("same PE");
    leg->Draw("same");
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_2->GetMaximum()*0.9.1,"#it{p}_{T}#in[1.0,1.2] [GeV]");
    lat.DrawLatex(0.02,dr_2->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_2->GetMaximum()*0.6,label1);
    c1->cd(3);
    dr_3->Draw("PE");
    h11_3->Draw("same PE");
    leg->Draw("same");
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_3->GetMaximum()*0.9.1,"#it{p}_{T}#in[1.2,1.5] [GeV]");
    lat.DrawLatex(0.02,dr_3->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_3->GetMaximum()*0.6,label1);
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_4->GetMaximum()*0.9.1,"#it{p}_{T}#in[1.5,2.0] [GeV]");
    lat.DrawLatex(0.02,dr_4->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_4->GetMaximum()*0.6,label1);
    c1->cd(5);
    dr_5->Draw("PE");
    h11_5->Draw("same PE");
    leg->Draw("same");
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_5->GetMaximum()*0.9.1,"#it{p}_{T}#in[2.0,2.5] [GeV]");
    lat.DrawLatex(0.02,dr_5->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_5->GetMaximum()*0.6,label1);
    c1->cd(6);
    dr_6->Draw("PE");
    h11_6->Draw("same PE");
    leg->Draw("same");
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_6->GetMaximum()*0.9.1,"#it{p}_{T}#in[2.5,3.5] [GeV]");
    lat.DrawLatex(0.02,dr_6->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_6->GetMaximum()*0.6,label1);
    c1->cd(7);
    dr_7->Draw("PE");
    h11_7->Draw("same PE");
    leg->Draw("same");
   ...
   res1=dr_7->GetRMS()*0.57735027;
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_7->GetMaximum()*0.9.1,"#it{p}_{T}#in[3.5,4.5] [GeV]");
    lat.DrawLatex(0.02,dr_7->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_7->GetMaximum()*0.6,label1);
    c1->cd(8);
    dr_8->Draw("PE");
    h11_8->Draw("same PE");
    leg->Draw("same");
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_8->GetMaximum()*0.9.1,"#it{p}_{T}#in[4.5,5.5] [GeV]");
    lat.DrawLatex(0.02,dr_8->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_8->GetMaximum()*0.6,label1);
    c1->cd(9);
    dr_9->Draw("PE");
    h11_9->Draw("same PE");
    leg->Draw("same");
    ...
    sprintf(label,"#sigma=%1.4f",res);
    sprintf(label1,"#sigma_{mm}=%1.4f",res1);
    lat.DrawLatex(-0.01.,dr_9->GetMaximum()*0.9.1,"#it{p}_{T}#in[5.5,8.5] [GeV]");
    lat.DrawLatex(0.02,dr_9->GetMaximum()*0.7,label);
    lat.DrawLatex(0.02,dr_9->GetMaximum()*0.6,label1);
    ...
    Res->GetYaxis()->SetRangeUser(0,0.1);   
