...
void DCA_Plots_old_central5(int save = 1 , int weight_data=1){
  ...
  leg1->Draw("same");
  cfit->SetLogy();
  cfit->SaveAs("plots_yj_c5/new_weight_comp.pdf");
  //=========================================================================
  ...
  for(int i =0;i<ch1->GetEntries();i++){
    ...
    if(s_head == 7){
      ...
      ww = pi0_new_weights->GetBinContent(bin)*0.0199728*5;
      ...
      ww = eta_new_weights->GetBinContent(bin)*0.0199728*5*0.0069/0.0174*0.45;
      //int bin = eta_weights->FindBin(pt_for_weight);
      //ww = eta_weights->GetBinContent(bin)*0.0199728*0.0069/0.0174*0.45*5;
      //ww = feta->Eval(s_pt);
    } else if(s_head == 1){
  ...
  leg->Draw("same");
  ccomp->SaveAs("plots_yj_c5/PhoECom.pdf");
  //======================================================================
  ...
  comp55->Draw("same");
  leg->Draw("same");
  ccomp_ee->SaveAs("plots_yj_c5/PhoEComp.pdf"); // phe component constitute, fraction w/ weight
  //======================================================================
  
  //TFile f("root/DCA_plots.root","RECREATE");
  TFile f("root_yj/DCA_plots_yj_central5.root","RECREATE");
  ...
  line->SetLineStyle(7);
  line->Draw("same");
  ciso->SaveAs("plots_yj_c5/DCAEff_Pt_Q.pdf"); // comp 就没填图， 本来是填各个成分的fraction的
  ciso->SaveAs("plots_yj_c5/DCAEff_Pt_Q.C"); // comp 就没填图， 本来是填各个成分的fraction的
  //==========================================================================
  ...
  ciso1->SaveAs("plots_yj_c5/PhiEff_Pt.pdf");
  ...
  ciso2->SaveAs("plots_yj_c5/EtaEff_Pt.pdf"); // we have
  ...
  ciso3->SaveAs("plots_yj_c5/VzEff_Pt.pdf");
  ...
  ciso33->SaveAs("plots_yj_c5/DCAEff_Pt.pdf"); // at high pt
  //==========================================================================
  ...
  cpt->SaveAs("plots_yj_c5/pt_comp_Q.pdf");
  //==========================================================================
  ...
  c2D4->SaveAs("plots_yj_c5/comp_gamma_dca.pdf");
  //==========================================================================
  ...
  dr_eh_all->Draw("COLZ");
  c3->SaveAs("plots_yj_c5/e_radius_2D.pdf");
  //==========================================================================
  ...
  c31->SaveAs("plots_yj_c5/PhoE_radius.pdf"); // zyj don't know
  //==========================================================================
  ...
  c33->SaveAs("plots_yj_c5/sanity_check_mass_pt.pdf");
  ...
  c331->SaveAs("plots_yj_c5/PhoE_mass.pdf");
    return ;
  //==========================================================================
  ...
  c11->cd(10);
  leg2->Draw();
  c11->SaveAs("plots_yj_c5/Gamma_InvYield_lin.pdf");
