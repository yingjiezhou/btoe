...
const   int nHft() const { return mNumHft; }
const  int nGoodHft() const{ return mNumGoodHft; }
...
protected:
    ...
    Int_t                   mNumHft;     // Number of HFT hits
    Int_t                   mNumGoodHft; // Number of GOOD HFT hits (by idtruth)
    Char_t                  mEnd[1]; //!
