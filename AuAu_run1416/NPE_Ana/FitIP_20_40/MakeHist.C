...
//////////////////////////////////////////////////////////////////
    ...
    hDcaLog3D_5  = new TH2F ("hDcaLog3D_5","hDcaLog3D_5",200,0,20,600,-6,0);
    hDcaLog3D_1  = new TH2F ("hDcaLog3D_1","hDcaLog3D_1",200,0,20,600,-6,0);
    int loop = 0;
    float px;
    float py;
    float iso;
	...
	if(!iso)continue;	
	if(!(centrality>3 && centrality<6))continue;
	if(triggercat==8){
    ...
    TFile f("hist/histograms.root","RECREATE");
    hDcaLog3D_5->Write();
    hDcaLog3D_1->Write();
    f.Close();
}
