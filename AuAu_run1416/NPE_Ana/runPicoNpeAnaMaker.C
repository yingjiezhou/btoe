...
void runPicoNpeAnaMaker(TString list="picoList_small.list", TString outFileName="test.root", TString badRunListFileName = "picoList_bad_MB.list")
{
    ...
    StPicoDstMaker* picoDstMaker = new StPicoDstMaker(0, list, "picoDstMaker");
    ...
    npeCuts->setMVACut(1.7);//Lower bound on MVA cut to reduce large pion background right away
    TFile *f1 = new TFile("./Likelihood/root/weights_electron.root");
    TFile *f2 = new TFile("./Likelihood/root/weights_pion.root");
    TFile *f3 = new TFile("./Likelihood/root/weights_electron_highpt.root");
    TFile *f4 = new TFile("./Likelihood/root/weights_pion_highpt.root");
    TFile *f5 = new TFile("./Likelihood/HighTower/root/weights_electron_HT.root");
    TFile *f6 = new TFile("./Likelihood/HighTower/root/weights_pion_HT.root");
    ...
    if (list == "picoList_small.list") nEntries =50000;
    nEntries=50000;
