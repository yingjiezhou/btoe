...
//////////////////////////////////////////////////////////////////
    ...
    double binning[numPtBins+1]={0.6,0.7,0.8,0.9,1,1.2,1.5,2.5,8.5};
...
//==============ELectron Part 
    ...
    leg->AddEntry(hec_v2,"Reconstructed photonic electron","PLE");
    leg->AddEntry(PhoEV2,"Calculated from photonic cocktail","PLE");   
