...
//Signals
    ...
    if(pt!=1)RooBifurGauss g1("g1","g1",*PID,mean1,sigma1,sigma11);
...
//Now fit Data
    ...
    if(pt!=2 && pt!=9)mean2.setRange(mean2.getVal()-mean2.getError(),mean2.getVal()+mean2.getError());}
