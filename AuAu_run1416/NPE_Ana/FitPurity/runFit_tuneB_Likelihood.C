...
void runFit_tuneB_Likelihood(int rs=1,int save=0, int doAllFits=0)
{
/////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
	...
	sprintf(dFile2,"../production/NPE_Tuples_TuneB7.root");
	...
	h01_2D_pi2 = (TH2F*) f_D1->Get("hFit_pi_3");
	h01_2D_pi2->SetName("h01_2D_pi2");
	h01_2D_pi3 = (TH2F*) f_D->Get("hFit_pi_3");
	...
	if(pt>0){
	    ...
	    if(pt<7)h01_2D_pi2->GetXaxis()->SetRangeUser(binning[pt-1],binning[pt]);
