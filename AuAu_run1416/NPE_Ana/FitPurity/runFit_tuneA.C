#include "fitMVAdata1D_tuneA.C"
void runFit_tuneA(int rs=1,int save=0, int doAllFits=0)
{
/////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
	...
	if(pt==1){
	    h01_2D = (TH2F*) f_D->Get("hFit_EH_1");//5
	    h01_2D1 = (TH2F*) f_D->Get("hFit_0");
	    h01_2D_e = (TH2F*) f_D->Get("hFit_e_5");
	    h01_2D_e_WS = (TH2F*) f_D->Get("hFit_e_WS_5"); 
	    h01_2D_pi = (TH2F*) f_D->Get("hFit_pi_5");
	    h01_2D_2pi = (TH2F*) f_D->Get("hFit_2pi_5");
	    h01_2D_k = (TH2F*) f_D->Get("hFit_k_5");
	    h01_2D_p = (TH2F*) f_D->Get("hFit_p_5");
	}
	if(pt==2){
	    h01_2D = (TH2F*) f_D->Get("hFit_EH_1");//4
	    h01_2D1 = (TH2F*) f_D->Get("hFit_0");
	    h01_2D_e = (TH2F*) f_D->Get("hFit_e_4");
	    h01_2D_e_WS = (TH2F*) f_D->Get("hFit_e_WS_4"); 
	    h01_2D_pi = (TH2F*) f_D->Get("hFit_pi_4");
	    h01_2D_2pi = (TH2F*) f_D->Get("hFit_2pi_4");
	    h01_2D_k = (TH2F*) f_D->Get("hFit_k_4");
	    h01_2D_p = (TH2F*) f_D->Get("hFit_p_4");
	}
	if(pt>2 || pt==0){
