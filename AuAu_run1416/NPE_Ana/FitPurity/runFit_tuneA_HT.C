#include "fitMVAdata1D_tuneA_HT.C"
void runFit_tuneA_HT(int rs=1,int save=0, int doAllFits=0)
{
/////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
	...
	h01_2D = (TH2F*) f_D->Get("hFit_11");
	h01_2D1 = (TH2F*) f_D->Get("hFit_7");
	h01_2D_e = (TH2F*) f_D->Get("hFit_e_11");
	h01_2D_e_WS = (TH2F*) f_D->Get("hFit_e_WS_11"); 
	h01_2D_pi = (TH2F*) f_D->Get("hFit_pi_11");
	h01_2D_2pi = (TH2F*) f_D->Get("hFit_2pi_11");
	h01_2D_k = (TH2F*) f_D->Get("hFit_k_11");
	h01_2D_p = (TH2F*) f_D->Get("hFit_p_11");
