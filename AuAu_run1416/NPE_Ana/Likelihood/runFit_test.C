...
//////////////////////////////////////////////////////////////////
    ...
    if(1)TH1F* hBkg_deltabeta = new TH1F("hBkg_deltabeta","hBkg_deltabeta",50,-0.0005,0.0005);
...
void doLikelihood(){
    ...
    TH1F* DLL_e = new TH1F("DLL_e","DLL_e",150,-3,3);
    TH1F* DLL_e_ws = new TH1F("DLL_e_ws","DLL_e_ws",150,-3,3);
    ...
    TH2F* DLL_e_pt = new TH2F("DLL_e_pt","DLL_e_pt",150,-3,3,200,-4,4);
    TH2F* DLL_e_pt_ws = new TH2F("DLL_e_pt_ws","DLL_e_pt_ws",150,-3,3,200,-4,4);
    TH2F* DLL_p_pt = new TH2F("DLL_p_pt","DLL_p_pt",150,-3,3,200,-4,4);
    ...
    TH1F* DLL_p = new TH1F("DLL_p","DLL_p",150,-3,3);
    TH1F* DLL_e_nw = new TH1F("DLL_e_nw","DLL_e_nw",150,-3,3);
    TH1F* DLL_e_ws_nw = new TH1F("DLL_e_ws_nw","DLL_e_ws_nw",150,-3,3);
    TH1F* DLL_p_nw = new TH1F("DLL_p_nw","DLL_p_nw",150,-3,3);

    TH1F* DLL_e_post = new TH1F("DLL_e_post","DLL_e_post",150,-3,3);
    TH1F* DLL_e_ws_post = new TH1F("DLL_e_ws_post","DLL_e_ws_post",150,-3,3);
    TH1F* DLL_p_post = new TH1F("DLL_p_post","DLL_p_post",150,-3,3);
    TH1F* DLL_pr_post = new TH1F("DLL_pr_post","DLL_pr_post",150,-3,3);
    TH1F* DLL_k_post = new TH1F("DLL_k_post","DLL_k_post",150,-3,3);
    ...
    TH2F* DLL_pr_2D = new TH2F("DLL_pr_2D","DLL_pr_2D",150,-3,3,400,-4,4);
    TH1F* DLL_2p = new TH1F("DLL_2p","DLL_2p",1000,-4,4);
    TH2F* DLL_2p_2D = new TH2F("DLL_2p_2D","DLL_2p_2D",150,-3,3,400,-4,4);
    TH1F* DLL_k = new TH1F("DLL_k","DLL_k",1000,-4,4);
    TH2F* DLL_k_2D = new TH2F("DLL_k_2D","DLL_k_2D",150,-3,3,400,-4,4);
    ...
    TH1F* eff_e = new TH1F("eff_e","eff_e",150,-3,3);
    TH1F* sign = new TH1F("sign ","sign ",150,-3,3);
    TH1F* line = new TH1F("line","line",50,-13,40);
    TH1F* eff_p = new TH1F("eff_p","eff_p",150,-3,3);
	...
	*/
	...
	if(weight1<1e-100)weight1+=1e-100;                                             
	if(weight2<1e-100)weight2+=1e-100;    
	if(weight3<1e-100)weight3+=1e-100;    
	if(weight4<1e-100)weight4+=1e-100;    
	if(weight5<1e-100)weight5+=1e-100;    
	//if(weight6<1e-10)weight6+=1e-10;    
	if(weight11<1e-100)weight11+=1e-100;                                                                                                                 
        if(weight22<1e-100)weight22+=1e-100;
	if(weight33<1e-100)weight33+=1e-100;
	if(weight44<1e-100)weight44+=1e-100;
	if(weight55<1e-100)weight55+=1e-100;
...
//if(rati>=1) rati = 1 - 1e-21;
	...
	for(int i=0; i<ch1->GetEntries();i++){
	    ...
	    double weight1= electron_weight_povere->GetBinContent(bin1)+1E-6;
	...
	ZERO(htemp1);
	int bin1 = htemp1->FindBin(1.7);
	int bin2 = htemp1->FindBin(0.65);
...
void doLikelihood_highPT(){
    ...
    TH2F* DLL_e_2D = new TH2F("DLL_e_2D","DLL_e_2D",400,-1,5,100,-0.3,0.3);
    TH2F* DLL_e_ws_2D = new TH2F("DLL_e_ws_2D","DLL_e_ws_2D",400,-1,5,100,-0.3,0.3);
    TH2F* DLL_p_2D = new TH2F("DLL_p_2D","DLL_e_2D",200,-1,1,100,-0.3,0.3);*/
    TH1F* DLL_e = new TH1F("DLL_e","DLL_e",200,-2,2);
    TH1F* DLL_e_ws = new TH1F("DLL_e_ws","DLL_e_ws",200,-2,2);
    TH2F* DLL_e_nsige = new TH2F("DLL_e_nsige","DLL_e_nsige",100,-13,13,80,-4,4);
    TH2F* DLL_e_nsige_ws = new TH2F("DLL_e_nsige_ws","DLL_e_nsige_ws",100,-13,13,80,-4,4);
    TH2F* DLL_p_nsige = new TH2F("DLL_p_nsige","DLL_p_nsige",100,-13,13,80,-4,4);
    TH2F* DLL_e_pt = new TH2F("DLL_e_pt","DLL_e_pt",200,-2,2,200,-4,4);
    TH2F* DLL_e_pt_ws = new TH2F("DLL_e_pt_ws","DLL_e_pt_ws",200,-2,2,200,-4,4);
    TH2F* DLL_p_pt = new TH2F("DLL_p_pt","DLL_p_pt",200,-2,2,200,-4,4);
    TH1F* DLL_p = new TH1F("DLL_p","DLL_p",200,-2,2);
    TH1F* DLL_e_nw = new TH1F("DLL_e_nw","DLL_e_nw",200,-2,2);
    TH1F* DLL_e_ws_nw = new TH1F("DLL_e_ws_nw","DLL_e_ws_nw",200,-2,2);
    TH1F* DLL_p_nw = new TH1F("DLL_p_nw","DLL_p_nw",200,-2,2);

    TH1F* DLL_e_post = new TH1F("DLL_e_post","DLL_e_post",200,-2,2);
    TH1F* DLL_e_ws_post = new TH1F("DLL_e_ws_post","DLL_e_ws_post",200,-2,2);
    TH1F* DLL_p_post = new TH1F("DLL_p_post","DLL_p_post",200,-2,2);
    TH1F* DLL_pr_post = new TH1F("DLL_pr_post","DLL_pr_post",200,-2,2);
    TH1F* DLL_k_post = new TH1F("DLL_k_post","DLL_k_post",200,-2,2);
    TH2F* DLL_e_2D = new TH2F("DLL_e_2D","DLL_e_2D",200,-2,2,400,-4,4);
    TH2F* DLL_e_ws_2D = new TH2F("DLL_e_ws_2D","DLL_e_ws_2D",200,-2,2,400,-4,4);
    TH2F* DLL_p_2D = new TH2F("DLL_p_2D","DLL_p_2D",200,-2,2,400,-4,4);

    TH1F* DLL_pr = new TH1F("DLL_pr","DLL_pr",1000,-4,4);
    TH2F* DLL_pr_2D = new TH2F("DLL_pr_2D","DLL_pr_2D",200,-2,2,400,-4,4);
    TH1F* DLL_2p = new TH1F("DLL_2p","DLL_2p",1000,-4,4);
    TH2F* DLL_2p_2D = new TH2F("DLL_2p_2D","DLL_2p_2D",200,-2,2,400,-4,4);
    TH1F* DLL_k = new TH1F("DLL_k","DLL_k",1000,-4,4);
    TH2F* DLL_k_2D = new TH2F("DLL_k_2D","DLL_k_2D",200,-2,2,400,-4,4);
    ...
    TH1D* LL_pp = new TH1D("LL_pp","LL_pp",1000,0,.000001);
    TH1D* LL_pe = new TH1D("LL_pe","LL_pe",1000,0,.000001);
    TH1F* eff_e = new TH1F("eff_e","eff_e",200,-2,2);
    TH1F* sign = new TH1F("sign ","sign ",200,-2,2);
    TH1F* line = new TH1F("line","line",100,-5,40);
    TH1F* eff_p = new TH1F("eff_p","eff_p",200,-2,2);
