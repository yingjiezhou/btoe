...
void fitdata1D_pion(TH1F* hpovere,TH1F* hnsige,TH1F* hdeltabeta,TH1F* hzdist, TH1F* hphidist,TH1F* hhits,int save,char outputfile[],int pt,double ptLow ,double ptHigh)
{
...
/////Minuit Options
    ...
    RooRealVar *hits = new RooRealVar("hits","hits",1,15);//hhits->GetXaxis()->GetXmin(),hhits->GetXaxis()->GetXmax());
...
//Signals var1  ////////////////
    ...
    if(1)RooBifurGauss g1_g("g1_g","g1_g",*povere,mean1_povere,sigma1_povere,sigma11_povere);
...
//Signals var2  ////////////////
    RooRealVar mean1_nsige("mean1_nsige","mean1_nsige",-3.,-10,2);
    RooRealVar sigma1_nsige("sigma1_nsige","sigma1_nsige",1,0.1,2.2);
    RooRealVar sigma2_nsige("sigma2_nsige","sigma2_nsige",1,0,1.2); 
    RooGaussian g1_nsige("g1_nsige","g1_nsige",*nsige,mean1_nsige,sigma1_nsige);
    ...
    prettycanvasAll(c_nsige,Frame_nsige,pullPlot_nsige,0,"n#sigma_{#pi}");     
//Signals var3  ////////////////
    RooRealVar mean1_deltabeta("mean1_deltabeta","mean1_deltabeta",0.,-.005,0.005);
    RooRealVar mean2_deltabeta("mean2_deltabeta","mean2_deltabeta",0.,-.01,0.01);
    RooRealVar sigma1_deltabeta("sigma1_deltabeta","sigma1_deltabeta",0.001,0.0001,1);
    RooRealVar sigma2_deltabeta("sigma2_deltabeta","sigma2_deltabeta",0.001,0.0001,1);
    RooRealVar sigma22_deltabeta("sigma22_deltabeta","sigma22_deltabeta",0.01,0.000001,1); 
    RooBifurGauss g1_1_deltabeta("g1_1_deltabeta","g1_1_deltabeta",*deltabeta,mean1_deltabeta,sigma1_deltabeta,sigma22_deltabeta);
...
//Signals var4  ////////////////
    ...
    RooRealVar sigma1_zdist("sigma1_zdist","sigma1_zdist",5,2,15);
    RooRealVar sigma2_zdist("sigma2_zdist","sigma2_zdist",5,2,15);
    ...
    RooAddPdf g1_zdist("g1_zdist","g1_zdist",g1_1_zdist,g1_2_zdist,frac1_zdist);
...
//Signals var5  ////////////////
    ...
    RooRealVar sigma1_phidist("sigma1_phidist","sigma1_phidist",0.01,0,0.1);
    RooRealVar sigma2_phidist("sigma2_phidist","sigma2_phidist",0.01,0,0.1);
    ...
    RooAddPdf g1_phidist("g1_phidist","g1_phidist",g1_1_phidist,g1_2_phidist,frac1_phidist);
...
///Done Fitting 
    ...
    weight_povere->Scale(1/weight_povere->Integral());//GGetMaximum());
   ...
   call->cd(6);
	...
	c_hits->SaveAs("plots/Pion_Hits_Fit.pdf");
	...
	weight_hits->Write("pion_weight_smdhits");
    }
