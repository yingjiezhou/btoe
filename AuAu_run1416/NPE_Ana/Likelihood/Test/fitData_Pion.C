...
//Signals var3  ////////////////
    ...
    if(pt==2)RooRealVar sigma1_deltabeta("sigma1_deltabeta","sigma1_deltabeta",0.0001,0.000001,1);
    if(pt==2)RooRealVar sigma2_deltabeta("sigma2_deltabeta","sigma2_deltabeta",0.0001,0.000001,1);
    if(pt==2)RooRealVar sigma22_deltabeta("sigma22_deltabeta","sigma22_deltabeta",0.0001,0.000001,1);
...
//Signals var5  ////////////////
    ...
    RooRealVar sigma2_phidist("sigma2_phidist","sigma2_phidist",0.01,0.001,0.1);
...
///Done Fitting 
    ...
    weight_povere->Scale(1/weight_povere->GetMaximum());
    ...
    weight_nsige->Scale(1/weight_nsige->GetMaximum());
    ...
    weight_deltabeta->Scale(1/weight_deltabeta->GetMaximum());
    ...
    weight_zdist->Scale(1/weight_zdist->GetMaximum());
    ...
    weight_phidist->Scale(1/weight_phidist->GetMaximum());
