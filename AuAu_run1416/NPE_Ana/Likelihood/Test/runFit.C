...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    double binning[numPtBins+1]={0.6,2.5,8.5};
    char cut_s[500];
    char cut_b[500];
    char cut_bkg[500];
   ...
   if(pt==0)sprintf(cut_s,"abs(1/probe_beta-1)<0.025 && probe_nsige<13 && probe_p/probe_emc0>0.3 && probe_p/probe_emc0<1.5 && probe_charge*tag_charge<0 && probe_pt>%1.1f && probe_pt<%1.1f ",0,8.5);
    if(pt==0)sprintf(cut_b,"abs(1/probe_beta-1)<0.025 && probe_nsige<13 && probe_p/probe_emc0>0.3 && probe_p/probe_emc0<1.5 && probe_charge*tag_charge>0 && probe_pt>%1.1f && probe_pt<%1.1f ",0,8.5);
    if(pt==0)sprintf(cut_bkg,"abs(1/probe_beta-1)<0.025 && probe_bkgcat==1 && probe_pt>%1.1f && probe_pt<%1.1f ",0,8.5);

    cout << "Using cuts " << cut_s << endl;
    char file[100] = "root/weights_electron_postcut.root";
    char file_pion[100] = "root/weights_pion_postcut.root";
//////////////////////////////////////////////////////////////////
