...
//Signals var1  ////////////////
    ...
    RooRealVar sigma1_povere("sigma1_povere","sigma1_povere",1,0.1,2.2);
    ...
    if(1)RooBifurGauss g1_cb("g1_cb","g1_cb",*povere,mean1_povere,sigma1_povere,sigma11_povere);
    if(1)RooBifurGauss g1_g("g1_g","g1_g",*povere,mean2_povere,sigma2_povere,sigma22_povere);
    if(1)RooBifurGauss g2_g("g2_g","g2_g",*povere,mean3_povere,sigma3_povere,sigma33_povere);
...
//Signals var5  ////////////////
    ...
    RooRealVar frac1_phidist("frac1_phidist","frac1_phidist",0.5,0,1);  
