...
//=========== Event Plane Calc. ===============
	...
	if(track->gPt()>0.15 && track->gPt()<2.  && !(track->nSigmaElectron()>-1 && track->nSigmaElectron()<3)){
	    ...
	    if(track->gMom(picoDst->event()->primaryVertex(), picoDst->event()->bField()).pseudoRapidity()>0.05 && track->gMom(picoDst->event()->primaryVertex(), picoDst->event()->bField()).pseudoRapidity()<1. ){
