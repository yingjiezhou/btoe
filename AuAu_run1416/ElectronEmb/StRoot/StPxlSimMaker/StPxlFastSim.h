...
class StPxlFastSim: public StPxlISim
{
 ...
 private:
  ...
  Double_t mDetEff;  // = 0.9;  // Efficiency for good sensors
  Double_t mDetUpInner; // = 0.85; // 85% sensors up
  Double_t mDetUpOuter; // = 0.95;  // 95% 
  Float_t mSensorMap[400];          // Sensor Status Map
};
#endif
/*
 * $Id: StPxlFastSim.h,v 1.3 2014/03/13 17:00:19 mstftsm Exp $
