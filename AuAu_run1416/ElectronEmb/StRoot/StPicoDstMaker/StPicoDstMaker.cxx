...
Int_t StPicoDstMaker::MakeWrite() {
  ...
  Float_t vzVpd = -999;
  //////////////////////////////////////
  // select the right vertex using no. of tracks (Simulation)
  /////////////////////////////////////
  if(mMcMode==true){
    int mTracks=0;
    int vtxIndex=0;
    for(unsigned int i=0;i<mMuDst->numberOfPrimaryVertices();i++) {
      ...
      if(!vtx) continue;
      if( vtx->noTracks() > mTracks ){
	mTracks = vtx->noTracks();
	vtxIndex = i;
      }	
    }
  ...
  //////////////////////////////////////
  // select the right vertex using VPD (data)
  /////////////////////////////////////
  else{
