...
void plotAllSyst(int savefrac = 0){
    ...
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,1,"./300/yields.dat",1,y_sys_mb);//Central 11
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,2,"./302/yields.dat",0,y_sys_mb);//phoe 1-pion
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,3,"./304/yields.dat",0,y_sys_mb);//phoe 1-gamma
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,4,"./306/yields.dat",0,y_sys_mb);// phoe 2
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,5,"./308/yields.dat",0,y_sys_mb);// pt spectra
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,6,"./310/yields.dat",0,y_sys_mb);// fragmetation
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,7,"./312/yields.dat",2,y_sys_mb);// fragmetation
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,1,"./301/yields.dat",1,y_sys_ht);//12
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,2,"./303/yields.dat",0,y_sys_ht);
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,3,"./305/yields.dat",0,y_sys_ht);
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,4,"./307/yields.dat",0,y_sys_ht);
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,5,"./309/yields.dat",0,y_sys_ht);
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,6,"./311/yields.dat",0,y_sys_ht);
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,7,"./313/yields.dat",2,y_sys_ht);
