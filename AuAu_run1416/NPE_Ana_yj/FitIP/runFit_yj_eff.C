...
void runFit_yj_eff(int rs=1,int save=1, int doAllFits=1, int HT=0)
{
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  //for(int pt=ptStart;pt<ptStart+1;pt++){ //zyj test
    ...
    sprintf(dFile1,"../../NPE_MC/Ana/root_yj/DCA_plots_yj_full.root"); // matt PHE
    ...
    if(HT){
      ...
      //double constraint_v2[numPtBins]={0.362,0.304,0.283, 0.275528, 0.203909, 0.174318, 0.146396, 0.156036, 0.147285};
...
/*
  // pion
  comp__5->SetBinContent(1,0.3611103);
  comp__5->SetBinContent(2,0.3550273);
  comp__5->SetBinContent(3,0.3248406);
  comp__5->SetBinContent(4,0.3162411);
  comp__5->SetBinContent(5,0.3113835);
  comp__5->SetBinContent(6,0.3260783);
  comp__5->SetBinContent(7,0.3459727);
  comp__5->SetBinContent(8,0.3807676);
  comp__5->SetBinContent(9,0.3891355);
  comp__5->SetBinError(1,0.003653152);
  comp__5->SetBinError(2,0.009999008);
  comp__5->SetBinError(3,0.005659404);
  comp__5->SetBinError(4,0.003748282);
  comp__5->SetBinError(5,0.002858133);
  comp__5->SetBinError(6,0.002094843);
  comp__5->SetBinError(7,0.002197238);
  comp__5->SetBinError(8,0.001863078);
  comp__5->SetBinError(9,0.001326305);*/
  /*
  //gamma
