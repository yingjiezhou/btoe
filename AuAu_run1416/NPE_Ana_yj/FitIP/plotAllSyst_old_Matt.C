...
void plotAllSyst_old_Matt(int savefrac = 0){
...
// pp
  ...
  ccharm->SaveAs("sys_latest_local/charm_spectrum.pdf");
  //======================================================================
  ...
  leg4->Draw("same");
  gPad->RedrawAxis();
  cy->SaveAs("sys_latest_local/yields.pdf");
  //======================================================================
  ...
  h->Draw("same E1");
  leg3->Draw("same");
  c1->SaveAs("sys_latest_local/Final_fraction.pdf");
  c1->SaveAs("sys_latest_local/Final_fraction.C");
  //======================================================================
  ...
  er_ht->Draw("same");
  leg22->Draw("same");
  c2->SaveAs("sys_latest_local/Real_err.pdf");
  c2->SaveAs("sys_latest_local/Real_err.C");
  //======================================================================
  ...
  Name->Draw("same");
  gPad->RedrawAxis();
  c3->SaveAs("sys_latest_local/MB_HT_average.pdf");
  //======================================================================
  // relative error
  for(int i = 5; i<10; i++){
  ...
  leg11->Draw("same");
  c34->SaveAs("sys_latest_local/realative_err.pdf");
  //======================================================================
  ...
  */
  ...
  func2.Draw("same l");
  func22.Draw("same l");
  cspread->SaveAs("sys_latest_local/spread.pdf");
  ...
  legg->Draw("same");
  Name1->Draw("same");
  c44->SaveAs("sys_latest_local/raa_fraction.pdf");
  //======================================================================
  ...
  c4->SaveAs("sys_latest_local/FracComp_errors.pdf");
  //======================================================================

  if(savefrac){
    TFile save("root_yj/Fractions_matt.root","RECREATE");
    frb->Write("bfrac");
    frc->Write("cfrac");
    frh->Write("hfrac");
    fre->Write("efrac");
  ...
  if(1){
    TFile save("root_yj/FracB_matt.root","RECREATE");
    h_ave->Write("fb");
