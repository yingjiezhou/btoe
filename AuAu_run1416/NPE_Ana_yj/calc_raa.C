void calc_raa(){
    ...
    fb_sys1->SetName("fb_sys11");
    fb1->SetMarkerColor(kBlue);
    fb1->SetLineColor(kBlue);
    fb1->SetMarkerStyle(25);
    fb_sys1->SetMarkerColor(kBlue);
    fb_sys1->SetLineColor(kBlue);
    fb_sys1->SetMarkerStyle(25);
    fb_sys1->SetFillColor(kBlue);
    fb_sys1->SetFillStyle(3004);
    ...
    legr->AddEntry(fb,"2014Au+Au #sqrt{s_{NN}} = 200 GeV","PLE");
    legr->AddEntry(fb11,"2016 Au+Au #sqrt{s_{NN}} = 200 GeV","PLE");
    legr->AddEntry(gpp,"#it{p}+#it{p} #sqrt{s} = 200 GeV","PLE");
    legr->AddEntry(gb,"FONLL #it{p}+#it{p} #sqrt{s} = 200 GeV","L");
