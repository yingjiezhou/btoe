...
void plotFractionRooFit(int pass=1){
  ...
  char file[50];
  sprintf(file,"./%i/yields.dat",1); //mb 11
  ifstream data(file);
  char file1[50];
  ...
  leg1->Draw("same");
  c1->SaveAs("plots_yj/b_fraction_comp_matt.pdf");
  c1->SaveAs("plots_yj/b_fraction_comp_matt.C");
  //===================================================================
  // comp 0930
  ...
  leg3->Draw("same");
  Name->Draw("same");
  c5->SaveAs("plots_yj/b_fraction_final_matt.pdf");
  c5->SaveAs("plots_yj/b_fraction_final_matt.C");
  ...
  */
  ...
  c2->SaveAs("plots_yj/NPE_PE_ratio_matt.pdf");
  //h2_ht->Draw("same");
  ...
  h4->Draw("histe same");
  leg->Draw("same");
  c3->SaveAs("plots_yj/bfraction_matt.pdf");
  ...
  */
  ...
  hc_t->Draw(" hist");
  hb_t->Draw("same hist");
  c4->SaveAs("plots_yj/pt_b_d_matt.pdf");
