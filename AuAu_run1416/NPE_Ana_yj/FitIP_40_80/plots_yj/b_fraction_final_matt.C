...
//=========  (Mon Sep 30 11:03:07 2019) by ROOT version 6.16/00
   ...
   hmb__3_Matt->SetLineColor(ci);
   hmb__3_Matt->SetLineWidth(2);

   ci = TColor::GetColor("#0000ff");
   hmb__3_Matt->SetMarkerColor(ci);
   ...
   hht__4_Matt->SetLineColor(ci);
   hht__4_Matt->SetLineWidth(2);

   ci = TColor::GetColor("#ff0000");
   hht__4_Matt->SetMarkerColor(ci);
