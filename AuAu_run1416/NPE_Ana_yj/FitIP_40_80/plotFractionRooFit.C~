void plotFractionRooFit(int pass=1){
    ...
    char file[50];
    sprintf(file,"./%i/yields.dat",11);
    ifstream data(file);
    char file1[50];
    sprintf(file1,"./%i/yields.dat",12);
...
/*
		hb->SetBinContent(pT,fb1);
		hb->SetBinError(pT,fb1*sqrt(npere*npere/nper/nper+bre*bre/br/br));
		hc->SetBinContent(pT,fc1);
		hc->SetBinError(pT,fc1*sqrt(npere*npere/nper/nper+bre*bre/br/br));
		he->SetBinContent(pT,fe1);
		he->SetBinError(pT,fe1*sqrt(ere*ere/er/er));
		hh->SetBinContent(pT,fh1);
		hh->SetBinError(pT,fh1*sqrt(bkgre*bkgre/bkgr/bkgr));
*/
...
/*
		hb_ht->SetBinContent(pT,fb1);
		hb_ht->SetBinError(pT,fb1*sqrt(npere*npere/nper/nper+bre*bre/br/br));
		hc_ht->SetBinContent(pT,fc1);
		hc_ht->SetBinError(pT,fc1*sqrt(npere*npere/nper/nper+bre*bre/br/br));
		he_ht->SetBinContent(pT,fe1);
		he_ht->SetBinError(pT,fe1*sqrt(ere*ere/er/er));
		hh_ht->SetBinContent(pT,fh1);
		hh_ht->SetBinError(pT,fh1*sqrt(bkgre*bkgre/bkgr/bkgr));
