...
0.667};
    ...
    double yep[21]={0.0118,
		    ...
		    0.0588,
		    0.0598,
		    0.0616,0.0657,0.0708,0.0784,0.0881,0.0992};
 ...
 // DUKE
    ...
    TGraphAsymmErrors *gpp = new TGraphAsymmErrors(6,xx2,yy3,xxe2,xxe2,ee13,ee13);                                                                                                                                                          
    TGraphAsymmErrors *gpp_sys = new TGraphAsymmErrors(6,xx2,yy3,xxe22,xxe22,ee1l3,ee1h3);    
    ...
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,8,"./15/yields.dat",0,y_sys_mb);// less dp fragmetation
    getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,9,"./17/yields.dat",2,y_sys_mb);// lc
    ...
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,8,"./16/yields.dat",0,y_sys_ht);
    getData(h_yield_ht,h_yield_ht_sys,h1_ht,frac_ht,frac1_ht,frac2_ht,frac3_ht,9,"./18/yields.dat",2,y_sys_ht);
    ...
    cout << "Errors are phoe1-pion  - phoe2 const - pt spectra - fragmentaion - lambda_c" <<  endl;
	...
	for(int j = 1; j<numSysBins+1; j++){	
		...
		if(j==1){
		    ...
		    if(j!=2 && j!=5 && j!=7)cout << fabs(cen-val)/cen << " & ";
		}
		cout << endl;
	    }
	}
...
//y_sys_ht->Draw("hist same");
    ...
    leg1->AddEntry(frb,"#it{b}#rightarrow#it{e}","PLE");
    leg1->AddEntry(frc,"#it{c}#rightarrow#it{e}","PLE");
