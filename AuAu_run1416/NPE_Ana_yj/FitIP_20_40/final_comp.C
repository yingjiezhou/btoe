...
//=========  (Mon Sep 30 10:45:37 2019) by ROOT version 6.16/00
  ...
  hmb__3_Matt->SetBinContent(5,0.250667);
  hmb__3_Matt->SetBinContent(6,0.400152);
  hmb__3_Matt->SetBinContent(7,0.466991);
  hmb__3_Matt->SetBinContent(8,0.600006);
  hmb__3_Matt->SetBinError(5,0.0122648);
  hmb__3_Matt->SetBinError(6,0.018922);
  hmb__3_Matt->SetBinError(7,0.0499963);
  hmb__3_Matt->SetBinError(8,0.170107);
  ...
  Double_t xAxis4_Matt[10] = {0.6+0.2, 1+0.2, 1.2+0.2, 1.5+0.2, 2+0.2, 2.5+0.2, 3.5+0.2, 4.5+0.2, 5.5+0.2, 8.5+0.2};
  
  TH1F *hht__4_Matt = new TH1F("hht__4_Matt","hht",9, xAxis4_Matt);
  hht__4_Matt->SetBinContent(6,0.58563);
  hht__4_Matt->SetBinContent(7,0.598869);
  hht__4_Matt->SetBinContent(8,0.642587);
  hht__4_Matt->SetBinContent(9,0.790271);
  hht__4_Matt->SetBinError(6,0.164012);
  hht__4_Matt->SetBinError(7,0.101775);
  hht__4_Matt->SetBinError(8,0.105496);
  hht__4_Matt->SetBinError(9,0.166438);
  hht__4_Matt->SetEntries(4);
  ...
  leg->AddEntry("hmb__3_Matt","Min. Bias Matt","PLE");
   ...
   pt->SetTextAlign(12);
   pt->SetTextFont(132);
   TText *pt_LaTex = pt->AddText("STAR 0-20%");
   pt->Draw();
   c5->Modified();
   c5->cd();
   c5->SetSelected(c5);
