...
/////Minuit Options
    ...
    if(pt>0)const double _start = -5.26;  
...
//Signals
    ...
    if(0)RooAddPdf g1("g1","g1",g1_1,g1_2,frac1);
    else RooBifurGauss g1("g1","g1",*PID,mean1,sigma1,sigma11);//,sigma11
    
    RooRealVar mean2("mean2","mean2",-0,-2,2.5);
    RooRealVar sigma2("sigma2","sigma2",0.5,0.001,5.);  
    ...
    RooBifurGauss g2("g2_2","g2_2",*PID,mean2,sigma2_2,sigma2_22);
    ...
    RooRealVar sigma44("sigma44","sigma44",1,0,3.);   // zyj not used here
...
//Now fit All Data
    ...
    if(1)dataHist1->plotOn(PIDFrame,Name("HistM1"),MarkerColor(kGray),LineColor(kGray));
    dataHist->plotOn(PIDFrame,Name("HistM"));
