#include "fitMVAdata1D_tuneB_Response.C"
void runFit_tuneB_Response(int rs=1,int save=0, int doAllFits=0)
{
/////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
	char dFile[500];
	char dFile1[500];
	sprintf(dFile,"../production/NPE_Tuples_TuneB4.root");
	...
	h01_2D1 = (TH2F*) f_D->Get("hFit2D_0");
	h01_2D_e = (TH2F*) f_D->Get("hFit2D_e_0");
	h01_2D_e_WS = (TH2F*) f_D->Get("hFit2D_e_WS_0"); 
	h01_2D_pi = (TH2F*) f_D1->Get("hFit2D_pi_0");
	h01_2D_2pi = (TH2F*) f_D->Get("hFit2D_0");
	h01_2D_k = (TH2F*) f_D->Get("hFit2D_0");
	h01_2D_p = (TH2F*) f_D->Get("hFit2D_0");
	h01_2D = (TH2F*) f_D->Get("hFit2D_0");//3
	...
	if(pt>0){
	    ...
	    h01_2D_e->GetXaxis()->SetRangeUser(binning[pt-1],binning[pt]);
