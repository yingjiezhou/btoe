...
/////Minuit Options
    ...
    if(pt>0)const double _start = -6;  
    if(pt>0)const double _end = 7;//13;
...
//Signals
    ...
    RooRealVar mean2("mean2","mean2",-2,-10,2);
    RooRealVar sigma2("sigma2","sigma2",0.2,0.15,1.);  
  

    RooRealVar mean2_2("mean2_2","mean2_2",-2,-7,2);
    ...
    RooBifurGauss g2("g2","g2",*PID,mean2,sigma2,sigma2_2);
    ...
    RooRealVar mean4("mean4","mean4",-4,-7,2);
    RooRealVar sigma4("sigma4","sigma4",1,0.1,5.); 
    RooRealVar sigma44("sigma44","sigma44",1,0.1,3.);    
    RooBifurGauss g4("g4","g4",*PID,mean4,sigma4,sigma44); 
...
//Background
    ...
    RooRealVar e_signal_yield("e_signal_yield","e_signal_yield",1000,000,1000000000);
    ...
    if(1)yieldList.add(p_signal_yield);
