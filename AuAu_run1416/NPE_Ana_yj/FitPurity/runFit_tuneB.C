#include "fitMVAdata1D_tuneB.C"
void runFit_tuneB(int rs=1,int save=0, int doAllFits=0)
{
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  for(int pt=ptStart;pt<ptEnd+1;pt++){
    ...
    sprintf(dFile2,"../production/NPE_Tuples_TuneB7_Small.root");
    ...
    h01_2D_pi1 = (TH2F*) f_D->Get("hFit_pi_0");
    h01_2D_pi1->SetName("h01_2D_pi1");
    h01_2D_pi2 = (TH2F*) f_D1->Get("hFit_pi_0");
    h01_2D_pi2->SetName("h01_2D_pi2");
    h01_2D_pi3 = (TH2F*) f_D->Get("hFit_pi_0");
    ...
    if(pt>0){
      ...
      if(pt<5)h01_2D_pi->GetXaxis()->SetRangeUser(binning[pt-1],binning[pt]);
      if(pt>4)h01_2D_pi->GetXaxis()->SetRangeUser(2.,8.5);
      if(pt<5)h01_2D_pi1->GetXaxis()->SetRangeUser(binning[pt-1],binning[pt]);
      if(pt>4)h01_2D_pi1->GetXaxis()->SetRangeUser(2.,8.5);
      if(pt<5)h01_2D_pi2->GetXaxis()->SetRangeUser(binning[pt-1],binning[pt]);
      if(pt>4)h01_2D_pi2->GetXaxis()->SetRangeUser(2.,8.5);
      if(pt<5)h01_2D_pi3->GetXaxis()->SetRangeUser(binning[pt-1],binning[pt]);
      if(pt>4)h01_2D_pi3->GetXaxis()->SetRangeUser(2.,8.5);
    ...
    h01_pi2=(TH1F*)h01_2D_pi2->ProjectionY();
    h01_pi3=(TH1F*)h01_2D_pi3->ProjectionY();
    ...
    double temp1 = h01->Integral(bin1,bin2);
    double temp2 = h011->Integral(bin1,bin2); //likelihood cut>0
    cout << "Pre cut " << temp2 << endl;
    cout << "Post cut " << temp1 << endl; // after likelihood cut, I can use this to get purity
    cout << "Difference in events passing cut " << temp2-temp1 << endl;
    ...
    h01_pi->GetXaxis()->SetRangeUser(-4,4);
    h01_pi1->GetXaxis()->SetRangeUser(-4,4);
    h01_pi2->GetXaxis()->SetRangeUser(-4,4);
    h01_pi3->GetXaxis()->SetRangeUser(-4,4);
