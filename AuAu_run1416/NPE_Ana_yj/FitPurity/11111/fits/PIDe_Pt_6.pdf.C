...
//=========  (Wed Aug 14 14:42:16 2019) by ROOT version 6.16/00
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-13.0963,-1.500193,6.162963,7.876015);
   pad1->SetFillColor(0);
   ...
   TH1D *frame_7faa32bc9360__1 = new TH1D("frame_7faa32bc9360__1","",100,-10.4,5.2);
   frame_7faa32bc9360__1->SetBinContent(1,1609623);
   frame_7faa32bc9360__1->SetMinimum(1);
   frame_7faa32bc9360__1->SetMaximum(1.336344e+07);
   frame_7faa32bc9360__1->SetEntries(2);
   frame_7faa32bc9360__1->SetDirectory(0);
   frame_7faa32bc9360__1->SetStats(0);
   frame_7faa32bc9360__1->SetLineWidth(2);
   frame_7faa32bc9360__1->SetMarkerStyle(20);
   frame_7faa32bc9360__1->GetXaxis()->SetTitle("n#sigma_{e}");
   frame_7faa32bc9360__1->GetXaxis()->SetNdivisions(505);
   frame_7faa32bc9360__1->GetXaxis()->SetLabelFont(132);
   frame_7faa32bc9360__1->GetXaxis()->SetLabelOffset(0.01);
   frame_7faa32bc9360__1->GetXaxis()->SetLabelSize(0.06);
   frame_7faa32bc9360__1->GetXaxis()->SetTitleSize(0.072);
   frame_7faa32bc9360__1->GetXaxis()->SetTitleOffset(0.95);
   frame_7faa32bc9360__1->GetXaxis()->SetTitleFont(132);
   frame_7faa32bc9360__1->GetYaxis()->SetTitle("Events / ( 0.52 )");
   frame_7faa32bc9360__1->GetYaxis()->SetLabelFont(132);
   frame_7faa32bc9360__1->GetYaxis()->SetLabelOffset(0.01);
   frame_7faa32bc9360__1->GetYaxis()->SetLabelSize(0.06);
   frame_7faa32bc9360__1->GetYaxis()->SetTitleSize(0.1);
   frame_7faa32bc9360__1->GetYaxis()->SetTitleOffset(0.6);
   frame_7faa32bc9360__1->GetYaxis()->SetTitleFont(132);
   frame_7faa32bc9360__1->GetZaxis()->SetLabelFont(132);
   frame_7faa32bc9360__1->GetZaxis()->SetLabelSize(0.06);
   frame_7faa32bc9360__1->GetZaxis()->SetTitleSize(0.072);
   frame_7faa32bc9360__1->GetZaxis()->SetTitleOffset(1.2);
   frame_7faa32bc9360__1->GetZaxis()->SetTitleFont(132);
   frame_7faa32bc9360__1->Draw("FUNC");
   ...
   Graph_HistM3001->SetMinimum(71.6254);
   Graph_HistM3001->SetMaximum(1471243);
   ...
   Graph_PID_Curve1->SetMinimum(27.80718);
   Graph_PID_Curve1->SetMaximum(1686269);
   ...
   Graph_e_signal2->SetMinimum(3.104168e-15);
   Graph_e_signal2->SetMaximum(22953.22);
   ...
   1.445302e-08,
   1.445302e-08};
   graph = new TGraph(128,pi_signal_fx3,pi_signal_fy3);
   ...
   TH1F *Graph_pi_signal3 = new TH1F("Graph_pi_signal3","Projection of completePDF",128,-11.5,6.5);
   Graph_pi_signal3->SetMinimum(2.654883e-27);
   Graph_pi_signal3->SetMaximum(636096.7);
   ...
   Graph_pi2_signal4->SetMinimum(2.927145e-62);
   Graph_pi2_signal4->SetMaximum(148.0429);
   ...
   0.2887492,
   0.2887492};
   graph = new TGraph(112,k_signal_fx5,k_signal_fy5);
   ...
   TH1F *Graph_k_signal5 = new TH1F("Graph_k_signal5","Projection of completePDF",112,-11.5,6.5);
   Graph_k_signal5->SetMinimum(0.2598743);
   Graph_k_signal5->SetMaximum(951932.8);
   ...
   1.971648e-09,
   1.971648e-09};
   graph = new TGraph(115,p_signal_fx6,p_signal_fy6);
   ...
   TH1F *Graph_p_signal6 = new TH1F("Graph_p_signal6","Projection of completePDF",115,-11.5,6.5);
   Graph_p_signal6->SetMinimum(1.774484e-09);
   Graph_p_signal6->SetMaximum(402541.1);
   Graph_p_signal6->SetDirectory(0);
   Graph_p_signal6->SetStats(0);
   Graph_p_signal6->SetLineWidth(2);
   Graph_p_signal6->SetMarkerStyle(20);
   Graph_p_signal6->GetXaxis()->SetNdivisions(505);
   Graph_p_signal6->GetXaxis()->SetLabelFont(132);
   Graph_p_signal6->GetXaxis()->SetLabelOffset(0.01);
   Graph_p_signal6->GetXaxis()->SetLabelSize(0.06);
   Graph_p_signal6->GetXaxis()->SetTitleSize(0.072);
   Graph_p_signal6->GetXaxis()->SetTitleOffset(0.95);
   Graph_p_signal6->GetXaxis()->SetTitleFont(132);
   Graph_p_signal6->GetYaxis()->SetLabelFont(132);
   Graph_p_signal6->GetYaxis()->SetLabelOffset(0.01);
   Graph_p_signal6->GetYaxis()->SetLabelSize(0.06);
   Graph_p_signal6->GetYaxis()->SetTitleSize(0.072);
   Graph_p_signal6->GetYaxis()->SetTitleOffset(0.95);
   Graph_p_signal6->GetYaxis()->SetTitleFont(132);
   Graph_p_signal6->GetZaxis()->SetLabelFont(132);
   Graph_p_signal6->GetZaxis()->SetLabelSize(0.06);
   Graph_p_signal6->GetZaxis()->SetTitleSize(0.072);
   Graph_p_signal6->GetZaxis()->SetTitleOffset(1.2);
   Graph_p_signal6->GetZaxis()->SetTitleFont(132);
   graph->SetHistogram(Graph_p_signal6);
   ...
   Graph_HistM13002->SetMinimum(7.726261);
   Graph_HistM13002->SetMaximum(63989.65);
   ...
   Graph_HistM3003->SetMinimum(71.6254);
   Graph_HistM3003->SetMaximum(1471243);
   ...
   TH1D *frame_7faa32bc9360__2 = new TH1D("frame_7faa32bc9360__2","",100,-10.4,5.2);
   frame_7faa32bc9360__2->SetBinContent(1,1609623);
   frame_7faa32bc9360__2->SetMinimum(1);
   frame_7faa32bc9360__2->SetMaximum(1.336344e+07);
   frame_7faa32bc9360__2->SetEntries(2);
   frame_7faa32bc9360__2->SetDirectory(0);
   frame_7faa32bc9360__2->SetStats(0);
   frame_7faa32bc9360__2->SetLineWidth(2);
   frame_7faa32bc9360__2->SetMarkerStyle(20);
   frame_7faa32bc9360__2->GetXaxis()->SetTitle("n#sigma_{e}");
   frame_7faa32bc9360__2->GetXaxis()->SetNdivisions(505);
   frame_7faa32bc9360__2->GetXaxis()->SetLabelFont(132);
   frame_7faa32bc9360__2->GetXaxis()->SetLabelOffset(0.01);
   frame_7faa32bc9360__2->GetXaxis()->SetLabelSize(0.06);
   frame_7faa32bc9360__2->GetXaxis()->SetTitleSize(0.072);
   frame_7faa32bc9360__2->GetXaxis()->SetTitleOffset(0.95);
   frame_7faa32bc9360__2->GetXaxis()->SetTitleFont(132);
   frame_7faa32bc9360__2->GetYaxis()->SetTitle("Events / ( 0.52 )");
   frame_7faa32bc9360__2->GetYaxis()->SetLabelFont(132);
   frame_7faa32bc9360__2->GetYaxis()->SetLabelOffset(0.01);
   frame_7faa32bc9360__2->GetYaxis()->SetLabelSize(0.06);
   frame_7faa32bc9360__2->GetYaxis()->SetTitleSize(0.1);
   frame_7faa32bc9360__2->GetYaxis()->SetTitleOffset(0.6);
   frame_7faa32bc9360__2->GetYaxis()->SetTitleFont(132);
   frame_7faa32bc9360__2->GetZaxis()->SetLabelFont(132);
   frame_7faa32bc9360__2->GetZaxis()->SetLabelSize(0.06);
   frame_7faa32bc9360__2->GetZaxis()->SetTitleSize(0.072);
   frame_7faa32bc9360__2->GetZaxis()->SetTitleOffset(1.2);
   frame_7faa32bc9360__2->GetZaxis()->SetTitleFont(132);
   frame_7faa32bc9360__2->Draw("AXISSAME");
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","","L");
