...
// pp
  ...
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,1,"./101/yields.dat",1,y_sys_mb);//Central 1
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,2,"./103/yields.dat",0,y_sys_mb);//phoe 1-pion
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,3,"./105/yields.dat",0,y_sys_mb);//phoe 1-gamma
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,4,"./107/yields.dat",0,y_sys_mb);// phoe 2
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,5,"./109/yields.dat",0,y_sys_mb);// pt spectra
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,6,"./111/yields.dat",0,y_sys_mb);// fragmetation
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,7,"./113/yields.dat",0,y_sys_mb);// fragmetation
  getData(h_yield_mb,h_yield_mb_sys,h1,frac,frac1,frac2,frac3,8,"./115/yields.dat",2,y_sys_mb);// fragmetation
  ...
  c1->SaveAs("sys_yj/Final_fraction.C");
  //======================================================================
  ...
  */
  ...
  if(1){
    TFile save("root_yj/FracB_0_20_yj.root","RECREATE");
    h_ave->Write("fb");
