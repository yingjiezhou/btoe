...
// pp
  ...
  ccharm->SaveAs("sys_matt/charm_spectrum.pdf");
  //======================================================================
  ...
  h->Draw("same E1");
  leg3->Draw("same");
  c1->SaveAs("sys_matt/Final_fraction.pdf");
  c1->SaveAs("sys_matt/Final_fraction.C");
  //======================================================================
  ...
  er_ht->Draw("same");
  leg22->Draw("same");
  c2->SaveAs("sys_matt/Real_err.pdf");
  c2->SaveAs("sys_matt/Real_err.C");
  //======================================================================
  ...
  Name->Draw("same");
  gPad->RedrawAxis();
  c3->SaveAs("sys_matt/MB_HT_average.pdf");
  //======================================================================
  // relative error
  for(int i = 5; i<10; i++){
  ...
  leg11->Draw("same");
  c34->SaveAs("sys_matt/realative_err.pdf");
  //======================================================================
  ...
  */
  ...
  func2.Draw("same l");
  func22.Draw("same l");
  cspread->SaveAs("sys_matt/spread.pdf");
  ...
  legg->Draw("same");
  Name1->Draw("same");
  c44->SaveAs("sys_matt/raa_fraction.pdf");
  //======================================================================
  ...
  c4->SaveAs("sys_matt/FracComp_errors.pdf");
  //======================================================================
