...
//Signals var1  ////////////////
    ...
    RooRealVar mean1_povere("mean1_povere","mean1_povere",0.5,0.4,2);
    RooRealVar mean2_povere("mean2_povere","mean2_povere",0.5,0.4,2);
...
//Signals var3  ////////////////
    ...
    RooRealVar sigma1_deltabeta("sigma1_deltabeta","sigma1_deltabeta",0.001,0.00001,1);
    RooRealVar sigma2_deltabeta("sigma2_deltabeta","sigma2_deltabeta",0.001,0.00001,1); 
    RooBifurGauss g1_deltabeta("g1_deltabeta","g1_deltabeta",*deltabeta,mean1_deltabeta,sigma1_deltabeta,sigma2_deltabeta);
