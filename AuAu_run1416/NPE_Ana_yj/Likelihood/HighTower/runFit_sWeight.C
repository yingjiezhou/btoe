...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(pt==0)sprintf(cut_s_beta,"(probe_neta>0 || probe_nphi>0) && probe_beta>0 &&probe_nsige<13 && probe_emc0>0 && probe_charge*tag_charge<0 && probe_pt>%1.1f && probe_pt<%1.1f ",2,8.5);
    if(pt==0)sprintf(cut_b_beta,"(probe_neta>0 || probe_nphi>0) && probe_beta>0 &&probe_nsige<13 && probe_emc0>0 && probe_charge*tag_charge>0 && probe_pt>%1.1f && probe_pt<%1.1f ",2,8.5);
...
//////////////////////////////////////////////////////////////////
    ...
    TH1F* hSig_povere = new TH1F("hSig_povere","hSig_povere",100,0,5);
    ...
    TH1F* hSig_zdist = new TH1F("hSig_zdist","hSig_zdist",30,-30,30);
    TH1F* hSig_phidist = new TH1F("hSig_phidist","hSig_phidist",100,-0.1,0.1);
    TH1F* hSig_hits = new TH1F("hSig_hits","hSig_hits",15,0,15);
    TH1F* hSig_povere_ws = new TH1F("hSig_povere_ws","hSig_povere_ws",200,0,5);
    ...
    TH1F* hSig_zdist_ws = new TH1F("hSig_zdist_ws","hSig_zdist_ws",30,-30,30);
    ...
    TH1F* hBkg_povere = new TH1F("hBkg_povere","hBkg_povere",100,0,5);
    TH1F* hBkg_nsigpi = new TH1F("hBkg_nsigpi","hBkg_nsigpi",70,-13,13);
    TH1F* hBkg_deltabeta = new TH1F("hBkg_deltabeta","hBkg_deltabeta",50,-0.05,0.05);
    TH1F* hBkg_zdist = new TH1F("hBkg_zdist","hBkg_zdist",30,-30,30);
    TH1F* hBkg_phidist = new TH1F("hBkg_phidist","hBkg_phidist",25,-0.1,0.1);
    TH1F* hBkg_hits = new TH1F("hBkg_hits","hBkg_hits",15,0,15);
    float nsige = 0;
    float beta = 0;
    float pT = 0;
    float p = 0;
    ...
    for(int i =0;i<ch2->GetEntries();i++){
	    ...
	    if(nphi>0||neta>0)hBkg_hits->Fill(neta+nphi,sw);                                                                                                                                       
	    //if(beta!=0){
...
void doLikelihood(){
    ...
    TGaxis::SetMaxDigits(3);
    int const numPtBins=5;
    double binning[numPtBins+1]={2,2.5,3.5,4.5,5.5,8.5};
    char dFile[500];
    char dFile1[500];
    sprintf(dFile,"../../production/NPE_Tuples_TuneA10.root");
    sprintf(dFile1,"../../SPlot/Kshort/out.root");
    ...
    TH1F* DLL_e = new TH1F("DLL_e","DLL_e",40,-1,1.5);
    TH1F* DLL_e_ws = new TH1F("DLL_e_ws","DLL_e_ws",40,-1,1.5);
    ...
    TH2F* DLL_e_pt = new TH2F("DLL_e_pt","DLL_e_pt",40,-1,1.5,200,-4,4);
    TH2F* DLL_e_pt_ws = new TH2F("DLL_e_pt_ws","DLL_e_pt_ws",40,-1,1.5,200,-4,4);
    TH2F* DLL_p_pt = new TH2F("DLL_p_pt","DLL_p_pt",40,-1,1.5,200,-4,4);
    ...
    TH1F* DLL_p = new TH1F("DLL_p","DLL_p",40,-1,1.5);
    TH1F* DLL_e_nw = new TH1F("DLL_e_nw","DLL_e_nw",40,-1,1.5);
    TH1F* DLL_e_ws_nw = new TH1F("DLL_e_ws_nw","DLL_e_ws_nw",40,-1,1.5);
    TH1F* DLL_p_nw = new TH1F("DLL_p_nw","DLL_p_nw",40,-1,1.5);
    ...
    TH1F* DLL_pr_post = new TH1F("DLL_pr_post","DLL_pr_post",40,-1,1.5);
    TH1F* DLL_k_post = new TH1F("DLL_k_post","DLL_k_post",40,-1,1.5);
    ...
    TH2F* DLL_pr_2D = new TH2F("DLL_pr_2D","DLL_pr_2D",40,-1,1.5,400,-4,4);
    TH1F* DLL_2p = new TH1F("DLL_2p","DLL_2p",1000,-4,4);
    TH2F* DLL_2p_2D = new TH2F("DLL_2p_2D","DLL_2p_2D",40,-1,1.5,400,-4,4);
    TH1F* DLL_k = new TH1F("DLL_k","DLL_k",1000,-4,4);
    TH2F* DLL_k_2D = new TH2F("DLL_k_2D","DLL_k_2D",40,-1,1.5,400,-4,4);
    ...
    TH1F* eff_e = new TH1F("eff_e","eff_e",40,-1,1.5);

    TH1F* sign = new TH1F("sign ","sign ",40,-1,1.5);
    TH1F* line = new TH1F("line","line",50,-13,40);
    TH1F* eff_p = new TH1F("eff_p","eff_p",40,-1,1.5);
	...
	double weight66= pion_weight_hits->GetBinContent(bin6);
        ...
        if(weight6<1e-10)weight5+=1e-10;
	if(weight11<1e-10)weight11+=1e-10;
        ...
        if(beta>0)double rati =weight1*weight2*weight3*weight4*weight5*weight6 / (weight6*weight1*weight2*weight3*weight4*weight5+weight66*weight11*weight22*weight33*weight44*weight55);
        if(beta<=0)double rati =weight1*weight2*weight4*weight5 / (weight6*weight1*weight2*weight4*weight5+weight66*weight11*weight22*weight44*weight55);
	...
	if(probe_charge*tag_charge<0){
	    ...
	    DLL_e->Fill(dll);
	    if(nsige>-1 && nsige<3 && p/emc0>0.3 && p/emc0<1.5 && neta>1 && nphi>1)DLL_e_post->Fill(dll);
	    if(nsige>-1 && nsige<3 && p/emc0>0.3 && p/emc0<1.5 && neta>1 && nphi>1)DLL_e_2D->Fill(pt,dll);
	...
	if(probe_charge*tag_charge>0){
	    ...
	    DLL_e_ws->Fill(dll);
	    if(nsige>-1 && nsige<3 && p/emc0>0.3 && p/emc0<1.5 && neta>1 && nphi>1)DLL_e_ws_post->Fill(dll);
	    if(nsige>-1 && nsige<3 && p/emc0>0.3 && p/emc0<1.5 && neta>1 && nphi>1)DLL_e_ws_2D->Fill(pt,dll);
	...
	if(1){//bkgcat==1 && nsige<0){
	    DLL_p->Fill(dll,sw);
	    if(nsige>-1 && nsige<3 && p/emc0>0.3 && p/emc0<1.5 && neta>1 && nphi>1)DLL_p_post->Fill(dll,sw);
	    if(nsige>-1 && nsige<3 && p/emc0>0.3 && p/emc0<1.5 && neta>1 && nphi>1)DLL_p_2D->Fill(pt,dll,sw);
	}
	if(bkgcat==2&& nsige>6){
	    DLL_2p->Fill(dll);
    ...
    pion_weight_povere->SetFillColor(kRed);
    pion_weight_nsigpi->SetFillColor(kRed);
    pion_weight_deltabeta->SetFillColor(kRed);
    pion_weight_zdist->SetFillColor(kRed);
    pion_weight_phidist->SetFillColor(kRed);
    pion_weight_hits->SetFillColor(kRed);

    electron_weight_povere->SetFillColor(1);
    electron_weight_nsige->SetFillColor(1);
    electron_weight_deltabeta->SetFillColor(1);
    electron_weight_zdist->SetFillColor(1);
    electron_weight_phidist->SetFillColor(1);
    electron_weight_hits->SetFillColor(1);

    pion_weight_povere->SetFillStyle(3004);
    pion_weight_nsigpi->SetFillStyle(3004);
    pion_weight_deltabeta->SetFillStyle(3004);
    pion_weight_zdist->SetFillStyle(3004);
    pion_weight_phidist->SetFillStyle(3004);
    pion_weight_hits->SetFillStyle(3004);

    electron_weight_povere->SetFillStyle(3005);
    electron_weight_nsige->SetFillStyle(3005);
    electron_weight_deltabeta->SetFillStyle(3005);
    electron_weight_zdist->SetFillStyle(3005);
    electron_weight_phidist->SetFillStyle(3005);
    electron_weight_hits->SetFillStyle(3005);
    ...
    electron_weight_hits->GetYaxis()->SetTitle("Probability");
    ...
    electron_weight_deltabeta->GetXaxis()->SetTitle("(1/#beta - 1/#beta_{e})/ (1/#beta)");
    ...
    electron_weight_povere->GetYaxis()->SetRangeUser(0,0.12);
    electron_weight_nsige->GetYaxis()->SetRangeUser(0,0.12);
    electron_weight_deltabeta->GetYaxis()->SetRangeUser(0,0.12);
    electron_weight_zdist->GetYaxis()->SetRangeUser(0,0.189);
    electron_weight_phidist->GetYaxis()->SetRangeUser(0,0.189);
    electron_weight_hits->GetYaxis()->SetRangeUser(0,0.12);
    ...
    pion_weight_nsigpi->Draw("same hist");
    leg->Draw("same");
    canv2->cd(3);
	...
	if(temp1>0 && temp2>0){
	    double temp = temp1/DLL_e->Integral(1,max) / sqrt(temp1/DLL_e->Integral(1,max)+10*temp2/DLL_p->Integral(1,max));
    ...
    eff_e->GetXaxis()->SetTitle("Lilelihood Cut");
    ...
    line->Draw("same hist");
    leg->Draw("same");
    TCanvas *canv12 = new TCanvas ("canv12","Sig");
    sign->GetXaxis()->SetTitle("Likelihood Response Cut");
    sign->GetYaxis()->SetTitle("#varepsilon_{Sig.}/(#varepsilon_{Sig.}+100#times#varepsilon_{Bkg.})");
    sign->SetLineColor(1);
    sign->Draw("same hist");
    ...
    leg2->AddEntry(DLL_e,"Electrons","LPE");
    leg2->AddEntry(DLL_p,"Pions","LPE");
    //leg2->AddEntry(DLL_2p,"Merged Pions","PEL");
    //leg2->AddEntry(DLL_k,"Kaons","PEL");
    //leg2->AddEntry(DLL_pr,"Protons","PEL");
    DLL_e->SetFillStyle(3007);
    DLL_e->SetFillColor(1);
    DLL_p->SetFillStyle(3008);
    DLL_p->SetFillColor(kRed);
    DLL_e->Draw("PE hist");
    //DLL_k->Draw("same");  
    //DLL_pr->Draw("same");  
    //DLL_2p->Draw("same"); 
    DLL_p->Draw("same PE hist");  
   
    leg2->Draw("same");

    norm(DLL_e_post);
    norm(DLL_p_post);
    TCanvas *canv15 = new TCanvas ("canv15","post");
    DLL_e_post->Draw("PE hist");
    //DLL_k->Draw("same");  
    //DLL_pr->Draw("same");  
    //DLL_2p->Draw("same"); 
    DLL_p_post->Draw("same PE hist");  
    ...
    leg1->AddEntry(pt_eff_e1,"#Delta#it{LL}(e-#pi)>0.25","PEL");
    //leg1->AddEntry(pt_eff_p,"Pions #Delta#it{LL}(e-#pi)>0.00","PEL");
    //leg1->AddEntry(pt_eff_p1,"#Delta#it{LL}(e-#pi)>-0.05","L");
    leg1->AddEntry(pt_eff_e2,"#Delta#it{LL}(e-#pi)>0.3","LPE");
    leg1->AddEntry(pt_eff_e3,"#Delta#it{LL}(e-#pi)>0.35","LPE");
    leg1->AddEntry(pt_eff_e4,"#Delta#it{LL}(e-#pi)>0.4","LPE");
    leg1->AddEntry(pt_eff_e5,"#Delta#it{LL}(e-#pi)>0.45","LPE");
