...
void doLikelihood(){
  ...
  sprintf(dFile1,"../SPlot/Kshort/root_yj/out.root"); // zyj ???
  ...
  TFile file("./root_yj/Ks_pion_smooth.root","RECREATE");
  ...
  electron_weight_povere->GetXaxis()->SetTitle("#it{pc}/E");
  ...
  */
  ...
  line->Draw("same hist");
  leg->Draw("same");
  canv4->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Cut_Effi.pdf");
  //========================================================================
  ...
  ROC->Draw("P");
  cpp->SaveAs("plots_likelihood_yj_B10_TuneCut/ROC.pdf");
  //========================================================================
  ...
  sign->Draw("P");
  canvsig->SaveAs("plots_likelihood_yj_B10_TuneCut/Signi.pdf");
  //========================================================================

  DLL_p->GetXaxis()->SetTitle("Likelihood Response"); // zyj e->p
  DLL_p->GetYaxis()->SetTitle("Arb. Units");
  DLL_p->SetLineColor(kRed);
  ...
  DLL_p_post->GetYaxis()->SetTitle("Arb. Units");
  ...
  leg2->Draw("same");
  canv1->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Response_Comparision.pdf");
  canv1->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Response_Comparision.C");
  //========================================================================

  TCanvas *cp = new TCanvas("cp","post_DLL_comparsion");
  //    DLL_k_post->Draw("same");
  //    DLL_pr_post->Draw("same");
  DLL_p_post->GetYaxis()->SetRangeUser(0, 0.3);
  DLL_p_post->Draw();
  DLL_e_post->Draw("same"); // with DLL_e_post cut
  leg2->Draw("same");
  cp->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Response_Comparision_post.pdf");
  cp->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Response_Comparision_post.C");
  ...
  for(int i = 1;i<numPtBins+1;i++){ // zyj eff for different pt bin
    ...
    pt_eff_e2->SetBinContent(i,htemp11->Integral(bin1,max)/htemp1->Integral()); //bin1 = htemp1->FindBin(0.2);
  ...
  canv5->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Efficiency_pt.pdf");
  canv5->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Efficiency_pt.C");
  //=========================================================================

  TCanvas *canv51 = new TCanvas ("canv51","DLL Rat");
  pt_eff_r->Draw("PE");
  canv51->SaveAs("plots_likelihood_yj_B10_TuneCut/DLL_Rat.pdf");
  //=========================================================================
  ...
  leg1->Draw("same");
  canv55->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Efficiency_diff_MVACut.pdf");
  canv55->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Efficiency_diff_MVACut.C");
  //=========================================================================
  ...
  canv6->SaveAs("plots_likelihood_yj_B10_TuneCut/corr_electron.pdf");
  //=========================================================================
  ...
  hOverlap->Draw();
  canv9->SaveAs("plots_likelihood_yj_B10_TuneCut/overlap.pdf");
  //=========================================================================
  ...
  leg12->Draw("same");
  canv25->SaveAs("plots_likelihood_yj_B10_TuneCut/Likelihood_Efficiency_Nsigma_e.pdf");
  //=========================================================================
  ...
  canv7->SaveAs("plots_likelihood_yj_B10_TuneCut/nsige_dll_dist.pdf");
  //=========================================================================
  ...
  canv77->cd(2);
  DLL_p_pt->Draw("COLZ");
  canv77->SaveAs("plots_likelihood_yj_B10_TuneCut/pt_dll_dist.pdf");
