...
double xes [28] = {0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05,0.05};
...
double yeraa_s [28] = {0.301,0.342,0.257,0.295,0.171,0.195,0.134,0.124,0.148,0.128,0.177,0.16,0.145,0.134,0.127,0.143,0.134,0.126,0.119,0.115,0.124,0.102,0.097,0.0813,0.0696,0.073,0.102,0.128};
...
void phenix(){
	...
	my_y_sys->SetPoint(i+1,mycenter[i],y/width);
...
double Int2(TF1 *f1 ,TF1 *f2, double low , double high){
