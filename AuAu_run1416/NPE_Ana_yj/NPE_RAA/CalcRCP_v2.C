...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    pp= (TGraphAsymmErrors*)f1->Get("pp");
    pp_sys= (TGraphAsymmErrors*)f1->Get("pp_sys");
    fb_sys->SetFillColor(kGray);
    
    TFile *f2 = new TFile("../DCA_Fit_0_20/root/FracB.root");
    fb1_sys= (TH1F*)f2->Get("fb_sys");fb1_sys->SetName("fb1_sys");
    TFile *f3 = new TFile("../DCA_Fit_20_40/root/FracB.root");
    fb2_sys= (TH1F*)f3->Get("fb_sys");fb2_sys->SetName("fb2_sys");
    TFile *f4 = new TFile("../DCA_Fit_40_80/root/FracB.root");
    fb3_sys= (TH1F*)f4->Get("fb_sys");fb3_sys->SetName("fb3_sys");
