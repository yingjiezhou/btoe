...
void runFit(int rs=1,int save=0, int doAllFits=0, int HT=0)
{
/////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
	...
	//sprintf(dFile,"../production/NPE_Tuples_V1.root");
        //sprintf(dFile,"../TestArea/test.root");
	TFile *f_D = new TFile(dFile);
	sprintf(dFile1,"../../NPE_MC/Ana/root/DCA_plots_for_TestFit.root");
	...
	if(HT){
	    double constraint[numPtBins]={0.5,0.5,0.5,0.5,0.422,   0.286,   0.229,   0.199,   0.169};
	    ...
	    double constraint[numPtBins]={0.283,0.240,0.207,0.173,0.141,0.128,0.123};  
	    int pur_val=10;
...
//////////////////////////////////////////////////////////////////   
	...
	if(0){
	    ...
	    norm(h01_emc);
	    h01_2D_emc1->GetXaxis()->SetRangeUser(1.5,8.5);
...
//////////////////////////////////////////////////////////////////    
	    ...
	    cout << "Pion mean PT" << pt_pi->GetMean() << endl;
	}//End Fit
    }//End PT
}//End
void norm(TH1F *h){
