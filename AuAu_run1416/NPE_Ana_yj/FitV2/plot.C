void plot(){
    ...
    getData(hb,hb_sys,"./200/yields.dat");
    getData(hc,hc_sys,"./201/yields.dat");
    getData(hb1,hb_sys1,"./202/yields.dat");//tight dca
    getData(hc1,hc_sys1,"./203/yields.dat");//tight dca
