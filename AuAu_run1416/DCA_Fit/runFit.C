#include "fitdata1D.C"
void runFit(int save=0, int doAllFits=0)
{
/////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
		...
		if(sys!=4 && sys!=5 && sys!=6 && sys!=7 && sys!=8)sprintf(dFile2,"../../NPE_MC/Ana/root/HF_plots.root");//_soft _hard _moredp _lessdp
		...
		else if(sys==8)sprintf(dFile2,"../../NPE_MC/Ana/root/HF_plots_lc.root");
