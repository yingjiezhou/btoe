...
void runFit_yj(int pnum, TString fphe, TString fhf, double constraint_v2[9], double fluc = 0.01, int rs=1,int save=1, int doAllFits=1, int HT=0)
{
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  //for(int pt=ptStart;pt<ptStart+1;pt++){ //zyj test
    ...
    sprintf(dFile1,"%s",fphe.Data()); // updated pion spectrum, change scale, default
    ...
    sprintf(dFile2,"%s",fhf.Data()); // updated D and Lc/D0 ratio
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////
      ...
      if(pt>0)fitdata1D(fluc, h01,h01_emc,h01_emc,h01_pi,h01_D,h01_e,h01_B,0,0,save,file,dat,datc,dir1,dir2,dir3,dir4,dir5,dir6,pt,0,rs,cutLow,cutHigh,binning[pt-1],binning[pt],eff,pur_val,HT,e_const); // zyj 2nd h01_emc is not used
