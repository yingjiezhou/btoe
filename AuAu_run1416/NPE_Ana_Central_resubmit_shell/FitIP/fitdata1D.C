...
void fitdata1D(double fluc, TH1F *data,TH1F *data_e,TH1F* data_emis,TH1F *data_pi,TH1F* data_D,TH1F* data_jpsi,TH1F* data_B,int daughter,int mag, int save,
               ...
               int pt,int eta, int rs,float cutLow,float cutHigh,double ptLow ,double ptHigh,double eff_b, int pur_dir, int HT, double e_const)
{
  ...
  //else
  e_ratio.setRange(e_const-fluc,e_const+fluc);
