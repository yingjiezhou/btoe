...
void plotFractionRooFit(int pass=1){
  ...
  char file[50];
  sprintf(file,"./%i/yields.dat",111333); //mb 11
  ifstream data(file);
  char file1[50];
  ...
  leg1->AddEntry(h1,"New Results Central-5","PE");
  ...
  leg1->Draw("same");
  c1->SaveAs("plots_yj/b_fraction_comp_111333_rebin.pdf");
  ...
  */
  ...
  c2->SaveAs("plots_yj/NPE_PE_ratio_111333_rebin.pdf");
  //h2_ht->Draw("same");
  ...
  h4->Draw("histe same");
  leg->Draw("same");
  c3->SaveAs("plots_yj/bfraction_111333_rebin.pdf");
