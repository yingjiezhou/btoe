#include "fitdata1D_HT.C"
void runFit_HT(int rs=1,int save=1, int doAllFits=0)
{
/////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
	...
	char dFile1[500];
	char dFile2[500];
	sprintf(dFile,"../production/NPE_Tuples_TuneB8.root");
	...
	h01_2D = (TH2F*) f_D->Get("hFit_7");
	h01_2D1 = (TH2F*) f_D->Get("hFit_7");
	h01_2D_e = (TH2F*) f_D->Get("hFit_e_7");
	h01_2D_e_WS = (TH2F*) f_D->Get("hFit_e_WS_7");
	if(pt<7){
	...
	h01_2D_2pi = (TH2F*) f_D2->Get("hFit_2pi_7");
	h01_2D_k = (TH2F*) f_D2->Get("hFit_k_7");
	h01_2D_p = (TH2F*) f_D2->Get("hFit_p_7");
