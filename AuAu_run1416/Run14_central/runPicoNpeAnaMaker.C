...
void runPicoNpeAnaMaker(TString list="picoList_small.list", TString outFileName="test.root", TString badRunListFileName = "picoList_bad_MB.list")
{
    ...
    //we only use good/bad runlist, no need both of them! here we don't need picoList_bad_MB.list
    ...
    StPicoDstMaker* picoDstMaker = new StPicoDstMaker(2, list, "picoDstMaker");// mode ==2, read
...
//    npeCuts->setBadRunListFileName(badRunListFileName);
    ...
    npeCuts->setSignalTree(0);// signal tree                                                                                                                                                     
    ...
    npeCuts->setTrigger(450103); // Central-5(production_2014, production_mid_2014,production_low_2014)
