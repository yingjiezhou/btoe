void runHftTree(const Char_t *input, const Char_t *output=0) {
  ...
  TString Chain("ry2016,in,StEvent,mysql,libPhysics,db,pxlDb,istDb,sstDb,StarMagField,MagF,HftMatTree,nodefault");
  if (Input.Contains("rcf") || Input.Contains("gstar")) Chain += ",AgML,y2016,simu";
