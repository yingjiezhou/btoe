...
void plotFractionRooFit(int pass=1){
  ...
  char file[50];
  sprintf(file,"./%i/yields.dat",11133); //mb 11
  ifstream data(file);
  char file1[50];
  ...
  leg1->Draw("same");
  c1->SaveAs("plots_yj/b_fraction_comp_11133.pdf");
  ...
  */
  ...
  c2->SaveAs("plots_yj/NPE_PE_ratio_11133.pdf");
  //h2_ht->Draw("same");
  ...
  h4->Draw("histe same");
  leg->Draw("same");
  c3->SaveAs("plots_yj/bfraction_11133.pdf");
