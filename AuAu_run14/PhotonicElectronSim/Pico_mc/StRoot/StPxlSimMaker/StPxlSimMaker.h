...
class StPxlSimMaker : public StMaker 
{
  ...
  */
  ...
  void addPileup2(){mAddPileup2 = kTRUE;}
  void setPileupFile2(TString pileupFile) {mPileupFile2 = pileupFile;}
...
private:
    ...
    TString mPileupFile2; // THIS IS A HACK THAT IS NOT IN THE OFFICIAL STAR VERSION
    Bool_t mAddPileup2;
    StPxlPileupAdder* mPileupAdder2;
