...
Int_t StPair::GetEntry(Long64_t entry)
{
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Int_t StPair::GetEntries()   
{
  if(fChain) return fChain->GetEntriesFast(); 
  return 0;  
}
void StPair::Init(TTree *tree)
{
  ...
  fChain->SetBranchAddress("p1dcaxy", &p1dcaxy, &b_p1dcaxy);
  fChain->SetBranchAddress("p1dcaz", &p1dcaz, &b_p1dcaz);
  fChain->SetBranchAddress("t1isHFT", &t1isHFT, &b_t1isHFT);
  fChain->SetBranchAddress("t1mcHFT", &t1mcHFT, &b_t1mcHFT);
  fChain->SetBranchAddress("t1trueHFT", &t1trueHFT, &b_t1trueHFT);
  ...
  fChain->SetBranchAddress("p2dcaxy", &p2dcaxy, &b_p2dcaxy);
  fChain->SetBranchAddress("p2dcaz", &p2dcaz, &b_p2dcaz);
  fChain->SetBranchAddress("t2isHFT", &t2isHFT, &b_t2isHFT);
  fChain->SetBranchAddress("t2mcHFT", &t2mcHFT, &b_t2mcHFT);
  fChain->SetBranchAddress("t2trueHFT", &t2trueHFT, &b_t2trueHFT);
