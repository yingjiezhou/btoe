...
if [ ! -d ${dir}/log/log_$1_purity ]; then
	mkdir ${dir}/log/log_$1_purity
fi
...
for runId in `cat runnumber_tt`
do
      echo "Arguments        = $1 $runId ">>runHaddAll_$1.con
      echo "Output           = log/log_$1_purity/run_$runId.out">>runHaddAll_$1.con
      echo "Error            = log/log_$1_purity/run_$runId.err">>runHaddAll_$1.con
      echo "Log              = log/log_$1_purity/run_$runId.olog">>runHaddAll_$1.con
