...
void drawPlots(const bool isFullRange=true) {
  ...
  TFile *fin_s200GeV  = new TFile(Form("%s/NpeCHcorr_TPC_allpT.root", inDir.Data()));
  TFile *fin_s200GeV_fullRange  = new TFile("fullRange/NpeCHcorr_TPC_allpT.root");
  ...
  float downLimit_M2 = 5e-4, upLimit_M2 = 1.;
  float downLimit_V2 = 5e-4, upLimit_V2 = 1.;
  if(!isFullRange) {
    downLimit_M2 = 5e-4;
    upLimit_M2 = 1.1;
    downLimit_V2 = 5e-4;
