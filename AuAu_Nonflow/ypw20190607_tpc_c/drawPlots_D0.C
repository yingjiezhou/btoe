...
//float ptBin[nPtBins+1]={2.0, 2.5, 3.5, 4.5, 5.5, 8.5};
float ptBin[nPtBins+1]={2.0, 4.0, 6.0, 10.0, 11.0, 12.0};
...
void drawPlots(const bool isFullRange=false) {
  ...
  TFile *fin_s200GeV  = new TFile(Form("%s/NpeCHcorr_TPC_v2.root", inDir.Data()));
  TFile *fin_s200GeV_fullRange  = new TFile("fullRange/NpeCHcorr_TPC_v2.root");
  ...
  leg_NpeKine1->SetHeader("|#eta|<1.0, p_{T}>0.15"); // ??
  ...
  leg_NpeKine5->SetHeader("|#eta|<0.7, p_{T}>2.0 GeV/c");
  ...
  leg_NpeKine2->SetHeader("|#eta|<1.0, p_{T}>0.15 GeV/c");
  ...
  leg_NpeKine6->SetHeader("|#eta|<0.7, p_{T}>2.0 GeV/c");
  ...
  leg_NpeKine3->SetHeader("|#eta|<1.0, p_{T}>0.15 GeV/c");
  ...
  hPhiE->GetYaxis()->SetRangeUser(1e5,3e9);
  ...
  leg_NpeKine7->SetHeader("|#eta|<0.7, p_{T}>2.0 GeV/c");
  ...
  leg_NpeKine4->SetHeader("|#eta|<1.0, p_{T}>0.15 GeV/c");
  ...
  leg_NpeKine8->SetHeader("|#eta|<0.7, p_{T}>2.0 GeV/c");
  ...
  hHadron_Pt_PP[0]= (TH1F*)fin_s200GeV->Get("hHad_noEtaGap_pTBin5");
  hHadron_Pt_PP[1]= (TH1F*)fin_s200GeV->Get("hHad_EtaGap_dot0_pTBin5");
  cPtHadron->cd(1);
  ...
  TString ptRange[nPtBins+1]={"2.0 < p^{NPE}_{T} < 2.5 GeV/c", "2.5 < p^{NPE}_{T} < 3.5 GeV/c", "3.5 < p^{NPE}_{T} < 4.5 GeV/c", "4.5 < p^{NPE}_{T} < 5.5 GeV/c", "5.5 < p^{NPE}_{T} < 8.5 GeV/c", "2.0 < p^{NPE}_{T} < 8.5 GeV/c"};
  ...
  for(auto i=0; i<nPtBins+1; i++){
    ...
    hDPhi_deltaEta01_PtBin[i]->Draw("E1SAME");
    ...
    leg_dPhi[i]->AddEntry(hDPhi_deltaEta01_PtBin[i],"w/ eta gap, #Delta#eta>0.15");
    leg_dPhi[i]->Draw();
  }
  ...
  float downLimit_M2 = -0.05, upLimit_M2 = 0.05;
  float downLimit_V2 = -0.05, upLimit_V2 = 0.05;
  if(!isFullRange) {
    downLimit_M2 = 5e-4;
    upLimit_M2 = 1.1;
    downLimit_V2 = 5e-4;
  ...
  leg_M2->AddEntry(hM2[1],"w/ eta gap, #Delta#eta>0.15");
  leg_M2->Draw();
  ...
  leg_V2->AddEntry(hV2[1],"w/ eta gap, #Delta#eta>0.15");
  leg_V2->Draw();
